...
#
# Usage: ROMDIR=... [MAME_BIN=...] [REC_BUILD=build/hui58] tests/test_record_window.sh
#
...
export MAME_BIN
BUILD="${REC_BUILD:-build/hui58}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
