...
BUILDS="${TRIPWIRE_BUILDS:-build/hui50:10 build/pyron34:11 build/don_m16:13 build/m3b_merged19:10 build/m3b_merged19:11 build/m3b_merged19:13}"  # re-pointed 14z-117 (pyron-medallion freeze) <- 14z-115
