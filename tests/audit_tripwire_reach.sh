...
BUILDS="${TRIPWIRE_BUILDS:-build/hui47:10 build/pyron31:11 build/don_m11:13 build/m3b_merged13:10 build/m3b_merged13:11 build/m3b_merged13:13}"  # re-pointed 14z-105
