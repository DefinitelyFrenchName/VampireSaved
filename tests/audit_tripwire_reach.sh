...
BUILDS="${TRIPWIRE_BUILDS:-build/hui49:10 build/pyron33:11 build/don_m15:13 build/m3b_merged18:10 build/m3b_merged18:11 build/m3b_merged18:13}"  # re-pointed 14z-115 (select-wheel freeze) <- 14z-113 (merged-m10: one-zip repackaging of merged-m9, same program)
