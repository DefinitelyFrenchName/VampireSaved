...
BUILDS="${TRIPWIRE_BUILDS:-build/hui47:10 build/pyron31:11 build/don_m13:13 build/m3b_merged15:10 build/m3b_merged15:11 build/m3b_merged15:13}"  # re-pointed 14z-111
