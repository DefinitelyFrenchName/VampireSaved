...
BUILDS="${TRIPWIRE_BUILDS:-build/hui58:10 build/pyron43:11 build/don_m24:13 build/m3b_merged28:10 build/m3b_merged28:11 build/m3b_merged28:13}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
