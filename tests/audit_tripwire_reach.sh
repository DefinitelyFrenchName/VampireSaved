...
BUILDS="${TRIPWIRE_BUILDS:-build/hui51:10 build/pyron35:11 build/don_m17:13 build/m3b_merged20:10 build/m3b_merged20:11 build/m3b_merged20:13}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117
