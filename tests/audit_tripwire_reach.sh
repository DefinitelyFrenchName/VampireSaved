...
BUILDS="${TRIPWIRE_BUILDS:-build/hui46:10 build/pyron30:11 build/don_m10:13 build/m3b_merged12:10 build/m3b_merged12:11 build/m3b_merged12:13}"  # re-pointed 14z-102
