...
#
# Usage: [BUILDS="build/hui58:0x10 ..."] tests/test_voice_row_range.sh
...
BUILDS="${BUILDS:-build/hui58:0x10 build/pyron43:0x11 build/don_m24:0x13}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
