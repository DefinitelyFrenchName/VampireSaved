...
#
# Usage: [BUILDS="build/hui55:0x10 ..."] tests/test_voice_row_range.sh
...
BUILDS="${BUILDS:-build/hui55:0x10 build/pyron40:0x11 build/don_m21:0x13}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
