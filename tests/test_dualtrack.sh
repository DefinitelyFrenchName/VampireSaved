...
cd "$REPO"
STOCK="${1:-$REPO/build/m5_stock18/rompath}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
WIDE="${2:-$REPO/build/m3b_merged27/rompath}"  # re-pointed 14z-133b: MERGED (thread 3, maintainer-ruled with the frozen-offset instrument below)    # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
