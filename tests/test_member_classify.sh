...
zips += [p for p in ("build/hui58/rompath/vsavjw.zip",  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
                     "build/m3b_merged28/rompath/vsavjw.zip") if os.path.exists(p)]  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
if not zips:
