...
#        (defaults to build/hui56; needs a build carrying H's real art)
#
...
BUILD="${1:-build/hui56}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
