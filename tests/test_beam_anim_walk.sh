...
#        (defaults to build/hui57; needs a build carrying H's real art)
#
...
BUILD="${1:-build/hui57}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
