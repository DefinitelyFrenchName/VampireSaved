...
#
# WHAT: the FBNeo headless runner boots vsavj and survives a soak: every ROM member loads
#   OK, emulation starts, and the process is still alive when killed (the M0 smoke).
