...
m_don="docs/project/tables/chars/donovan.json"; ex_don="build/don_m24/extract"  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
...
m="docs/project/tables/chars/donovan.json"; ex="build/don_m24/extract"  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
if [ -f "$m" ] && [ -d "$ex" ]; then
