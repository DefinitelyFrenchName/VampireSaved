...
#
# Usage: ROMDIR=... [MAME_BIN=...] [DON=build/don_m22 HUI=build/hui56 PYR=build/pyron41] [TENANTS="donovan pyron huitzil"] tests/test_move_naming.sh   # emulator tier (MAME, ~3 min)
#
...
DON="${DON:-build/don_m22}"; HUI="${HUI:-build/hui56}"; PYR="${PYR:-build/pyron41}"   # the vs2 EXTRACTS (anim region + index pointers)
