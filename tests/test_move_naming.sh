...
#
# Usage: ROMDIR=... [MAME_BIN=...] [DON=build/don_m21 HUI=build/hui55 PYR=build/pyron40] [TENANTS="donovan pyron huitzil"] tests/test_move_naming.sh   # emulator tier (MAME, ~3 min)
#
...
DON="${DON:-build/don_m21}"; HUI="${HUI:-build/hui55}"; PYR="${PYR:-build/pyron40}"   # the vs2 EXTRACTS (anim region + index pointers)
