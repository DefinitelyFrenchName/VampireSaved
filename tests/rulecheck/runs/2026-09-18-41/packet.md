...
Subject: 14z-167: the final re-freeze of tests/expected/throw_registration.tsv, re-read on Opus 5 (its 14z-166 packet, run 2026-09-18-36, was prepared but never read) - the reducer's frame-net steps, the ids rows with writer PCs, the legacy control captured
