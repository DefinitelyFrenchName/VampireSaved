...
MANI_STOCK="cb22fa87e94649d1e0629a1c3c04b3b032dd577b 30 30" # 14z-127 (THE STOCK TWIN MOVED: vm3j.03d only — the same three boot-title poke16; no group C on this track, so no glyph member moves; inventory 30 unchanged)
...
MANI_HUI="b6916e786a2e6b0c2daaf0be6f7afca302bff5cc 25" # 14z-127 (delta: THE BOOT-TITLE FREEZE + M13 mark: PROGRAM vm3j.03d (the three `boot_title_saved_*` poke16 at PRG:0x01C822/24/26 — the name-screen display script's JAPAN entry, "S A V I O R" -> "S A V E D"; declared in all three manifests, deduped to ONE shared row); GROUP C vsw.33m/37m (the M13 glyph); count unchanged; QSound/Z80 untouched)
...
MANI_PYR="8c3bcf899ccc1189b7b4c2a1ec528a1e4786d906 25" # 14z-127 (delta: THE BOOT-TITLE FREEZE + M13 mark: PROGRAM vm3j.03d (the three `boot_title_saved_*` poke16 at PRG:0x01C822/24/26 — the name-screen display script's JAPAN entry, "S A V I O R" -> "S A V E D"; declared in all three manifests, deduped to ONE shared row); GROUP C vsw.33m/37m (the M13 glyph); count unchanged; QSound/Z80 untouched)
...
MANI_MERGED="1e31608899cf28aad39f6a558ec9415daf029586 25" # 14z-127 (delta: THE BOOT-TITLE FREEZE + M13 mark: PROGRAM vm3j.03d (the three `boot_title_saved_*` poke16 at PRG:0x01C822/24/26 — the name-screen display script's JAPAN entry, "S A V I O R" -> "S A V E D"; declared in all three manifests, deduped to ONE shared row); GROUP C vsw.33m/37m (the M13 glyph); count unchanged; QSound/Z80 untouched)
