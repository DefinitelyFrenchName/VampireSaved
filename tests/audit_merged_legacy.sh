...
LEGB_DON="${LEGB_DON:-build/don_m16}"   # re-pointed 14z-117 (pyron-medallion freeze) <- 14z-115
LEGB_HUI="${LEGB_HUI:-build/hui50}"  # re-pointed 14z-117 (pyron-medallion freeze) <- 14z-115
LEGB_PYR="${LEGB_PYR:-build/pyron34}"  # re-pointed 14z-117 (pyron-medallion freeze) <- 14z-115
