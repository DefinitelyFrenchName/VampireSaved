...
LEGB_DON="${LEGB_DON:-build/don_m24}"   # re-pointed 14z-119 (physics-port freeze; the 14z-117b sweep MISSED these three — they still named the one-back solos) <- 14z-117 <- 14z-115
LEGB_HUI="${LEGB_HUI:-build/hui58}"  # re-pointed 14z-119 (physics-port freeze; the 14z-117b sweep MISSED these three — they still named the one-back solos) <- 14z-117 <- 14z-115
LEGB_PYR="${LEGB_PYR:-build/pyron43}"  # re-pointed 14z-119 (physics-port freeze; the 14z-117b sweep MISSED these three — they still named the one-back solos) <- 14z-117 <- 14z-115
