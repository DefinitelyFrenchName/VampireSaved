...
#   defaults: build/m3b_merged27/rompath, build/m5_stock18/rompath
#
...
cd "$REPO"
WIDE="${1:-build/m3b_merged27/rompath}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
STOCK="${2:-build/m5_stock18/rompath}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
