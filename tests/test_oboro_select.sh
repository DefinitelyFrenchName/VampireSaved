...
cd "$REPO"
WIDE="${1:-build/m3b_merged20/rompath}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117
STOCK="${2:-build/m5_stock12/rompath}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117
