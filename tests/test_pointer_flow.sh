...
for pair in "build/m3b_merged20:merged-m13" "build/don_m17:donovan-m17" \
            "build/hui51:huitzil-m24" "build/pyron35:pyron-m18"; do   # re-pointed 14z-117b (random-select freeze) <- 14z-117
    b="${pair%%:*}"; n="${pair##*:}"
