...
for pair in "build/m3b_merged25:merged-m17" "build/don_m21:donovan-m19" \
            "build/hui55:huitzil-m26" "build/pyron40:pyron-m22"; do   # re-pointed 14z-130 (M13 boot-title freeze) <- 14z-119
    b="${pair%%:*}"; n="${pair##*:}"
