...
for pair in "build/m3b_merged23:merged-m15" "build/don_m20:donovan-m19" \
            "build/hui54:huitzil-m26" "build/pyron38:pyron-m20"; do   # re-pointed 14z-130 (M13 boot-title freeze) <- 14z-119
    b="${pair%%:*}"; n="${pair##*:}"
