...
for pair in "build/m3b_merged19:merged-m12" "build/don_m16:donovan-m16" \
            "build/hui50:huitzil-m23" "build/pyron34:pyron-m17"; do   # re-pointed 14z-117 (pyron-medallion freeze) <- 14z-115
    b="${pair%%:*}"; n="${pair##*:}"
