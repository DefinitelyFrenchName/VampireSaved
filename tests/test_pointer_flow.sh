...
for pair in "build/m3b_merged26:merged-m17" "build/don_m22:donovan-m19" \
            "build/hui56:huitzil-m26" "build/pyron41:pyron-m22"; do   # re-pointed 14z-130 (M13 boot-title freeze) <- 14z-119
    b="${pair%%:*}"; n="${pair##*:}"
