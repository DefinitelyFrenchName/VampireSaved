...
for pair in "build/m3b_merged21:merged-m14" "build/don_m18:donovan-m18" \
            "build/hui52:huitzil-m25" "build/pyron36:pyron-m19"; do   # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
    b="${pair%%:*}"; n="${pair##*:}"
