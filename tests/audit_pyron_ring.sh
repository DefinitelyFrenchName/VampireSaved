...
MERGED="${1:-build/m3b_merged27}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
SOLO="${2:-build/pyron42}"    # pyron-m15 (14z-105; was pyron-m13, the shipping solo (carries  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
