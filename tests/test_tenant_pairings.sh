...
#
# Usage: ROMDIR=... [MERGED=build/m3b_merged28] tests/test_tenant_pairings.sh
...
BUILD="${MERGED:-build/m3b_merged28}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
