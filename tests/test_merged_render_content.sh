...
MERGED="${1:-$REPO/build/m3b_merged16/rompath}"  # re-pointed 14z-111
...
chk "D band  0x4AD8F == don_m14"  "$m_d" "$s_d"
chk "H band  0x40AF6 == hui48"    "$m_h" "$s_h"
chk "P band  0x45000 == pyron32"  "$m_p" "$s_p"
chk "strip   0x486A0 == hui48 (the S3 relocation, live)" "$m_s" "$s_s"
