...
MERGED="${1:-$REPO/build/m3b_merged23/rompath}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
...
D_RP="$REPO/build/don_m20/rompath"   # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
H_RP="$REPO/build/hui54/rompath"    # re-pointed 14z-105 (window freeze); re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
P_RP="$REPO/build/pyron38/rompath"  # re-pointed 14z-105 (window freeze); re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
...
chk "D band  0x4AD8F == don_m20 (label re-pointed 14z-117)"  "$m_d" "$s_d"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
chk "H band  0x40AF6 == hui54 (label re-pointed 14z-117)"    "$m_h" "$s_h"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
chk "P band  0x45000 == pyron38 (label re-pointed 14z-117)"  "$m_p" "$s_p"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
chk "strip   0x486A0 == hui54 (the S3 relocation, live; label re-pointed 14z-117)" "$m_s" "$s_s"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
