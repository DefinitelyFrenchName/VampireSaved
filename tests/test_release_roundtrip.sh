...
#   defaults build/m3b_merged23/rompath, merged-m16. Needs xdelta3.
...
cd "$REPO"
RP="${1:-build/m3b_merged23/rompath}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
