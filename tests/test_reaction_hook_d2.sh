...
# Usage: ROMDIR=... tests/test_reaction_hook_d2.sh [builddir]   (default build/don_m23)
#
...
BUILD="${1:-build/don_m23}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
