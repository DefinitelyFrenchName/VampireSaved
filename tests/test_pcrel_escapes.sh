...
BUILDS = ["hui47", "pyron31", "don_m13"]  # re-pointed 14z-111 (don only; H/P unchanged since 14z-105); 14z-102 (the window freeze; hui re-measured across the #109 extraction shift — inventory unchanged, source-side keys)
