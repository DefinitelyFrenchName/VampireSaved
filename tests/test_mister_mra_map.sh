...
# (build/m3b_merged25 by default, MRA_MAP_BUILD to override). Everything is
...
cd "$REPO"
BUILD="${MRA_MAP_BUILD:-build/m3b_merged25}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
