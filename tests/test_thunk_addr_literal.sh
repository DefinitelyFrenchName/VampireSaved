...
for t in donovan:build/m5_wide huitzil:build/hui57 pyron:build/pyron21; do  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
    nm=${t%%:*}; bd=${t##*:}
