...
CUR_BUILDS="build/don_m24 build/hui58 build/pyron43"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
BUILDS="${*:-$HIST_BUILDS}"
...
echo "== 5: the CURRENT trio — don_m24 / hui58 / pyron43 (label re-pointed 14z-117) =="  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
