...
CUR_BUILDS="build/don_m20 build/hui54 build/pyron38"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
BUILDS="${*:-$HIST_BUILDS}"
...
echo "== 5: the CURRENT trio — don_m20 / hui54 / pyron38 (label re-pointed 14z-117) =="  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
