...
CUR_BUILDS="build/don_m19 build/hui53 build/pyron37"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
BUILDS="${*:-$HIST_BUILDS}"
...
echo "== 5: the CURRENT trio — don_m19 / hui53 / pyron37 (label re-pointed 14z-117) =="  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
