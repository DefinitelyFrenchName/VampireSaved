-- sprite_capture.lua — obj_records_dump.lua PLUS the OBJ palette page, for the
-- character pages' sprite renders (14z-121 (6), tools/sprite_render.py).
...
emu.register_frame_done(function()
    ...
    if want[frame] then
        ...
        local pal = program:read_range(0x90C000, 0x90CFFF, 8)
        local hex = {}
