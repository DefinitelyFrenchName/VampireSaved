...
| `reactions_donovan.txt` | `test_reactions.sh` | which chains Donovan runs AS THE VICTIM per reaction class, and how long | in-emulator (ours) | `FREEZE=1 TENANTS=donovan tests/test_reactions.sh` | 14z-120 |
| `reactions_huitzil.txt` | `test_reactions.sh` | the same for Huitzil/Phobos | in-emulator (ours) | `FREEZE=1 TENANTS=huitzil tests/test_reactions.sh` | 14z-120 |
| `reactions_pyron.txt` | `test_reactions.sh` | the same for Pyron | in-emulator (ours) | `FREEZE=1 TENANTS=pyron tests/test_reactions.sh` | 14z-120 |
