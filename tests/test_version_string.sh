...
#   default build/m3b_merged23. Reads the knobs from the manifest the build
...
cd "$REPO"
OUT="${1:-build/m3b_merged23}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
