...
#        outbase default: build/pyron42 (the current freeze; the dated
...
BUILD="${1:-build/pyron42}"  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
