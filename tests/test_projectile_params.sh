...
# Usage: ROMDIR=... [MAME_BIN=...] [DON=build/don_m22 PYR=build/pyron41 HUI=build/hui56] [NOLIVE=1] [FREEZE=1] tests/test_projectile_params.sh
#
...
DON="${DON:-build/don_m22}"; PYR="${PYR:-build/pyron41}"; HUI="${HUI:-build/hui56}"
