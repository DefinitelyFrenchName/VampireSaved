...
# Usage: ROMDIR=... [MAME_BIN=...] [DON=build/don_m23 PYR=build/pyron42 HUI=build/hui57] [NOLIVE=1] [FREEZE=1] tests/test_projectile_params.sh
#
...
DON="${DON:-build/don_m23}"; PYR="${PYR:-build/pyron42}"; HUI="${HUI:-build/hui57}"
