...
# Usage: ROMDIR=... [MAME_BIN=...] [DON=build/don_m24 PYR=build/pyron43 HUI=build/hui58] [NOLIVE=1] [FREEZE=1] tests/test_projectile_params.sh
#
...
DON="${DON:-build/don_m24}"; PYR="${PYR:-build/pyron43}"; HUI="${HUI:-build/hui58}"
