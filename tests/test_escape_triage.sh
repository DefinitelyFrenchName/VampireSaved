...
cd "$REPO"
for d in build/don_m23/extract build/hui57/extract build/pyron42/extract \
         build/m3b_merged27/patch/placements.json; do  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
