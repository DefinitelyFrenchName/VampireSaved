# VAMPIRE SAVED — merged-m14 (in-game mark: "M12")
...
`./rompath/` then holds vsavjw.zip. Point your patched emulator's rom path at it
...
## Identify the build
- In game: the mark `M12` at the bottom-right of the
  character-select screen.
- On disk: program fingerprint `6649523a`;
  every member's SHA-1 is in `manifest.json`.

## What is patched
20 members are patched, 5 are copied pristine from your dumps.
