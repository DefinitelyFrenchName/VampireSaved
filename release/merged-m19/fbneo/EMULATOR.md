...
release on tag `freeze/merged-m19` (https://github.com/DefinitelyFrenchName/VampireSaved/releases/tag/freeze/merged-m19) also publishes
`merged-m19-fbneo-<os-arch>.zip`: the SAME package as this one, with a
