...
1. **The emulator.** You already have it, or you build it once — whichever package
   you downloaded:
   - `merged-m20-mame-<os-arch>.zip` (built for: macos-arm64, windows-x86_64): the emulator is in this package
   ...
   - `merged-m20-mame-recipe.zip`: no ready-made program, but the one small
