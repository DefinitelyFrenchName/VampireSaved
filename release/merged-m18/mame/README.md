...
1. The patched emulator. **You already have it, or you build it once — whichever
   package you took:**
   - `merged-m18-mame-<os-arch>.zip` (built for: macos-arm64, windows-x86_64): the emulator is in this package
   ...
   - `merged-m18-mame-recipe.zip`: build it once from the pinned upstream with
