...
```sh
export ROMDIR=/path/to/reference/sets
tools/run_wide.sh build/m3b_merged26 fbneo # THE 3-TENANT BUILD (all 18
...
tools/run_wide.sh build/don_m22 fbneo      # or the solo builds (hui56,
                                           # pyron41); ... mame
                                           # (registry rows name the CURRENT
                                           # fingerprints — donovan-m22/
                                           # huitzil-m29/pyron-m23 since the
                                           # 14z-144 M18 freeze)
```
...
merged-m18 at 14z-157; this line said `merged-m14` until then). What
...
equivalent.
**THE CURRENT MERGED BUILD IS THE REGISTRY'S TOP ROW** — `build/m3b_merged26`
= merged-m18 at 14z-157 (this line named `m3b_merged21` = merged-m14 until
then); see "Current WIDE builds" above. `build/m3b_merged8` was `merged-m1`,
