...
```sh
export ROMDIR=/path/to/reference/sets
tools/run_wide.sh build/m3b_merged18 fbneo # THE 3-TENANT BUILD (all 18
                                           ...
                                           # merged-m11, FROZEN 14z-115 (the
                                           # select-wheel separation: the three
                                           # tenant medallions repositioned
                                           # with a 1px black ring each, per
                                           # the maintainer's own offsets;
                                           # program fingerprint dea2c918).
                                           # WHAT TO LOOK AT FIRST:
                                           # (1) the select screen shows
                                           # "M9" bottom-right — THE NAKED-
...
tools/run_wide.sh build/don_m15 fbneo      # or the solo builds (hui49,
                                           # pyron33); ... mame
                                           # (registry rows name the CURRENT
                                           # fingerprints — donovan-m15/
                                           # huitzil-m22/pyron-m16 since the
                                           # 14z-115 select-wheel freeze)
```

**Current WIDE builds — THE 14z-115 SELECT-WHEEL SEPARATION FREEZE
(maintainer-directed "E2", approved on MAME snapshots 2026-08-28; NOT yet
field-tested): donovan-m15 / huitzil-m22 / pyron-m16 / merged-m11.**
