...
tests/test_pyron_blink.sh      [bd]   # 14z-75: the sprite/HUD BLINK. Palette row 10
                                      ...
                                      # PYRON_BLINK_EXPECT=blinks (default, the frozen
                                      # OPEN shape) | fixed. Checker
                                      # tools/check_pyron_blink.py. Defaults pyron15
