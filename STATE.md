...
| open (phase 3) | the slide counter's home; the unindexed lying/wake nodes (entered by game-logic jumps — the per-victim pose tables of [VSE-44] are the candidate source); projectile parameter records; the `gap_*` auto tables |
