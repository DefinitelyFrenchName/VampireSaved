...
| next | G4 (mister pair) / G6 (HANDOFF) / the CLAUDE.md condensing pass; (c) NEXT SESSION by the (a)/(c) rule; every inferred_claims row except 10 (a (c) item) and 11 (ruled-parked) is now MEASURED |
