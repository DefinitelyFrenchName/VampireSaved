...
**Ledger rollover:** the 14z-125 group (14z-125, 14z-125b and its CLOSE)
moved verbatim to STATE_HISTORY.md at the 14z-126b close — STATE had crossed
the rule's ~150 KB line with the close entry, so the oldest kept group rolled
early. STATE holds 14z-126 / 14z-126b. (The 14z-124 group rolled the same way
at the 14z-126 close.)
