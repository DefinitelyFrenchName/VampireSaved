...
| open for the maintainer | Genocide Vulcan's input (list 421K vs measured 421P); the guard cancel's meter cost on vs2 (banked stock unchanged; the bar fraction `+0x10A` not sampled); Plasma Trap's HK chain (situation-dependent in the rig) |
