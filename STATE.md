...
| next | README (G7 (21)) + the audit banner (22) + the class flips; the close ritual; (c) NEXT SESSION |
...
- **THE CLAUDE.md CONDENSING PASS (maintainer-directed 2026-08-30, 14z-122
  ...
  anchors and headers intact). PASS 2 NEEDS A RULING — the remaining bulk is
