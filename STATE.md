...
| **CLOSE — static tier after thread 3 + the release prep** | `ROMDIR=... tests/run_all_static.sh` -> `PASS 133 SKIP 0 FAIL 0 MISSING 0` **GREEN**, gated on the GREEN line, tree clean during the run. Commits LOCAL |
