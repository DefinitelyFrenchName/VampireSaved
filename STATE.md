...
| next | G6 (2): the gate fence → a generated gate index + the per-gate WHY into the script headers; G4 running as a fork; then the CLAUDE.md condensing pass; (c) NEXT SESSION |
