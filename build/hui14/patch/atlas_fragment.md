...
| `PRG:0x0D4E10` | 0x3B40 | VS2 | donovan x088512 (vsav2 0x088512) |
| `PRG:0x0D8950` | 0x1E800 | VS2 | donovan anim (vsav2 0x245872) |
| `PRG:0x0F7150` | 0x190 | VS2 | donovan aux0_0 (vsav2 0x334170) |
| `PRG:0x3EC720` | 0xE620 | VS2 | donovan aux0_1 (vsav2 0x336560) |
| `PRG:0x0F72E0` | 0x32B2 | VS2 | donovan hitbox (vsav2 0x0C4250) |
| `PRG:0x0FA5A0` | 0x3C6 | VS2 | donovan hitbox_proj (vsav2 0x0D05C0) |
| `PRG:0x0FA970` | 0x900 | VS2 | donovan x0d143e (vsav2 0x0D143E) |
| `PRG:0x400010` | 0xB20C | VS2 | donovan x2b7ef4 (vsav2 0x2B7EF4) |
| `PRG:0x0FB290` | 0xC | GEN | farm-port stub 0x2916c |
| `PRG:0x0FB2B0` | 0xC | GEN | farm-port stub 0x29184 |
| `PRG:0x0FB2D0` | 0xC | GEN | farm-port stub 0x2918c |
| `PRG:0x0FB2E0` | 0x2C | GEN | alloc wrapper 0x15702 |
...
| `PRG:0x0FB450` | 0x2C | GEN | alloc wrapper 0x1572e |
| `PRG:0x0FB490` | 0xC | GEN | farm-port stub 0x2915c |
| `PRG:0x0FB4B0` | 0xC | GEN | farm-port stub 0x29164 |
| `PRG:0x0FB530` | 0x40 | GEN | patched clone 0x5459a (vs2 0x5c77e) |
...
| `PRG:0x0FB6B0` | 0xDC0 | VS2 | effect palette block |
| `PRG:0x0FC4B0` | 0x130 | GEN | proj_hook ext table |
| `PRG:0x0FC5E0` | 0x12 | GEN | obj_hook thunk |
| `PRG:0x054470` | 0x6 | GEN | obj_hook engine site |
| `PRG:0x0FC610` | 0x1F0 | GEN | proj_hook ext table |
| `PRG:0x0FC800` | 0x12 | GEN | obj_hook thunk |
| `PRG:0x05E542` | 0x6 | GEN | obj_hook engine site |
| `PRG:0x0FC820` | 0x50 | GEN | pool-seed + flavor(+Start-hold) init shim |
...
| `PRG:0x0FC870` | 0x28 | NEW | select_wheel roster21 march mid-row retarget 0x2b598 |
| `PRG:0x0FC8A0` | 0x28 | NEW | select_wheel roster21 march mid-row retarget 0x2b7d8 |
...
| `PRG:0x0FC8D0` | 0x16 | NEW | win_pal_variant hui_win_pal thunk |
| `PRG:0x0FC8F0` | 0x1A | GEN | site_thunk tenant_jump_seq |
| `PRG:0x022A0E` | 0x6 | GEN | site_thunk tenant_jump_seq engine site |
| `PRG:0x0FC910` | 0xE | GEN | site_thunk shadow_seq_guard |
| `PRG:0x08245C` | 0x6 | GEN | site_thunk shadow_seq_guard engine site |
| `PRG:0x0FC920` | 0x1E | GEN | site_thunk name_bank_variant_id |
| `PRG:0x05FCE0` | 0x6 | GEN | site_thunk name_bank_variant_id engine site |
| `PRG:0x0FC940` | 0x1E | GEN | site_thunk splash_bank_variant_id |
| `PRG:0x06C0E0` | 0x6 | GEN | site_thunk splash_bank_variant_id engine site |
| `PRG:0x0FC960` | 0x16 | GEN | site_thunk winquote_bank_variant_id |
...
| `PRG:0x0FC980` | 0x38 | GEN | site_thunk select_pal_variant_id |
...
| `PRG:0x0FC9C0` | 0x42 | GEN | site_thunk throw_arc_tables |
| `PRG:0x028386` | 0x6 | GEN | site_thunk throw_arc_tables engine site |
| `PRG:0x0FCA10` | 0xE | GEN | site_thunk idmask_victim_spawn |
| `PRG:0x060EF0` | 0x6 | GEN | site_thunk idmask_victim_spawn engine site |
| `PRG:0x0FCA20` | 0x10 | GEN | site_thunk idmask_piece_subtype |
