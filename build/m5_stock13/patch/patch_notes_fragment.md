...
data     0x0ceb50 +0x500  sprite palette block (vsav2 0x39CB9C); poke32 0x38c1d4 (table 0x38c198 row 0xf)
...
data   0x0bd8f2 +0x8  param32_a[0xf] value
data   0x0bd972 +0x8  param32_a[0x1f] mirror
data   0x0bde4a +0x30  jump_params[0xf] value
data   0x0be14a +0x30  jump_params[0x1f] mirror
...
data   0x0be372 +0x8  param32_b[0xf] value
data   0x0be3f2 +0x8  param32_b[0x1f] mirror
...
# ai_script_0: OPTIONAL row, region not extracted on this track — vanilla (aliased) row kept (14z-111, WIDE-only AI script port)
# ai_script_1: OPTIONAL row, region not extracted on this track — vanilla (aliased) row kept (14z-111, WIDE-only AI script port)
# ai_script_2: OPTIONAL row, region not extracted on this track — vanilla (aliased) row kept (14z-111, WIDE-only AI script port)
# ai_script_3: OPTIONAL row, region not extracted on this track — vanilla (aliased) row kept (14z-111, WIDE-only AI script port)
...
# aux voice_alias_thunk_w00: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w01: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w02: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w03: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w04: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w05: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w06: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w07: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w08: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w09: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w10: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w11: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w12: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w13: SKIPPED (variant-half row; tenant is at base slot 0x0f)
# aux voice_alias_thunk_w14: SKIPPED (variant-half row; tenant is at base slot 0x0f)
...
# data_port voice_borrow_candidates_a: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port voice_borrow_voicenums_b: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_bulleta: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_demitri: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_gallon: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_victor: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_zabel: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_morrigan: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_anakaris: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_felicia: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_bishamon: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_aulbath: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_sasquatch: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_qbee: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_leilei: SKIPPED (host-slot content; tenant is at variant id 0x0f)
# data_port capture_kf_lilith: SKIPPED (host-slot content; tenant is at variant id 0x0f)
...
# site_thunk voice_borrow_keep_tenant: SKIPPED (variant-id-only; tenant is at 0x0f)
# site_thunk oboro_select_hook: SKIPPED (profile 'cps2-wide-v1' != None)
# site_thunk random_select_bound: SKIPPED (profile 'cps2-wide-v1' != None)
# site_thunk random_select_roster: SKIPPED (profile 'cps2-wide-v1' != None)
...
# code_word voice_borrow_site_pad: SKIPPED (slot-track gated; owner at 0x0f)
# code_word don_kernel_voice_e0: SKIPPED (slot-track gated; owner at 0x0f)
# code_word don_kernel_voice_e1: SKIPPED (slot-track gated; owner at 0x0f)
# code_word don_kernel_voice_e2: SKIPPED (slot-track gated; owner at 0x0f)
# code_word don_kernel_voice_e3: SKIPPED (slot-track gated; owner at 0x0f)
