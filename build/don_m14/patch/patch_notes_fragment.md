...
data   0x413fe0 +0x6040  win_pal_variant don_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c365c stride 0xb40)
code   0x3ffe30 +0x16  win_pal_variant thunk, 1-way: don_win_pal d6==0x13 -> a0=0x413400; else vanilla pool 0x3ad700
...
code   0x41a020 +0x2a  site_thunk ls_freeze_vs2_victim; site 0x023ad8 jsr-routed
code   0x41a050 +0x24  site_thunk ls_freeze_vs2_attacker; site 0x023ade jsr-routed
code   0x41a080 +0x16  site_thunk es_type51_dispatch; site 0x0185ca jsr-routed
code   0x41a0a0 +0x1e  site_thunk name_bank_variant_id; site 0x05fce0 jsr-routed
code   0x41a0c0 +0x1e  site_thunk splash_bank_variant_id; site 0x06c0e0 jsr-routed
code   0x41a0e0 +0x16  site_thunk winquote_bank_variant_id; site 0x05f328 jsr-routed
code   0x41a100 +0x7e  site_thunk select_sword_pal_variant_id; site 0x05f9d0 jsr-routed
data   0x41a180 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c2a3c
code   0x41a2c0 +0x38  site_thunk select_pal_variant_id; site 0x05f146 jsr-routed
code   0x41a300 +0x22  site_thunk voice_borrow_keep_tenant; site 0x00aef2 jsr-routed
code   0x41a330 +0x1e  site_thunk oboro_select_hook; site 0x020b9c jsr-routed
