...
data   0x411cb0 +0x54  select_wheel roster21 coord list (18 vanilla + 3 new)
data   0x411d10 +0x5e  select_wheel roster21 record (count 17->20, budget 0x55 CARRIED OVER, cptr -> 0x411cb0)
...
data   0x411d70 +0x20  select_records portrait/p1 coord list (8 pairs, vs2 0x3036b8)
data   0x411d90 +0x2a  select_records portrait/p1 record (vs2 0x2a639c, 8 entries, budget 0x61 = vs2's own)
poke32 0x26746e <- 0x411d90  select_records portrait/p1 array row 0x11 (was 0x27195e, the base-half alias)
data   0x411dc0 +0x20  select_records portrait/p2 coord list (8 pairs, vs2 0x3036d8)
data   0x411de0 +0x2a  select_records portrait/p2 record (vs2 0x2a63c6, 8 entries, budget 0x61 = vs2's own)
poke32 0x2674ee <- 0x411de0  select_records portrait/p2 array row 0x11 (was 0x271d70, the base-half alias)
data   0x411e10 +0x4  select_records name_banner/p1 coord list (1 pairs, vs2 0x2fd9b4)
data   0x411e20 +0xe  select_records name_banner/p1 record (vs2 0x2a6570, 1 entries, budget 0x6 = vs2's own)
poke32 0x2675ee <- 0x411e20  select_records name_banner/p1 array row 0x11 (was 0x272156, the base-half alias)
data   0x411e30 +0x8  select_records name_banner/p2 coord list (2 pairs, vs2 0x303d9c)
data   0x411e40 +0x12  select_records name_banner/p2 record (vs2 0x2a7680, 2 entries, budget 0x3 = vs2's own)
poke32 0x26766e <- 0x411e40  select_records name_banner/p2 array row 0x11 (was 0x273060, the base-half alias)
data   0x411e60 +0x14  select_records splash_p1/p1 coord list (5 pairs, vs2 0x30437c)
data   0x411e80 +0x1e  select_records splash_p1/p1 record (vs2 0x2a7f2c, 5 entries, budget 0x4f = vs2's own)
poke32 0x2672ee <- 0x411e80  select_records splash_p1/p1 array row 0x11 (was 0x273494, the base-half alias)
data   0x411ea0 +0x14  select_records splash_p2/p1 coord list (5 pairs, vs2 0x304390)
data   0x411ec0 +0x1e  select_records splash_p2/p1 record (vs2 0x2a7f4a, 5 entries, budget 0x4f = vs2's own)
poke32 0x26736e <- 0x411ec0  select_records splash_p2/p1 array row 0x11 (was 0x2737da, the base-half alias)
data   0x411ee0 +0x38  select_records win_quote/p1 coord list (14 pairs, vs2 0x305034)
data   0x411f20 +0x42  select_records win_quote/p1 record (vs2 0x2a8cb6, 14 entries, budget 0xb5 = vs2's own)
poke32 0x2673ee <- 0x411f20  select_records win_quote/p1 array row 0x11 (was 0x273b68, the base-half alias)
...
data   0x411f70 +0x6040  win_pal_variant pyr_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c35bc stride 0xb40)
code   0x0ff120 +0x16  win_pal_variant thunk, 1-way: pyr_win_pal d6==0x11 -> a0=0x4114d0; else vanilla pool 0x3ad700
...
data   0x417fb0 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c28fc
