...
code   0x0fed30 +0x15c  obj_walker: 0x54458 relocated verbatim + its extended type table at +0x2c (59 vanilla + 17 ported, 12 placed); dispatch site 0x54470 left VANILLA
code   2 caller operand(s) of jsr 0x54458 -> 0x0fed30 (0x009436, 0x020310)
code   0x0fee90 ILLEGAL  TRIPWIRE for unresolved 0x6a70c
# obj_hook@0x5e542 type 121: unresolved 0x6a70c -> tripwire 0xfee90
# obj_hook@0x5e542 type 122: unresolved 0x6a70c -> tripwire 0xfee90
# obj_hook@0x5e542 type 123: unresolved 0x6a70c -> tripwire 0xfee90
code   0x0feea0 +0x21c  obj_walker: 0x5e52a relocated verbatim + its extended type table at +0x2c (114 vanilla + 10 ported, 7 placed); dispatch site 0x5e542 left VANILLA
code   21 caller operand(s) of jsr 0x5e52a -> 0x0feea0 (0x0053f6, 0x005410, 0x00577c, 0x0057a8, 0x00590a, 0x005ebc, 0x00943c, 0x009caa, 0x009f36, 0x00a188, 0x00a804, 0x00abcc, 0x010dfa, 0x012a3e, 0x012d16, 0x012e4c, 0x012e66, 0x020316, 0x021638, 0x021ada, 0x021dea)
...
code   0x0ff0c0 +0x28  select_wheel roster21: march mid-row retarget 0x16/0x19 -> 0x02 (dest computation 0x2b598 jsr-routed)
code   0x0ff0f0 +0x28  select_wheel roster21: march mid-row retarget 0x16/0x19 -> 0x02 (dest computation 0x2b7d8 jsr-routed)
...
code   0x0ff120 +0x16  win_pal_variant thunk, 1-way: pyr_win_pal d6==0x11 -> a0=0x4114e0; else vanilla pool 0x3ad700
code   0x05f1b6 +6     win_pal_variant: movea.l #pool -> jsr 0xff120
code   0x0ff140 +0x1e  site_thunk name_bank_variant_id; site 0x05fce0 jsr-routed
code   0x0ff160 +0x1e  site_thunk splash_bank_variant_id; site 0x06c0e0 jsr-routed
code   0x0ff180 +0x16  site_thunk winquote_bank_variant_id; site 0x05f328 jsr-routed
data   0x417fc0 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c28fc
code   0x0ff1a0 +0x38  site_thunk select_pal_variant_id; site 0x05f146 jsr-routed
code   0x0ff1e0 +0x5e  site_thunk hitclass_map_extend; site 0x01a888 jmp-routed
code   0x0ff240 +0x22  site_thunk voice_borrow_keep_tenant; site 0x00aef2 jsr-routed
code   0x0ff270 +0x1e  site_thunk oboro_select_hook; site 0x020b9c jsr-routed
