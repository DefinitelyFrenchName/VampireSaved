...
data     0x3fa690 +0x500  sprite palette block (vsav2 0x39C19C); poke32 0x38c1dc (table 0x38c198 row 0x11)
data     0x0feb90 +0xdc0  effect palette block (vsav2 0x3AC45C); poke32 0x38c25c (table 0x38c218 row 0x11)
...
code   0x0ff950 ILLEGAL  TRIPWIRE for unresolved 0x65c22
# obj_hook@0x54470 type 59: unresolved 0x65c22 -> tripwire 0xff950
code   0x0ff960 ILLEGAL  TRIPWIRE for unresolved 0x65e5a
# obj_hook@0x54470 type 60: unresolved 0x65e5a -> tripwire 0xff960
# obj_hook@0x54470 type 61: unresolved 0x65e5a -> tripwire 0xff960
code   0x0ff970 ILLEGAL  TRIPWIRE for unresolved 0x66ec4
# obj_hook@0x54470 type 62: unresolved 0x66ec4 -> tripwire 0xff970
code   0x0ff980 ILLEGAL  TRIPWIRE for unresolved 0x6717c
# obj_hook@0x54470 type 63: unresolved 0x6717c -> tripwire 0xff980
data   0x0ff990 +0x130  proj_hook extended type table (59 vanilla + 17 ported, 12 placed)
code   0x0ffac0 obj_hook thunk (ghost-clean: returns to vanilla jsr)
code   0x054470 ENGINE HOOK: dispatch -> jmp thunk; vanilla jsr (A0) at 0x54476 untouched (vanilla types identical via table copy)
code   0x0ffae0 ILLEGAL  TRIPWIRE for unresolved 0x6a70c
# obj_hook@0x5e542 type 121: unresolved 0x6a70c -> tripwire 0xffae0
# obj_hook@0x5e542 type 122: unresolved 0x6a70c -> tripwire 0xffae0
# obj_hook@0x5e542 type 123: unresolved 0x6a70c -> tripwire 0xffae0
data   0x0ffaf0 +0x1f0  proj_hook extended type table (114 vanilla + 10 ported, 7 placed)
code   0x0ffce0 obj_hook thunk (ghost-clean: returns to vanilla jsr)
...
code   0x0ffd00 +0x28  select_wheel roster21: march mid-row retarget 0x16/0x19 -> 0x02 (dest computation 0x2b598 jsr-routed)
code   0x0ffd30 +0x28  select_wheel roster21: march mid-row retarget 0x16/0x19 -> 0x02 (dest computation 0x2b7d8 jsr-routed)
...
code   0x0ffd60 +0x1e  site_thunk name_bank_variant_id; site 0x05fce0 jsr-routed
code   0x0ffd80 +0x1e  site_thunk splash_bank_variant_id; site 0x06c0e0 jsr-routed
code   0x0ffda0 +0x16  site_thunk winquote_bank_variant_id; site 0x05f328 jsr-routed
data   0x4002d0 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c28fc
code   0x0ffdc0 +0x38  site_thunk select_pal_variant_id; site 0x05f146 jsr-routed
