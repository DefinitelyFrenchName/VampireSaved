...
data   0x41ec40 +0x54  select_wheel roster21 coord list (18 vanilla + 3 new)
data   0x41eca0 +0x5e  select_wheel roster21 record (count 17->20, budget 0x55 CARRIED OVER, cptr -> 0x41ec40)
...
data   0x41ed00 +0x1c  select_records portrait/p1 coord list (7 pairs, vs2 0x303238)
data   0x41ed20 +0x26  select_records portrait/p1 record (vs2 0x2a5e4a, 7 entries, budget 0x5b = vs2's own)
poke32 0x26746a <- 0x41ed20  select_records portrait/p1 array row 0x10 (was 0x271924, the base-half alias)
data   0x41ed50 +0x1c  select_records portrait/p2 coord list (7 pairs, vs2 0x3035a8)
data   0x41ed70 +0x26  select_records portrait/p2 record (vs2 0x2a625a, 7 entries, budget 0x5b = vs2's own)
poke32 0x2674ea <- 0x41ed70  select_records portrait/p2 array row 0x10 (was 0x271d36, the base-half alias)
data   0x41eda0 +0x4  select_records name_banner/p1 coord list (1 pairs, vs2 0x303730)
data   0x41edb0 +0xe  select_records name_banner/p1 record (vs2 0x2a64d6, 1 entries, budget 0x8 = vs2's own)
poke32 0x2675ea <- 0x41edb0  select_records name_banner/p1 array row 0x10 (was 0x272148, the base-half alias)
data   0x41edc0 +0x8  select_records name_banner/p2 coord list (2 pairs, vs2 0x303d9c)
data   0x41edd0 +0x12  select_records name_banner/p2 record (vs2 0x2a7506, 2 entries, budget 0x3 = vs2's own)
poke32 0x26766a <- 0x41edd0  select_records name_banner/p2 array row 0x10 (was 0x273052, the base-half alias)
data   0x41edf0 +0x14  select_records splash_p1/p1 coord list (5 pairs, vs2 0x304028)
data   0x41ee10 +0x1e  select_records splash_p1/p1 record (vs2 0x2a7b06, 5 entries, budget 0x4c = vs2's own)
poke32 0x2672ea <- 0x41ee10  select_records splash_p1/p1 array row 0x10 (was 0x273462, the base-half alias)
data   0x41ee30 +0x14  select_records splash_p2/p1 coord list (5 pairs, vs2 0x3042b8)
data   0x41ee50 +0x1e  select_records splash_p2/p1 record (vs2 0x2a7e36, 5 entries, budget 0x4c = vs2's own)
poke32 0x26736a <- 0x41ee50  select_records splash_p2/p1 array row 0x10 (was 0x2737a8, the base-half alias)
data   0x41ee70 +0x84  select_records win_quote/p1 coord list (33 pairs, vs2 0x304bd8)
data   0x41ef00 +0x8e  select_records win_quote/p1 record (vs2 0x2a881e, 33 entries, budget 0x8a = vs2's own)
poke32 0x2673ea <- 0x41ef00  select_records win_quote/p1 array row 0x10 (was 0x273aee, the base-half alias)
...
data   0x41ef90 +0x6040  win_pal_variant hui_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c329c stride 0xb40)
code   0x0fcfb0 +0x16  win_pal_variant thunk, 1-way: hui_win_pal d6==0x10 -> a0=0x41e590; else vanilla pool 0x3ad700
...
data   0x424fd0 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c12dc
code   0x0fd060 +0x38  site_thunk select_pal_variant_id; site 0x05f146 jsr-routed
data   0x425110 +0x54  site_thunk throw_arc_tables data block <- vsav2 0x0279b4
data   0x425170 +0x370  site_thunk throw_arc_tables data block <- vsav2 0x027a08
...
data   0x4254e0 +0x100  site_thunk df_gold_variant_id data block <- vsav2 0x3abedc
