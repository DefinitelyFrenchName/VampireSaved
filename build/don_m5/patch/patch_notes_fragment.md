...
code   0x0cc000 obj_hook thunk (ghost-clean: returns to vanilla jsr)
...
code   0x0cc030 obj_hook thunk (ghost-clean: returns to vanilla jsr)
...
code   0x0cc050 state_hook private seq entry (records base 0x3ff9b0 - 0x2cd*32 -> engine 0x2ad9a)
code   0x02a7c8 ENGINE HOOK: +0x14e state dispatch -> thunk 0x0fff40 (vanilla ids ghost-clean via jmp-back; ids 0xb2-0xc8 -> 12 synthesized stubs at 0x3ffb30, ext table 0x0cf310)
code   0x018458 ENGINE HOOK: hit-reaction dispatch -> thunk 0x0fff90 (vanilla ids jmp back to untouched 0x18460; ids 0xa0-0xa6 -> 4 verbatim vs2 cases at 0x0cf340)
...
code   0x0fffd0 +0x28  select_wheel roster21: march mid-row retarget 0x16/0x19 -> 0x02 (dest computation 0x2b598 jsr-routed)
code   0x3ffd00 +0x28  select_wheel roster21: march mid-row retarget 0x16/0x19 -> 0x02 (dest computation 0x2b7d8 jsr-routed)
...
code   0x3ffd30 +0x16  win_pal_variant thunk, 1-way: don_win_pal d6==0x13 -> a0=0x400730; else vanilla pool 0x3ad700
code   0x05f1b6 +6     win_pal_variant: movea.l #pool -> jsr 0x3ffd30
code   0x3ffd50 +0x62  site_thunk fixture_row0f_override_bank0; site 0x01c586 jsr-routed
code   0x3ffdc0 +0x62  site_thunk fixture_row0f_override_bank1; site 0x01c59a jsr-routed
code   0x3ffe30 +0x18  site_thunk select_companion_tbl_a; site 0x0845ec jsr-routed
code   0x3ffe50 +0x18  site_thunk select_companion_tbl_b; site 0x0845f8 jsr-routed
code   0x3ffe70 +0x22  site_thunk select_companion_resolve_s1; site 0x084602 jsr-routed
code   0x3ffea0 +0x22  site_thunk select_companion_resolve_s2; site 0x084624 jsr-routed
code   0x3ffed0 +0x3c  site_thunk accent_color_aware_0; site 0x02ad82 jsr-routed
code   0x3fff10 +0x3c  site_thunk accent_color_aware_1; site 0x02ad94 jsr-routed
code   0x3fff50 +0x3c  site_thunk accent_color_aware_2; site 0x02b342 jsr-routed
code   0x3fff90 +0x3c  site_thunk accent_color_aware_3; site 0x02b7e8 jsr-routed
code   0x3fffd0 +0x2a  site_thunk ls_freeze_vs2_victim; site 0x023ad8 jsr-routed
code   0x405e10 +0x24  site_thunk ls_freeze_vs2_attacker; site 0x023ade jsr-routed
code   0x405e40 +0x16  site_thunk es_type51_dispatch; site 0x0185ca jsr-routed
code   0x405e60 +0x1e  site_thunk name_bank_variant_id; site 0x05fce0 jsr-routed
code   0x405e80 +0x1e  site_thunk splash_bank_variant_id; site 0x06c0e0 jsr-routed
code   0x405ea0 +0x16  site_thunk winquote_bank_variant_id; site 0x05f328 jsr-routed
code   0x405ec0 +0x7e  site_thunk select_sword_pal_variant_id; site 0x05f9d0 jsr-routed
data   0x405f40 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c2a3c
code   0x406080 +0x38  site_thunk select_pal_variant_id; site 0x05f146 jsr-routed
code   0x4060c0 +0x22  site_thunk voice_borrow_keep_tenant; site 0x00aef2 jsr-routed
