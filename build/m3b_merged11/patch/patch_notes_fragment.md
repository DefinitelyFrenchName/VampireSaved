...
data   0x412ba0 +0x54  select_wheel roster21 coord list (18 vanilla + 3 new)
data   0x412c00 +0x5e  select_wheel roster21 record (count 17->20, budget 0x55 CARRIED OVER, cptr -> 0x412ba0)
...
data   0x412c60 +0x1c  select_records portrait/p1 coord list (7 pairs, vs2 0x3036f8)
data   0x412c80 +0x26  select_records portrait/p1 record (vs2 0x2a63f0, 7 entries, budget 0x5b = vs2's own)
poke32 0x267476 <- 0x412c80  select_records portrait/p1 array row 0x13 (was 0x2719da, the base-half alias)
data   0x412cb0 +0x1c  select_records portrait/p2 coord list (7 pairs, vs2 0x303714)
data   0x412cd0 +0x26  select_records portrait/p2 record (vs2 0x2a6416, 7 entries, budget 0x5b = vs2's own)
poke32 0x2674f6 <- 0x412cd0  select_records portrait/p2 array row 0x13 (was 0x271dec, the base-half alias)
data   0x0cf360 +0x4  select_records name_banner/p1 coord list (1 pairs, vs2 0x303734)
data   0x412d00 +0xe  select_records name_banner/p1 record (vs2 0x2a657e, 1 entries, budget 0xa = vs2's own)
poke32 0x2675f6 <- 0x412d00  select_records name_banner/p1 array row 0x13 (was 0x272172, the base-half alias)
data   0x412d10 +0x8  select_records name_banner/p2 coord list (2 pairs, vs2 0x303da4)
data   0x412d20 +0x12  select_records name_banner/p2 record (vs2 0x2a76a4, 2 entries, budget 0x3 = vs2's own)
poke32 0x267676 <- 0x412d20  select_records name_banner/p2 array row 0x13 (was 0x273080, the base-half alias)
data   0x412d40 +0x14  select_records splash_p1/p1 coord list (5 pairs, vs2 0x3043a4)
data   0x412d60 +0x1e  select_records splash_p1/p1 record (vs2 0x2a7f68, 5 entries, budget 0x4b = vs2's own)
poke32 0x2672f6 <- 0x412d60  select_records splash_p1/p1 array row 0x13 (was 0x2734e8, the base-half alias)
data   0x412d80 +0x14  select_records splash_p2/p1 coord list (5 pairs, vs2 0x3043b8)
data   0x412da0 +0x1e  select_records splash_p2/p1 record (vs2 0x2a7f86, 5 entries, budget 0x4b = vs2's own)
poke32 0x267376 <- 0x412da0  select_records splash_p2/p1 array row 0x13 (was 0x27382e, the base-half alias)
data   0x412dc0 +0x8c  select_records win_quote/p1 coord list (35 pairs, vs2 0x30506c)
data   0x412e50 +0x96  select_records win_quote/p1 record (vs2 0x2a8cf8, 35 entries, budget 0xa7 = vs2's own)
poke32 0x2673f6 <- 0x412e50  select_records win_quote/p1 array row 0x13 (was 0x273d3c, the base-half alias)
...
data   0x412ef0 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c2a3c
...
code   0x3ffc90 +0x5e  site_thunk hitclass_map_extend; site 0x01a888 jmp-routed
...
# table_fix: region x026142 len 0x1400 -> 0x1440 (merged vanilla bank table; tenant rows written per tenant)
# layout group at 0x413030+0x79c6: code@0x413030, x057456@0x4157f6; -0x14 gap bytes recycled
...
# pcrel_escape_fix x026142: 9 escapes -> 6 trampolines (0 tripwired), pad 0x1440..0x14a0
code_file 0x41c700 +0x14a0  donovan x026142 (from vsav2 0x026142)
# bank_ref 0xd6ebe -> 0xbcd20 (delta rule, 16B byte-identical)
# bank_ref 0xd699e -> 0xbc800 (delta rule, 16B byte-identical)
# bank_ref 0xd671e -> 0xbc580 (delta rule, 16B byte-identical)
# bank_ref 0xd671e -> 0xbc580 (delta rule, 16B byte-identical)
...
poke32 0x0bf2da <- 0x00413818  tail_code_ptr[0x10] donovan code
...
poke32 0x0bd1ba <- 0x0041303c  dispatch_01[0x10] donovan handler
poke32 0x0bd23a <- 0x00413900  dispatch_02[0x10] donovan handler
poke32 0x0bd2ba <- 0x00413900  dispatch_03[0x10] donovan handler
poke32 0x0bd33a <- 0x00413900  dispatch_04[0x10] donovan handler
poke32 0x0bd3ba <- 0x00415124  dispatch_05[0x10] donovan handler
poke32 0x0bd43a <- 0x00413256  dispatch_06[0x10] donovan handler
poke32 0x0bd53a <- 0x00413482  dispatch_08[0x10] donovan handler
poke32 0x0bd5ba <- 0x004135ce  dispatch_09[0x10] donovan handler
poke32 0x0bd63a <- 0x004131e2  dispatch_10[0x10] donovan handler
poke32 0x0bd6ba <- 0x00415574  dispatch_11[0x10] donovan handler
poke32 0x0bd73a <- 0x00415790  dispatch_12[0x10] donovan handler
poke32 0x0bd7ba <- 0x004157c0  dispatch_13[0x10] donovan handler
poke32 0x0bd83a <- 0x004153c0  dispatch_14[0x10] donovan handler
poke32 0x0bf25a <- 0x004134a6  dispatch_15[0x10] donovan handler
poke32 0x0bf35a <- 0x0041501a  dispatch_16[0x10] donovan handler
poke32 0x0bf3da <- 0x00415108  dispatch_17[0x10] donovan handler
poke32 0x0bf4da <- 0x0041582a  dispatch_18[0x10] donovan handler
poke32 0x0bf65a <- 0x00415110  dispatch_19[0x10] donovan handler
