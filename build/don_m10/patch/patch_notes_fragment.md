...
data   0x412d00 +0x4  select_records name_banner/p1 coord list (1 pairs, vs2 0x303734)
...
data   0x412f00 +0x6040  win_pal_variant don_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c365c stride 0xb40)
code   0x3ffdd0 +0x16  win_pal_variant thunk, 1-way: don_win_pal d6==0x13 -> a0=0x412320; else vanilla pool 0x3ad700
...
code   0x418f40 +0x16  site_thunk es_type51_dispatch; site 0x0185ca jsr-routed
code   0x418f60 +0x1e  site_thunk name_bank_variant_id; site 0x05fce0 jsr-routed
code   0x418f80 +0x1e  site_thunk splash_bank_variant_id; site 0x06c0e0 jsr-routed
code   0x418fa0 +0x16  site_thunk winquote_bank_variant_id; site 0x05f328 jsr-routed
code   0x418fc0 +0x7e  site_thunk select_sword_pal_variant_id; site 0x05f9d0 jsr-routed
data   0x419040 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c2a3c
code   0x419180 +0x38  site_thunk select_pal_variant_id; site 0x05f146 jsr-routed
code   0x4191c0 +0x22  site_thunk voice_borrow_keep_tenant; site 0x00aef2 jsr-routed
