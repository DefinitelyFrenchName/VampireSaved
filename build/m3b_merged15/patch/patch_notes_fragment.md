...
data   0x412d10 +0x4  select_records name_banner/p1 coord list (1 pairs, vs2 0x303734)
data   0x412d20 +0xe  select_records name_banner/p1 record (vs2 0x2a657e, 1 entries, budget 0xa = vs2's own)
poke32 0x2675f6 <- 0x412d20  select_records name_banner/p1 array row 0x13 (was 0x272172, the base-half alias)
data   0x412d30 +0x8  select_records name_banner/p2 coord list (2 pairs, vs2 0x303da4)
data   0x412d40 +0x12  select_records name_banner/p2 record (vs2 0x2a76a4, 2 entries, budget 0x3 = vs2's own)
poke32 0x267676 <- 0x412d40  select_records name_banner/p2 array row 0x13 (was 0x273080, the base-half alias)
data   0x412d60 +0x14  select_records splash_p1/p1 coord list (5 pairs, vs2 0x3043a4)
data   0x412d80 +0x1e  select_records splash_p1/p1 record (vs2 0x2a7f68, 5 entries, budget 0x4b = vs2's own)
poke32 0x2672f6 <- 0x412d80  select_records splash_p1/p1 array row 0x13 (was 0x2734e8, the base-half alias)
data   0x412da0 +0x14  select_records splash_p2/p1 coord list (5 pairs, vs2 0x3043b8)
data   0x412dc0 +0x1e  select_records splash_p2/p1 record (vs2 0x2a7f86, 5 entries, budget 0x4b = vs2's own)
poke32 0x267376 <- 0x412dc0  select_records splash_p2/p1 array row 0x13 (was 0x27382e, the base-half alias)
data   0x412de0 +0x8c  select_records win_quote/p1 coord list (35 pairs, vs2 0x30506c)
data   0x412e70 +0x96  select_records win_quote/p1 record (vs2 0x2a8cf8, 35 entries, budget 0xa7 = vs2's own)
poke32 0x2673f6 <- 0x412e70  select_records win_quote/p1 array row 0x13 (was 0x273d3c, the base-half alias)
...
data   0x412f10 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c2a3c
...
# table_fix: region x026142 len 0x1400 -> 0x1440 (merged vanilla bank table; tenant rows written per tenant)
# layout group at 0x413050+0x79c6: code@0x413050, x057456@0x415816; -0x14 gap bytes recycled
...
data_file 0x42c4f0 +0x1e800  donovan anim (from vsav2 0x245872)
data_file 0x44acf0 +0x190  donovan aux0_0 (from vsav2 0x334170)
data_file 0x44ae80 +0xe620  donovan aux0_1 (from vsav2 0x336560)
...
code   0x468640 farm-port stub for 0x2916c (param at 0x3fffe0, common 0x29f4a)
code   0x468660 farm-port stub for 0x29184 (param at 0x468650, common 0x29f4a)
code   0x468680 farm-port stub for 0x2918c (param at 0x468670, common 0x29f4a)
code   0x468690 slot-clearing alloc wrapper for 0x15702 -> 0x16fba (0x80 cleared, +8 preserved)
...
code   0x4686c0 sound stub for 0x4ddc (vsavj sfx id 0x84)
code   0x4686e0 sound stub for 0x4f48 (vsavj sfx id 0x8b)
...
code   0x468700 sound stub for 0x4e92 (vsavj sfx id 0x93)
...
code   0x468720 sound stub for 0x4ec6 (vsavj sfx id 0x95)
code   0x468740 sound stub for 0x4e10 (vsavj sfx id 0x85)
...
code   0x468760 sound stub for 0x4e5e (vsavj sfx id 0x91)
code   0x468780 sound stub for 0x4e78 (vsavj sfx id 0x92)
...
code   0x4687a0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00440002, rts)
# code+0x966: owner_tag stamp_b_d16 type 68 -> jsr 0x4687a0 (huitzil id 0x10)
# code+0xa22: owner_tag stamp_b_d16 type 68 -> jsr 0x4687a0 (huitzil id 0x10)
code   0x4687b0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00450002, rts)
# code+0xdf0: owner_tag stamp_b_d16 type 69 -> jsr 0x4687b0 (huitzil id 0x10)
# code+0xe20: owner_tag stamp_b_d16 type 69 -> jsr 0x4687b0 (huitzil id 0x10)
code   0x4687c0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00460002, rts)
# code+0x1070: owner_tag stamp_b_d16 type 70 -> jsr 0x4687c0 (huitzil id 0x10)
# code+0x14b0: owner_tag stamp_b_d16 type 70 -> jsr 0x4687c0 (huitzil id 0x10)
code   0x4687d0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00470002, rts)
# code+0x1950: owner_tag stamp_b_d16 type 71 -> jsr 0x4687d0 (huitzil id 0x10)
code   0x4687e0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00480002, rts)
# code+0x2026: owner_tag stamp_b_d16 type 72 -> jsr 0x4687e0 (huitzil id 0x10)
# code+0x2048: owner_tag stamp_b_d16 type 72 -> jsr 0x4687e0 (huitzil id 0x10)
# code+0x13bc: data_in_code reroute -> helper 0x468800, table 0x4687f0 (DATA view of vsav2 0x056074; FG capture-pose random table (native draws seqs 1/3/5))
# code+0x1390: data_in_code reroute -> helper 0x468820, table 0x468810 (DATA view of vsav2 0x056064; FG capture-pose table 2 (seqs 0x56-0x59))
# code+0x17c8: data_in_code reroute -> helper 0x468840, table 0x468830 (DATA view of vsav2 0x05649c; capture-pose table 3 (seqs 0x56-0x59 twin))
# code+0x17f4: data_in_code reroute -> helper 0x468860, table 0x468850 (DATA view of vsav2 0x0564ac; capture-pose table 4 (01/03/05 twin))
code_file 0x413050 +0x27c6  donovan code (from vsav2 0x054C90)
data_file 0x4594a0 +0x32b2  donovan hitbox (from vsav2 0x0C4250)
...
data_file 0x45c760 +0x3c6  donovan hitbox_proj (from vsav2 0x0D05C0)
code   0x468870 ILLEGAL  TRIPWIRE for unresolved 0x2cd38
# x022400+0x112: unresolved 0x2cd38 -> tripwire 0x468870
# bank_ref 0xd8998 -> 0xbe7fa (delta rule, 16B byte-identical)
code   0x468880 ILLEGAL  TRIPWIRE for unresolved 0x7f5f4
# x022400+0xa82: unresolved 0x7f5f4 -> tripwire 0x468880
code   0x468890 ILLEGAL  TRIPWIRE for unresolved 0x82480
# x022400+0xada: unresolved 0x82480 -> tripwire 0x468890
# bank_ref 0xd9638 -> 0xbf49a (delta rule, known table base)
code   0x4688a0 ILLEGAL  TRIPWIRE for unresolved 0x828fe
# x022400+0xb66: unresolved 0x828fe -> tripwire 0x4688a0
# bank_ref 0xd8998 -> 0xbe7fa (delta rule, 16B byte-identical)
code   0x4688b0 ILLEGAL  TRIPWIRE for unresolved 0xbdb0
# x022400+0x12ac: unresolved 0xbdb0 -> tripwire 0x4688b0
# x022400+0x12fa: unresolved 0x2cd38 -> tripwire 0x468870
code   0x4688c0 ILLEGAL  TRIPWIRE for unresolved 0x8278c
# x022400+0x14c0: unresolved 0x8278c -> tripwire 0x4688c0
code   0x4688d0 ILLEGAL  TRIPWIRE for unresolved 0x7b368
# x022400+0x15c8: unresolved 0x7b368 -> tripwire 0x4688d0
code   0x4688e0 ILLEGAL  TRIPWIRE for unresolved 0x3d1c
# x022400+0x662: unresolved 0x3d1c -> tripwire 0x4688e0
code   0x4688f0 ILLEGAL  TRIPWIRE for unresolved 0x3dc6
# x022400+0x696: unresolved 0x3dc6 -> tripwire 0x4688f0
code   0x468900 ILLEGAL  TRIPWIRE for unresolved 0x3e70
# x022400+0x80c: unresolved 0x3e70 -> tripwire 0x468900
# x022400+0x86c: unresolved 0x3d1c -> tripwire 0x4688e0
code   0x468910 ILLEGAL  TRIPWIRE for unresolved 0x3c44
# x022400+0x1078: unresolved 0x3c44 -> tripwire 0x468910
code   0x468920 ILLEGAL  TRIPWIRE for unresolved 0x3cb0
# x022400+0x13a0: unresolved 0x3cb0 -> tripwire 0x468920
code   0x468930 ILLEGAL  TRIPWIRE for unresolved 0x3a28
# x022400+0x13e0: unresolved 0x3a28 -> tripwire 0x468930
# x022400+0x13ee: unresolved 0x3a28 -> tripwire 0x468930
code   0x468940 ILLEGAL  TRIPWIRE for unresolved 0x3980
# x022400+0x1404: unresolved 0x3980 -> tripwire 0x468940
code   0x468950 ILLEGAL  TRIPWIRE for unresolved 0x41be
# x022400+0x14ce: unresolved 0x41be -> tripwire 0x468950
...
code_file 0x41aa20 +0x1780  donovan x022400 (from vsav2 0x022400)
code   0x468960 ILLEGAL  TRIPWIRE for unresolved 0x2cbde
# x02592a+0x16e: unresolved 0x2cbde -> tripwire 0x468960
code   0x468970 ILLEGAL  TRIPWIRE for unresolved 0x2ce0a
# x02592a+0x18a: unresolved 0x2ce0a -> tripwire 0x468970
code   0x468980 ILLEGAL  TRIPWIRE for unresolved 0x2ce3e
# x02592a+0x368: unresolved 0x2ce3e -> tripwire 0x468980
code   0x468990 ILLEGAL  TRIPWIRE for unresolved 0x364a
# x02592a+0x44a: unresolved 0x364a -> tripwire 0x468990
# pcrel_escape_fix x02592a: 89 escapes -> 35 trampolines (0 tripwired), pad 0x456..0x576
code_file 0x41c1a0 +0x576  donovan x02592a (from vsav2 0x02592A)
# x026142+0x1414: bank table row 0x13 <- 0x1000 (bank 4, WIDE encoding; vanilla row was 0x2000) — tenant-driven
# x026142+0x140e: bank table row 0x10 <- 0x1000 (bank 4, WIDE encoding; vanilla row was 0x6000) — tenant-driven
# x026142+0x1410: bank table row 0x11 <- 0x1000 (bank 4, WIDE encoding; vanilla row was 0x6000) — tenant-driven
# x026142+0x13ee: table_fix 48 bytes (merged vanilla bank table; tenant rows written per tenant)
...
# pcrel_escape_fix x026142: 9 escapes -> 6 trampolines (0 tripwired), pad 0x1440..0x14a0
code_file 0x41c720 +0x14a0  donovan x026142 (from vsav2 0x026142)
# bank_ref 0xd6ebe -> 0xbcd20 (delta rule, 16B byte-identical)
# bank_ref 0xd699e -> 0xbc800 (delta rule, 16B byte-identical)
# bank_ref 0xd671e -> 0xbc580 (delta rule, 16B byte-identical)
# bank_ref 0xd671e -> 0xbc580 (delta rule, 16B byte-identical)
...
code_file 0x41dbc0 +0xe00  donovan x028122 (from vsav2 0x028122)
code   0x4689a0 slot-clearing alloc wrapper for 0x1572e -> 0x16fe6 (0x80 cleared, +8 preserved)
code   0x4689e0 farm-port stub for 0x2915c (param at 0x4689d0, common 0x29f4a)
code   0x468a00 farm-port stub for 0x29164 (param at 0x4689f0, common 0x29f4a)
code   0x468a10 sound stub for 0x4f96 (vsavj sfx id 0xa1)
code   0x468a30 ILLEGAL  TRIPWIRE for unresolved 0x4223c
# x057456+0x3b42: unresolved 0x4223c -> tripwire 0x468a30
code   0x468a40 ILLEGAL  TRIPWIRE for unresolved 0x42cee
# x057456+0x421a: unresolved 0x42cee -> tripwire 0x468a40
code   0x468a50 ILLEGAL  TRIPWIRE for unresolved 0x448d4
# x057456+0x50cc: unresolved 0x448d4 -> tripwire 0x468a50
...
code   0x468a60 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00400002, rts)
# x057456+0x8fc: owner_tag stamp_b_d16 type 64 -> jsr 0x468a60 (huitzil id 0x10)
code   0x468a70 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00410002, rts)
# x057456+0xa24: owner_tag stamp_b_d16 type 65 -> jsr 0x468a70 (huitzil id 0x10)
code   0x468a80 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00420002, rts)
# x057456+0x14ce: owner_tag stamp_b_d16 type 66 -> jsr 0x468a80 (huitzil id 0x10)
code   0x468a90 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00430002, rts)
# x057456+0x18f6: owner_tag stamp_b_d16 type 67 -> jsr 0x468a90 (huitzil id 0x10)
code   0x468aa0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c003e0002, rts)
# x057456+0x29c4: owner_tag stamp_b_d16 type 62 -> jsr 0x468aa0 (huitzil id 0x10)
code   0x468ab0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c003f0002, rts)
# x057456+0x2b4a: owner_tag stamp_b_d16 type 63 -> jsr 0x468ab0 (huitzil id 0x10)
code   0x468ac0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c004b0002, rts)
# x057456+0x2b56: owner_tag stamp_b_d16 type 75 -> jsr 0x468ac0 (huitzil id 0x10)
code   0x468ad0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c003d0002, rts)
# x057456+0x39fe: owner_tag stamp_b_d16 type 61 -> jsr 0x468ad0 (huitzil id 0x10)
code   0x468ae0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00490002, rts)
# x057456+0x4624: owner_tag stamp_b_d16 type 73 -> jsr 0x468ae0 (huitzil id 0x10)
code   0x468af0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01014200, rts)
# x057456+0x4d12: owner_tag stamp_l_ind type 66 -> jsr 0x468af0 (huitzil id 0x10)
code   0x468b00 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01004202, rts)
# x057456+0x4ddc: owner_tag stamp_l_ind type 66 -> jsr 0x468b00 (huitzil id 0x10)
code_file 0x415816 +0x5200  donovan x057456 (from vsav2 0x057456)
code   0x468b10 ILLEGAL  TRIPWIRE for unresolved 0x12f484
# x05c800+0x152a: unresolved 0x12f484 -> tripwire 0x468b10
# x05c800+0x16a4: unresolved 0x12f484 -> tripwire 0x468b10
code   0x468b20 ILLEGAL  TRIPWIRE for unresolved 0x167bf4
# x05c800+0x2622: unresolved 0x167bf4 -> tripwire 0x468b20
# x05c800+0x2a20: unresolved 0x167bf4 -> tripwire 0x468b20
code   0x468b30 ILLEGAL  TRIPWIRE for unresolved 0x17f176
# x05c800+0x2ae4: unresolved 0x17f176 -> tripwire 0x468b30
# x05c800+0x3034: unresolved 0x17f176 -> tripwire 0x468b30
code   0x468b40 ILLEGAL  TRIPWIRE for unresolved 0x181592
# x05c800+0x3072: unresolved 0x181592 -> tripwire 0x468b40
# x05c800+0x1456: char-id imm 0x10 -> 0x10
# x05c800+0x738: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 (Jedah band) / WIDE bank 4)
# x05c800+0x58d4: port_patch 397c60000018 -> 397c10000018 (OBJ bank setter (a4 form): vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
# x05c800+0x5994: port_patch 397c60000018 -> 397c10000018 (OBJ bank setter (a4 form): vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
code   0x468b50 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01003b22, rts)
# x05c800+0x83a: owner_tag stamp_l_ind type 59 -> jsr 0x468b50 (huitzil id 0x10)
# pcrel_escape_fix x05c800: 2 escapes -> 1 trampolines (0 tripwired), pad 0x6a00..0x6a20
code_file 0x41e9c0 +0x6a20  donovan x05c800 (from vsav2 0x05C800)
code_file 0x3ffd60 +0x280  donovan x0672d0 (from vsav2 0x0672D0)
code_file 0x4253e0 +0x2f6  donovan x067550 (from vsav2 0x067550)
code   0x468b60 sound stub for 0x4fb0 (vsavj sfx id 0xa0)
code   0x468b80 sound stub for 0x4fca (vsavj sfx id 0xa5)
code_file 0x4256e0 +0x1ba  donovan x067846 (from vsav2 0x067846)
code_file 0x4258a0 +0x60c  donovan x067a00 (from vsav2 0x067A00)
...
code_file 0x425eb0 +0x44c  donovan x06800c (from vsav2 0x06800C)
code   0x468ba0 sound stub for 0x4f2e (vsavj sfx id 0x199)
code_file 0x426300 +0x310  donovan x068458 (from vsav2 0x068458)
code_file 0x426610 +0x264  donovan x068768 (from vsav2 0x068768)
code   0x468bc0 sound stub for 0x4efa (vsavj sfx id 0x90)
code_file 0x426880 +0x2ac  donovan x0689cc (from vsav2 0x0689CC)
code   0x468be0 +0x40  patched clone of 0x5459a for vs2 0x5c77e (unmasked set-anim entry; false byte-matc)
code   0x468c20 sound stub for 0x4f62 (vsavj sfx id 0x7f)
code_file 0x426b30 +0x3ce  donovan x068c78 (from vsav2 0x068C78)
# x069046+0x260: type_renumber stamp_l_ind type 114 -> 124 (huitzil's own number; site 0x5e542)
code   0x468c40 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01004206, rts)
# x069046+0x4a: owner_tag stamp_l_ind type 66 -> jsr 0x468c40 (huitzil id 0x10)
code   0x468c50 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01004204, rts)
# x069046+0x130: owner_tag stamp_l_ind type 66 -> jsr 0x468c50 (huitzil id 0x10)
code_file 0x426f00 +0x2b0  donovan x069046 (from vsav2 0x069046)
...
code_file 0x4271b0 +0x368  donovan x0692f6 (from vsav2 0x0692F6)
# x06965e+0xac: type_renumber stamp_l_ind type 114 -> 124 (huitzil's own number; site 0x5e542)
code_file 0x427520 +0x100  donovan x06965e (from vsav2 0x06965E)
code   0x468c60 ILLEGAL  TRIPWIRE for unresolved 0x22f2d2
# x06cac0+0x546: unresolved 0x22f2d2 -> tripwire 0x468c60
code   0x468c70 ILLEGAL  TRIPWIRE for unresolved 0x4cb0
# x06cac0+0x552: unresolved 0x4cb0 -> tripwire 0x468c70
code   0x468c80 ILLEGAL  TRIPWIRE for unresolved 0x4c96
# x06cac0+0x586: unresolved 0x4c96 -> tripwire 0x468c80
# x06cac0+0x58e: unresolved 0x22f2d2 -> tripwire 0x468c60
# bank_ref 0xd7118 -> 0xbcf7a (delta rule, known table base)
# bank_ref 0xd7118 -> 0xbcf7a (delta rule, known table base)
code   0x468c90 ILLEGAL  TRIPWIRE for unresolved 0x3a90
# x06cac0+0xacc: unresolved 0x3a90 -> tripwire 0x468c90
code   0x468ca0 ILLEGAL  TRIPWIRE for unresolved 0x3a76
# x06cac0+0xb18: unresolved 0x3a76 -> tripwire 0x468ca0
# x06cac0+0xb60: unresolved 0x3a76 -> tripwire 0x468ca0
# x06cac0+0xbac: unresolved 0x3a76 -> tripwire 0x468ca0
# pcrel_escape_fix x06cac0: 0 escapes -> 0 trampolines (0 tripwired), pad 0xebc..0xf1c
code_file 0x427620 +0xca8  donovan x06cac0 code (from vsav2 0x06CAC0)
data_file 0x4282c8 +0x274  donovan x06cac0 RAW TABLES (unencrypted; vs2 0x06D768)
code   0x468cb0 ILLEGAL  TRIPWIRE for unresolved 0x281696
# x088512+0x348: unresolved 0x281696 -> tripwire 0x468cb0
code   0x468cc0 ILLEGAL  TRIPWIRE for unresolved 0x289b14
# x088512+0x126a: unresolved 0x289b14 -> tripwire 0x468cc0
# x088512+0x127c: unresolved 0x289b14 -> tripwire 0x468cc0
code   0x468cd0 ILLEGAL  TRIPWIRE for unresolved 0x28ed08
# x088512+0x1de2: unresolved 0x28ed08 -> tripwire 0x468cd0
code   0x468ce0 ILLEGAL  TRIPWIRE for unresolved 0x36784a
# x088512+0x1dee: unresolved 0x36784a -> tripwire 0x468ce0
code   0x468cf0 sound stub for 0x50ee (vsavj sfx id 0x7e)
code   0x468d10 sound stub for 0x50a0 (vsavj sfx id 0x7b)
code   0x468d30 sound stub for 0x50d4 (vsavj sfx id 0x7d)
code   0x468d50 sound stub for 0x50ba (vsavj sfx id 0x7c)
code   0x468d70 sound stub for 0x4e2a (vsavj sfx id 0x8f)
code   0x468d90 sound stub for 0x4df6 (vsavj sfx id 0x86)
code   0x468db0 ILLEGAL  TRIPWIRE for unresolved 0x2695d0
# x088512+0x2894: unresolved 0x2695d0 -> tripwire 0x468db0
code   0x468dc0 ILLEGAL  TRIPWIRE for unresolved 0x2abd58
# x088512+0x359c: unresolved 0x2abd58 -> tripwire 0x468dc0
# x088512+0x22c: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
# x088512+0x1814: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
# x088512+0x2bee: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
...
code   0x468dd0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01014102, rts)
# x088512+0x2ebc: owner_tag stamp_l_ind type 65 -> jsr 0x468dd0 (huitzil id 0x10)
code   0x468de0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01014100, rts)
# x088512+0x2f54: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x3034: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x305e: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x3088: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x30b2: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x30dc: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x3106: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x3130: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x329a: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x32c4: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x32ee: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x3318: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x3342: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x336c: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x3396: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x33c0: owner_tag stamp_l_ind type 65 -> jsr 0x468de0 (huitzil id 0x10)
# x088512+0x3ae4: data_in_code reroute -> helper 0x468ef0, table 0x468df0 (DATA view of vsav2 0x08c042; pod-zone word offset/record table (a3 re-derived from it; self-relative))
code_file 0x428540 +0x3b78  donovan x088512 code (from vsav2 0x088512)
data_file 0x42c0b8 +0x20  donovan x088512 RAW TABLES (unencrypted; vs2 0x08C08A)
code_file 0x42c0e0 +0x100  donovan x0926e4 (from vsav2 0x0926E4)
code_file 0x42c1e0 +0x306  donovan x093460 (from vsav2 0x093460)
data_file 0x45cb30 +0x900  donovan x0d143e (from vsav2 0x0D143E)
code   0x468f00 ILLEGAL  TRIPWIRE for unresolved 0x2c31aa
# x2b7ef4+0xb0d9: unresolved 0x2c31aa -> tripwire 0x468f00
code   0x468f10 ILLEGAL  TRIPWIRE for unresolved 0x2c31e4
# x2b7ef4+0xb0fd: unresolved 0x2c31e4 -> tripwire 0x468f10
code   0x468f20 ILLEGAL  TRIPWIRE for unresolved 0x2c3236
# x2b7ef4+0xb105: unresolved 0x2c3236 -> tripwire 0x468f20
code   0x468f30 ILLEGAL  TRIPWIRE for unresolved 0x2c325c
# x2b7ef4+0xb10d: unresolved 0x2c325c -> tripwire 0x468f30
code   0x468f40 ILLEGAL  TRIPWIRE for unresolved 0x2c3272
# x2b7ef4+0xb115: unresolved 0x2c3272 -> tripwire 0x468f40
code   0x468f50 ILLEGAL  TRIPWIRE for unresolved 0x2c3280
# x2b7ef4+0xb11d: unresolved 0x2c3280 -> tripwire 0x468f50
code   0x468f60 ILLEGAL  TRIPWIRE for unresolved 0x2c3296
# x2b7ef4+0xb125: unresolved 0x2c3296 -> tripwire 0x468f60
code   0x468f70 ILLEGAL  TRIPWIRE for unresolved 0x2c32a4
# x2b7ef4+0xb12d: unresolved 0x2c32a4 -> tripwire 0x468f70
code   0x468f80 ILLEGAL  TRIPWIRE for unresolved 0x2c32b2
# x2b7ef4+0xb135: unresolved 0x2c32b2 -> tripwire 0x468f80
# x2b7ef4: effect-c5 — 5714 bank-1 codes kept NATIVE (art -> group C bank 5); 114 coord lists matched, 617 ported (11336B fragment)
data_file 0x45d430 +0xb20c  donovan x2b7ef4 (from vsav2 0x2B7EF4)
data     0x46bbe0 +0x500  sprite palette block (vsav2 0x39BC9C); poke32 0x38c1d8 (table 0x38c198 row 0x10)
data     0x46c0e0 +0xdc0  effect palette block (vsav2 0x3AB69C); poke32 0x38c258 (table 0x38c218 row 0x10)
poke32 0x0bceba <- 0x0042c4f0  anim_index_a[0x10] donovan anim
poke32 0x0bcf3a <- 0x0043104c  anim_index_a2[0x10] donovan anim
poke32 0x0bcfba <- 0x0042eb5a  anim_index_b[0x10] donovan anim
poke32 0x0bd03a <- 0x0042eae4  anim_index_c[0x10] donovan anim
poke32 0x0bd0ba <- 0x00436b54  anim_index_proj[0x10] donovan anim
data   0x0bd8fa +0x8  param32_a[0x10] value
data   0x0bde7a +0x30  jump_params[0x10] value
poke32 0x0bd9ba <- 0x004595c0  hitbox_base[0x10] donovan hitbox
poke32 0x0bda3a <- 0x004594a0  hitbox_comp[0x10] donovan hitbox
poke32 0x0bdaba <- 0x0045c794  proj_hitbox_base[0x10] donovan hitbox_proj
poke32 0x0bdb3a <- 0x0045c760  proj_hitbox_comp[0x10] donovan hitbox_proj
...
poke32 0x0bf2da <- 0x00413838  tail_code_ptr[0x10] donovan code
...
poke32 0x0bd1ba <- 0x0041305c  dispatch_01[0x10] donovan handler
poke32 0x0bd23a <- 0x00413920  dispatch_02[0x10] donovan handler
poke32 0x0bd2ba <- 0x00413920  dispatch_03[0x10] donovan handler
poke32 0x0bd33a <- 0x00413920  dispatch_04[0x10] donovan handler
poke32 0x0bd3ba <- 0x00415144  dispatch_05[0x10] donovan handler
poke32 0x0bd43a <- 0x00413276  dispatch_06[0x10] donovan handler
poke32 0x0bd53a <- 0x004134a2  dispatch_08[0x10] donovan handler
poke32 0x0bd5ba <- 0x004135ee  dispatch_09[0x10] donovan handler
poke32 0x0bd63a <- 0x00413202  dispatch_10[0x10] donovan handler
poke32 0x0bd6ba <- 0x00415594  dispatch_11[0x10] donovan handler
poke32 0x0bd73a <- 0x004157b0  dispatch_12[0x10] donovan handler
poke32 0x0bd7ba <- 0x004157e0  dispatch_13[0x10] donovan handler
poke32 0x0bd83a <- 0x004153e0  dispatch_14[0x10] donovan handler
poke32 0x0bf25a <- 0x004134c6  dispatch_15[0x10] donovan handler
poke32 0x0bf35a <- 0x0041503a  dispatch_16[0x10] donovan handler
poke32 0x0bf3da <- 0x00415128  dispatch_17[0x10] donovan handler
poke32 0x0bf4da <- 0x0041584a  dispatch_18[0x10] donovan handler
poke32 0x0bf65a <- 0x00415130  dispatch_19[0x10] donovan handler
...
data   0x46cea0 +0x1d80  data_port grab_hold_keyframes PLACED (tenant at 0x10; host block 0x92c4a untouched) <- vsav2 0x0c56aa (0 fixes)
poke32 0x0be2ba <- 0x46cea0  data_port grab_hold_keyframes ptr-table 0xbe27a row 0x10
...
data   0x46ec20 +0xc0  sound_table hui_sfx_records <- vsav2 0x0c742a (24 entries; kept ['0x110@1', '0x111@2', '0x112@3', '0x08d@5', '0x07f@6', '0x080@7', '0x081@8', '0x082@9', '0x0d8@10', '0x199@11', '0x083@12', '0x088@13', '0x089@14', '0x08a@15', '0x08b@16', '0x08c@17', '0x08e@18', '0x096@19', '0x094@20', '0x199@21', '0x198@22']; zeroed 2 unplayable ids; remapped [(5, '0x745', '0x8d'), (6, '0x735', '0x7f'), (7, '0x736', '0x80'), (8, '0x737', '0x81'), (9, '0x738', '0x82'), (10, '0x739', '0xd8'), (11, '0x73a', '0x199'), (12, '0x73b', '0x83'), (13, '0x740', '0x88'), (14, '0x741', '0x89'), (15, '0x742', '0x8a'), (16, '0x743', '0x8b'), (17, '0x744', '0x8c'), (18, '0x746', '0x8e'), (19, '0x74e', '0x96'), (20, '0x74c', '0x94')])
poke32 0x0bf45a <- 0x46ec20  sound_table hui_sfx_records per-char ptr row 0x10 (was 0x938ba)
data   0x46ece0 +0x1c  select_records portrait/p1 coord list (7 pairs, vs2 0x303238)
data   0x46ed00 +0x26  select_records portrait/p1 record (vs2 0x2a5e4a, 7 entries, budget 0x5b = vs2's own)
poke32 0x26746a <- 0x46ed00  select_records portrait/p1 array row 0x10 (was 0x271924, the base-half alias)
data   0x46ed30 +0x1c  select_records portrait/p2 coord list (7 pairs, vs2 0x3035a8)
data   0x46ed50 +0x26  select_records portrait/p2 record (vs2 0x2a625a, 7 entries, budget 0x5b = vs2's own)
poke32 0x2674ea <- 0x46ed50  select_records portrait/p2 array row 0x10 (was 0x271d36, the base-half alias)
data   0x46ed80 +0x4  select_records name_banner/p1 coord list (1 pairs, vs2 0x303730)
data   0x46ed90 +0xe  select_records name_banner/p1 record (vs2 0x2a64d6, 1 entries, budget 0x8 = vs2's own)
poke32 0x2675ea <- 0x46ed90  select_records name_banner/p1 array row 0x10 (was 0x272148, the base-half alias)
data   0x46eda0 +0x8  select_records name_banner/p2 coord list (2 pairs, vs2 0x303d9c)
data   0x46edb0 +0x12  select_records name_banner/p2 record (vs2 0x2a7506, 2 entries, budget 0x3 = vs2's own)
poke32 0x26766a <- 0x46edb0  select_records name_banner/p2 array row 0x10 (was 0x273052, the base-half alias)
data   0x46edd0 +0x14  select_records splash_p1/p1 coord list (5 pairs, vs2 0x304028)
data   0x46edf0 +0x1e  select_records splash_p1/p1 record (vs2 0x2a7b06, 5 entries, budget 0x4c = vs2's own)
poke32 0x2672ea <- 0x46edf0  select_records splash_p1/p1 array row 0x10 (was 0x273462, the base-half alias)
data   0x46ee10 +0x14  select_records splash_p2/p1 coord list (5 pairs, vs2 0x3042b8)
data   0x46ee30 +0x1e  select_records splash_p2/p1 record (vs2 0x2a7e36, 5 entries, budget 0x4c = vs2's own)
poke32 0x26736a <- 0x46ee30  select_records splash_p2/p1 array row 0x10 (was 0x2737a8, the base-half alias)
data   0x46ee50 +0x84  select_records win_quote/p1 coord list (33 pairs, vs2 0x304bd8)
data   0x46eee0 +0x8e  select_records win_quote/p1 record (vs2 0x2a881e, 33 entries, budget 0x8a = vs2's own)
poke32 0x2673ea <- 0x46eee0  select_records win_quote/p1 array row 0x10 (was 0x273aee, the base-half alias)
...
# site_thunk splash_bank_variant_id: body deferred to the 0x06c0e0 chain (30 bytes)
# site_thunk winquote_bank_variant_id: body deferred to the 0x05f328 chain (22 bytes)
code   0x46ef70 +0x1a  site_thunk tenant_jump_seq; site 0x022a0e jmp-routed
code   0x46ef90 +0xe  site_thunk shadow_seq_guard; site 0x08245c jmp-routed
data   0x46efa0 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c12dc
# site_thunk select_pal_variant_id: body deferred to the 0x05f146 chain (56 bytes)
data   0x46f0e0 +0x54  site_thunk throw_arc_tables data block <- vsav2 0x0279b4
data   0x46f140 +0x370  site_thunk throw_arc_tables data block <- vsav2 0x027a08
code   0x46f4b0 +0x42  site_thunk throw_arc_tables; site 0x028386 jmp-routed
code   0x46f500 +0xe  site_thunk idmask_victim_spawn; site 0x060ef0 jmp-routed
code   0x46f510 +0x10  site_thunk idmask_piece_subtype; site 0x05e7d6 jmp-routed
data   0x46f520 +0x100  site_thunk df_gold_variant_id data block <- vsav2 0x3abedc
code   0x46f620 +0x54  site_thunk df_gold_variant_id; site 0x02a8d6 jmp-routed
code   0x46f680 +0xfe  site_thunk beam_list_type6; site 0x01b6aa jmp-routed
code   0x46f780 +0x1d6  site_thunk index_window_018468; site 0x018460 jmp-routed
...
code   0x080aec +0x4  code_ptr beam_effect_class16 (00080b44 -> 0042c1e0 = x093460+0x0)
code   0x080b28 +0x4  code_ptr beam_effect_class31 (00080b44 -> 0042c0e0 = x0926e4+0x0)
# stage 1: Jedah hitbox block 0x093AAA+0x0 (base 0x93b6a comp 0x93aaa)
# table_fix: region x026142 len 0x1400 -> 0x1440 (merged vanilla bank table; tenant rows written per tenant)
data_file 0x483820 +0x1b500  donovan anim (from vsav2 0x264086)
data_file 0x49ed20 +0x190  donovan aux0_0 (from vsav2 0x334170)
data_file 0x49eeb0 +0x190  donovan aux0_1 (from vsav2 0x33CD00)
data_file 0x49f040 +0xd830  donovan aux0_2 (from vsav2 0x344A60)
code   0x4b9d90 farm-port stub for 0x2916c (param at 0x4b9d70, common 0x29f4a)
code   0x4b9db0 farm-port stub for 0x2915c (param at 0x4b9da0, common 0x29f4a)
code   0x4b9dd0 farm-port stub for 0x29164 (param at 0x4b9dc0, common 0x29f4a)
code   0x4b9df0 farm-port stub for 0x29184 (param at 0x4b9de0, common 0x29f4a)
code   0x4b9e10 farm-port stub for 0x2918c (param at 0x4b9e00, common 0x29f4a)
code   0x4b9e20 sound stub for 0x4f96 (vsavj sfx id 0xa1)
code   0x4b9e40 slot-clearing alloc wrapper for 0x15702 -> 0x16fba (0x80 cleared, +8 preserved)
code   0x4b9e70 slot-clearing alloc wrapper for 0x1572e -> 0x16fe6 (0x80 cleared, +8 preserved)
code   0x4b9ea0 ILLEGAL  TRIPWIRE for unresolved 0x4223c
# code+0x3ad8: unresolved 0x4223c -> tripwire 0x4b9ea0
code   0x4b9eb0 ILLEGAL  TRIPWIRE for unresolved 0x42cee
# code+0x41b0: unresolved 0x42cee -> tripwire 0x4b9eb0
code   0x4b9ec0 ILLEGAL  TRIPWIRE for unresolved 0x448d4
# code+0x5062: unresolved 0x448d4 -> tripwire 0x4b9ec0
...
code   0x4b9ed0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c00400002, rts)
# code+0x892: owner_tag stamp_b_d16 type 64 -> jsr 0x4b9ed0 (pyron id 0x11)
code   0x4b9ee0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c00410002, rts)
# code+0x9ba: owner_tag stamp_b_d16 type 65 -> jsr 0x4b9ee0 (pyron id 0x11)
code   0x4b9ef0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c00420002, rts)
# code+0x1464: owner_tag stamp_b_d16 type 66 -> jsr 0x4b9ef0 (pyron id 0x11)
code   0x4b9f00 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c00430002, rts)
# code+0x188c: owner_tag stamp_b_d16 type 67 -> jsr 0x4b9f00 (pyron id 0x11)
code   0x4b9f10 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c003e0002, rts)
# code+0x295a: owner_tag stamp_b_d16 type 62 -> jsr 0x4b9f10 (pyron id 0x11)
code   0x4b9f20 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c003f0002, rts)
# code+0x2ae0: owner_tag stamp_b_d16 type 63 -> jsr 0x4b9f20 (pyron id 0x11)
code   0x4b9f30 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c004b0002, rts)
# code+0x2aec: owner_tag stamp_b_d16 type 75 -> jsr 0x4b9f30 (pyron id 0x11)
code   0x4b9f40 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c003d0002, rts)
# code+0x3994: owner_tag stamp_b_d16 type 61 -> jsr 0x4b9f40 (pyron id 0x11)
code   0x4b9f50 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c00490002, rts)
# code+0x45ba: owner_tag stamp_b_d16 type 73 -> jsr 0x4b9f50 (pyron id 0x11)
code   0x4b9f60 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01014200, rts)
# code+0x4ca8: owner_tag stamp_l_ind type 66 -> jsr 0x4b9f60 (pyron id 0x11)
code   0x4b9f70 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01004202, rts)
# code+0x4d72: owner_tag stamp_l_ind type 66 -> jsr 0x4b9f70 (pyron id 0x11)
# code+0x1ee: data_in_code [pointer-inline] lea.l #0x4b9f80,a2 in place (DATA view of vsav2 0x0576f4; air-dive per-strength (xv,yv) rows; a2 re-derived by `lea (a2,d2.w),a2`)
code_file 0x46f960 +0x5200  donovan code (from vsav2 0x0574C0)
data_file 0x4ac870 +0x16b6  donovan hitbox (from vsav2 0x0C7502)
...
data_file 0x4adf30 +0x322  donovan hitbox_proj (from vsav2 0x0D0986)
# x026142+0x1414: bank table row 0x13 <- 0x1000 (bank 4, WIDE encoding; vanilla row was 0x2000) — tenant-driven
# x026142+0x140e: bank table row 0x10 <- 0x1000 (bank 4, WIDE encoding; vanilla row was 0x6000) — tenant-driven
# x026142+0x1410: bank table row 0x11 <- 0x1000 (bank 4, WIDE encoding; vanilla row was 0x6000) — tenant-driven
# x026142+0x13ee: table_fix 48 bytes (merged vanilla bank table; tenant rows written per tenant)
...
# bank_ref 0xd7198 -> 0xbcffa (delta rule, known table base)
# pcrel_escape_fix x026142: 9 escapes -> 6 trampolines (0 tripwired), pad 0x1440..0x14a0
code_file 0x474b60 +0x14a0  donovan x026142 (from vsav2 0x026142)
# bank_ref 0xd6ebe -> 0xbcd20 (delta rule, 16B byte-identical)
# bank_ref 0xd699e -> 0xbc800 (delta rule, 16B byte-identical)
# bank_ref 0xd671e -> 0xbc580 (delta rule, 16B byte-identical)
# bank_ref 0xd671e -> 0xbc580 (delta rule, 16B byte-identical)
...
# x028122+0x9c0: port_patch 426db496 -> 426db444 (obj-hit dmg: clr white var -> vsavj layout (-0x4BBC))
# x028122+0x9d0: port_patch 3b42b496 -> 3b42b444 (obj-hit dmg: white damage -> vsavj layout (-0x4BBC))
code_file 0x476000 +0xe00  donovan x028122 (from vsav2 0x028122)
code   0x4b9f90 ILLEGAL  TRIPWIRE for unresolved 0x12f484
# x05c800+0x152a: unresolved 0x12f484 -> tripwire 0x4b9f90
# x05c800+0x16a4: unresolved 0x12f484 -> tripwire 0x4b9f90
code   0x4b9fa0 ILLEGAL  TRIPWIRE for unresolved 0x167bf4
# x05c800+0x2622: unresolved 0x167bf4 -> tripwire 0x4b9fa0
# x05c800+0x2a20: unresolved 0x167bf4 -> tripwire 0x4b9fa0
code   0x4b9fb0 ILLEGAL  TRIPWIRE for unresolved 0x17f176
# x05c800+0x2ae4: unresolved 0x17f176 -> tripwire 0x4b9fb0
# x05c800+0x3034: unresolved 0x17f176 -> tripwire 0x4b9fb0
code   0x4b9fc0 ILLEGAL  TRIPWIRE for unresolved 0x181592
# x05c800+0x3072: unresolved 0x181592 -> tripwire 0x4b9fc0
# x05c800+0x738: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 (Jedah band) / WIDE bank 4)
# x05c800+0x58d4: port_patch 397c60000018 -> 397c10000018 (OBJ bank setter (a4 form): vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
# x05c800+0x5994: port_patch 397c60000018 -> 397c10000018 (OBJ bank setter (a4 form): vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
code   0x4b9fd0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01003b22, rts)
# x05c800+0x83a: owner_tag stamp_l_ind type 59 -> jsr 0x4b9fd0 (pyron id 0x11)
# pcrel_escape_fix x05c800: 2 escapes -> 1 trampolines (0 tripwired), pad 0x6a00..0x6a20
code_file 0x476e00 +0x6a20  donovan x05c800 (from vsav2 0x05C800)
code_file 0x47d820 +0x280  donovan x0672d0 (from vsav2 0x0672D0)
code_file 0x47daa0 +0x2f6  donovan x067550 (from vsav2 0x067550)
code   0x4b9fe0 sound stub for 0x4fb0 (vsavj sfx id 0xa0)
code   0x4ba000 sound stub for 0x4fca (vsavj sfx id 0xa5)
code_file 0x47dda0 +0x1ba  donovan x067846 (from vsav2 0x067846)
code_file 0x47df60 +0x60c  donovan x067a00 (from vsav2 0x067A00)
...
code_file 0x47e570 +0x44c  donovan x06800c (from vsav2 0x06800C)
code_file 0x47e9c0 +0x310  donovan x068458 (from vsav2 0x068458)
code_file 0x47ecd0 +0x264  donovan x068768 (from vsav2 0x068768)
code   0x4ba020 sound stub for 0x4efa (vsavj sfx id 0x90)
code_file 0x47ef40 +0x2ac  donovan x0689cc (from vsav2 0x0689CC)
code   0x4ba040 +0x40  patched clone of 0x5459a for vs2 0x5c77e (unmasked set-anim entry; false byte-matc)
code   0x4ba080 sound stub for 0x4f62 (vsavj sfx id 0x7f)
code_file 0x47f1f0 +0x3ce  donovan x068c78 (from vsav2 0x068C78)
# x069046+0x260: type_renumber stamp_l_ind type 114 -> 125 (pyron's own number; site 0x5e542)
code   0x4ba0a0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01004206, rts)
# x069046+0x4a: owner_tag stamp_l_ind type 66 -> jsr 0x4ba0a0 (pyron id 0x11)
code   0x4ba0b0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01004204, rts)
# x069046+0x130: owner_tag stamp_l_ind type 66 -> jsr 0x4ba0b0 (pyron id 0x11)
code_file 0x47f5c0 +0x2b0  donovan x069046 (from vsav2 0x069046)
...
code_file 0x47f870 +0x368  donovan x0692f6 (from vsav2 0x0692F6)
# x06965e+0xac: type_renumber stamp_l_ind type 114 -> 125 (pyron's own number; site 0x5e542)
code_file 0x47fbe0 +0x100  donovan x06965e (from vsav2 0x06965E)
code   0x4ba0c0 ILLEGAL  TRIPWIRE for unresolved 0x281696
# x088512+0x348: unresolved 0x281696 -> tripwire 0x4ba0c0
code   0x4ba0d0 ILLEGAL  TRIPWIRE for unresolved 0x289b14
# x088512+0x126a: unresolved 0x289b14 -> tripwire 0x4ba0d0
# x088512+0x127c: unresolved 0x289b14 -> tripwire 0x4ba0d0
code   0x4ba0e0 ILLEGAL  TRIPWIRE for unresolved 0x24edd4
# x088512+0x1362: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x13a0: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x13e4: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x1428: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x1464: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x14a2: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x150a: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x154e: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x1590: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x15f0: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x1670: unresolved 0x24edd4 -> tripwire 0x4ba0e0
code   0x4ba0f0 ILLEGAL  TRIPWIRE for unresolved 0x24a3ce
# x088512+0x16d8: unresolved 0x24a3ce -> tripwire 0x4ba0f0
# x088512+0x1732: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x1796: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x17fa: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x18ee: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x191c: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x194a: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x1994: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x1cd2: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x1d1a: unresolved 0x24edd4 -> tripwire 0x4ba0e0
code   0x4ba100 ILLEGAL  TRIPWIRE for unresolved 0x28ed08
# x088512+0x1de2: unresolved 0x28ed08 -> tripwire 0x4ba100
code   0x4ba110 ILLEGAL  TRIPWIRE for unresolved 0x36784a
# x088512+0x1dee: unresolved 0x36784a -> tripwire 0x4ba110
code   0x4ba120 sound stub for 0x50ee (vsavj sfx id 0x7e)
code   0x4ba140 sound stub for 0x50a0 (vsavj sfx id 0x7b)
code   0x4ba160 sound stub for 0x50d4 (vsavj sfx id 0x7d)
code   0x4ba180 sound stub for 0x50ba (vsavj sfx id 0x7c)
code   0x4ba1a0 ILLEGAL  TRIPWIRE for unresolved 0x25111e
# x088512+0x2156: unresolved 0x25111e -> tripwire 0x4ba1a0
# x088512+0x21d2: unresolved 0x25111e -> tripwire 0x4ba1a0
# x088512+0x26e2: unresolved 0x25111e -> tripwire 0x4ba1a0
code   0x4ba1b0 sound stub for 0x4e2a (vsavj sfx id 0x8f)
code   0x4ba1d0 sound stub for 0x4df6 (vsavj sfx id 0x86)
# x088512+0x28ce: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x290c: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x294a: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x2986: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x29c4: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x2a2c: unresolved 0x24edd4 -> tripwire 0x4ba0e0
# x088512+0x2a6a: unresolved 0x24edd4 -> tripwire 0x4ba0e0
code   0x4ba1f0 ILLEGAL  TRIPWIRE for unresolved 0x2abd58
# x088512+0x359c: unresolved 0x2abd58 -> tripwire 0x4ba1f0
# x088512+0x22c: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
# x088512+0x1814: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
# x088512+0x2bee: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
...
code   0x4ba200 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01014102, rts)
# x088512+0x2ebc: owner_tag stamp_l_ind type 65 -> jsr 0x4ba200 (pyron id 0x11)
code   0x4ba210 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01014100, rts)
# x088512+0x2f54: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x3034: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x305e: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x3088: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x30b2: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x30dc: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x3106: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x3130: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x329a: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x32c4: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x32ee: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x3318: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x3342: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x336c: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x3396: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x33c0: owner_tag stamp_l_ind type 65 -> jsr 0x4ba210 (pyron id 0x11)
# x088512+0x3ae4: data_in_code reroute -> helper 0x4ba320, table 0x4ba220 (DATA view of vsav2 0x08c042; pod-zone word offset/record table (a3 re-derived from it; self-relative; shared-zone copy))
code_file 0x47fce0 +0x3b40  donovan x088512 (from vsav2 0x088512)
data_file 0x4ae260 +0x900  donovan x0d143e (from vsav2 0x0D143E)
code   0x4ba330 ILLEGAL  TRIPWIRE for unresolved 0x2c3136
# x2b7ef4+0xb0c9: unresolved 0x2c3136 -> tripwire 0x4ba330
code   0x4ba340 ILLEGAL  TRIPWIRE for unresolved 0x2c3170
# x2b7ef4+0xb0d1: unresolved 0x2c3170 -> tripwire 0x4ba340
code   0x4ba350 ILLEGAL  TRIPWIRE for unresolved 0x2c31aa
# x2b7ef4+0xb0d9: unresolved 0x2c31aa -> tripwire 0x4ba350
code   0x4ba360 ILLEGAL  TRIPWIRE for unresolved 0x2c31e4
# x2b7ef4+0xb0fd: unresolved 0x2c31e4 -> tripwire 0x4ba360
code   0x4ba370 ILLEGAL  TRIPWIRE for unresolved 0x2c3236
# x2b7ef4+0xb105: unresolved 0x2c3236 -> tripwire 0x4ba370
code   0x4ba380 ILLEGAL  TRIPWIRE for unresolved 0x2c325c
# x2b7ef4+0xb10d: unresolved 0x2c325c -> tripwire 0x4ba380
code   0x4ba390 ILLEGAL  TRIPWIRE for unresolved 0x2c3272
# x2b7ef4+0xb115: unresolved 0x2c3272 -> tripwire 0x4ba390
code   0x4ba3a0 ILLEGAL  TRIPWIRE for unresolved 0x2c3280
# x2b7ef4+0xb11d: unresolved 0x2c3280 -> tripwire 0x4ba3a0
code   0x4ba3b0 ILLEGAL  TRIPWIRE for unresolved 0x2c3296
# x2b7ef4+0xb125: unresolved 0x2c3296 -> tripwire 0x4ba3b0
code   0x4ba3c0 ILLEGAL  TRIPWIRE for unresolved 0x2c32a4
# x2b7ef4+0xb12d: unresolved 0x2c32a4 -> tripwire 0x4ba3c0
code   0x4ba3d0 ILLEGAL  TRIPWIRE for unresolved 0x2c32b2
# x2b7ef4+0xb135: unresolved 0x2c32b2 -> tripwire 0x4ba3d0
# x2b7ef4: effect-c5 — 5714 bank-1 codes kept NATIVE (art -> group C bank 5); 114 coord lists matched, 617 ported (11336B fragment)
data_file 0x4aeb60 +0xb20c  donovan x2b7ef4 (from vsav2 0x2B7EF4)
data     0x4bd030 +0x500  sprite palette block (vsav2 0x39C19C); poke32 0x38c1dc (table 0x38c198 row 0x11)
data     0x4bd530 +0xdc0  effect palette block (vsav2 0x3AC45C); poke32 0x38c25c (table 0x38c218 row 0x11)
poke32 0x0bcebe <- 0x00483820  anim_index_a[0x11] donovan anim
poke32 0x0bcf3e <- 0x00488d6a  anim_index_a2[0x11] donovan anim
poke32 0x0bcfbe <- 0x00485cee  anim_index_b[0x11] donovan anim
poke32 0x0bd03e <- 0x0048576a  anim_index_c[0x11] donovan anim
poke32 0x0bd0be <- 0x0048cd4e  anim_index_proj[0x11] donovan anim
data   0x0bd902 +0x8  param32_a[0x11] value
data   0x0bdeaa +0x30  jump_params[0x11] value
poke32 0x0bd9be <- 0x004ac96c  hitbox_base[0x11] donovan hitbox
poke32 0x0bda3e <- 0x004ac870  hitbox_comp[0x11] donovan hitbox
poke32 0x0bdabe <- 0x004adf38  proj_hitbox_base[0x11] donovan hitbox_proj
poke32 0x0bdb3e <- 0x004adf30  proj_hitbox_comp[0x11] donovan hitbox_proj
...
poke32 0x0bf2de <- 0x0046ff52  tail_code_ptr[0x11] donovan code
...
code   0x4be2f0 ILLEGAL  TRIPWIRE for unresolved 0x65c22
# obj_hook@0x54470 type 59 owner-dispatch fallback: unresolved 0x65c22 -> tripwire 0x4be2f0
code   0x4be300 obj_hook type 59 OWNER-DISPATCH (tag; donovan 0xcbe32; unknown owner -> tripwire 0x4be2f0)
...
code   0x4be320 ILLEGAL  TRIPWIRE for unresolved 0x65e5a
# obj_hook@0x54470 type 61 owner-dispatch fallback: unresolved 0x65e5a -> tripwire 0x4be320
code   0x4be330 obj_hook type 61 OWNER-DISPATCH (tag; donovan 0xcc06a; unknown owner -> tripwire 0x4be320)
...
code   0x4be350 ILLEGAL  TRIPWIRE for unresolved 0x66ec4
# obj_hook@0x54470 type 62 owner-dispatch fallback: unresolved 0x66ec4 -> tripwire 0x4be350
code   0x4be360 obj_hook type 62 OWNER-DISPATCH (tag; donovan 0xcd0d4; unknown owner -> tripwire 0x4be350)
...
code   0x4be380 ILLEGAL  TRIPWIRE for unresolved 0x6717c
# obj_hook@0x54470 type 63 owner-dispatch fallback: unresolved 0x6717c -> tripwire 0x4be380
code   0x4be390 obj_hook type 63 OWNER-DISPATCH (tag; donovan 0xc28a0; unknown owner -> tripwire 0x4be380)
...
code   0x4be3b0 ILLEGAL  TRIPWIRE for unresolved 0x672d0
# obj_hook@0x54470 type 64 owner-dispatch fallback: unresolved 0x672d0 -> tripwire 0x4be3b0
code   0x4be3c0 obj_hook type 64 OWNER-DISPATCH (tag; huitzil 0x3ffd60, pyron 0x47d820; unknown owner -> tripwire 0x4be3b0)
code   0x4be3f0 ILLEGAL  TRIPWIRE for unresolved 0x67550
# obj_hook@0x54470 type 65 owner-dispatch fallback: unresolved 0x67550 -> tripwire 0x4be3f0
code   0x4be400 obj_hook type 65 OWNER-DISPATCH (tag; huitzil 0x4253e0, pyron 0x47daa0; unknown owner -> tripwire 0x4be3f0)
...
code   0x4be430 ILLEGAL  TRIPWIRE for unresolved 0x67846
# obj_hook@0x54470 type 66 owner-dispatch fallback: unresolved 0x67846 -> tripwire 0x4be430
code   0x4be440 obj_hook type 66 OWNER-DISPATCH (tag; huitzil 0x4256e0, pyron 0x47dda0; unknown owner -> tripwire 0x4be430)
...
code   0x4be470 ILLEGAL  TRIPWIRE for unresolved 0x67a00
# obj_hook@0x54470 type 67 owner-dispatch fallback: unresolved 0x67a00 -> tripwire 0x4be470
code   0x4be480 obj_hook type 67 OWNER-DISPATCH (tag; huitzil 0x4258a0, pyron 0x47df60; unknown owner -> tripwire 0x4be470)
code   0x4be4b0 ILLEGAL  TRIPWIRE for unresolved 0x6800c
# obj_hook@0x54470 type 68 owner-dispatch fallback: unresolved 0x6800c -> tripwire 0x4be4b0
code   0x4be4c0 obj_hook type 68 OWNER-DISPATCH (tag; huitzil 0x425eb0, pyron 0x47e570; unknown owner -> tripwire 0x4be4b0)
code   0x4be4f0 ILLEGAL  TRIPWIRE for unresolved 0x68458
# obj_hook@0x54470 type 69 owner-dispatch fallback: unresolved 0x68458 -> tripwire 0x4be4f0
code   0x4be500 obj_hook type 69 OWNER-DISPATCH (tag; huitzil 0x426300, pyron 0x47e9c0; unknown owner -> tripwire 0x4be4f0)
code   0x4be530 ILLEGAL  TRIPWIRE for unresolved 0x68768
# obj_hook@0x54470 type 70 owner-dispatch fallback: unresolved 0x68768 -> tripwire 0x4be530
code   0x4be540 obj_hook type 70 OWNER-DISPATCH (tag; huitzil 0x426610, pyron 0x47ecd0; unknown owner -> tripwire 0x4be530)
code   0x4be570 ILLEGAL  TRIPWIRE for unresolved 0x689cc
# obj_hook@0x54470 type 71 owner-dispatch fallback: unresolved 0x689cc -> tripwire 0x4be570
code   0x4be580 obj_hook type 71 OWNER-DISPATCH (tag; huitzil 0x426880, pyron 0x47ef40; unknown owner -> tripwire 0x4be570)
code   0x4be5b0 ILLEGAL  TRIPWIRE for unresolved 0x68c78
# obj_hook@0x54470 type 72 owner-dispatch fallback: unresolved 0x68c78 -> tripwire 0x4be5b0
code   0x4be5c0 obj_hook type 72 OWNER-DISPATCH (tag; huitzil 0x426b30, pyron 0x47f1f0; unknown owner -> tripwire 0x4be5b0)
code   0x4be5f0 ILLEGAL  TRIPWIRE for unresolved 0x69046
# obj_hook@0x54470 type 73 owner-dispatch fallback: unresolved 0x69046 -> tripwire 0x4be5f0
code   0x4be600 obj_hook type 73 OWNER-DISPATCH (tag; huitzil 0x426f00, pyron 0x47f5c0; unknown owner -> tripwire 0x4be5f0)
...
code   0x4be630 ILLEGAL  TRIPWIRE for unresolved 0x692f6
# obj_hook@0x54470 type 74 owner-dispatch fallback: unresolved 0x692f6 -> tripwire 0x4be630
code   0x4be640 obj_hook type 74 OWNER-DISPATCH (tag; huitzil 0x4271b0, pyron 0x47f870; unknown owner -> tripwire 0x4be630)
code   0x4be670 ILLEGAL  TRIPWIRE for unresolved 0x6965e
# obj_hook@0x54470 type 75 owner-dispatch fallback: unresolved 0x6965e -> tripwire 0x4be670
code   0x4be680 obj_hook type 75 OWNER-DISPATCH (tag; huitzil 0x427520, pyron 0x47fbe0; unknown owner -> tripwire 0x4be670)
...
code   0x4be6b0 +0x15c  obj_walker: 0x54458 relocated verbatim + its extended type table at +0x2c (59 vanilla + 17 ported, 17 placed); dispatch site 0x54470 left VANILLA
code   2 caller operand(s) of jsr 0x54458 -> 0x4be6b0 (0x009436, 0x020310)
...
code   0x4be810 ILLEGAL  TRIPWIRE for unresolved 0x6a70c
# obj_hook@0x5e542 type 121: unresolved 0x6a70c -> tripwire 0x4be810
# obj_hook@0x5e542 type 122: unresolved 0x6a70c -> tripwire 0x4be810
# obj_hook@0x5e542 type 123: unresolved 0x6a70c -> tripwire 0x4be810
#   obj_hook renumbered type 124 = huitzil's 114 -> 0x428540 (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 125 = pyron's 114 -> 0x47fce0 (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 126 = huitzil's 115 -> 0x4297fa (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 127 = pyron's 115 -> 0x480f9a (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 128 = huitzil's 116 -> 0x42a29c (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 129 = pyron's 116 -> 0x481a3c (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 130 = huitzil's 117 -> 0x42a61a (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 131 = pyron's 117 -> 0x481dba (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 132 = huitzil's 118 -> 0x42ad26 (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 133 = pyron's 118 -> 0x4824c6 (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 134 = huitzil's 119 -> 0x42b108 (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 135 = pyron's 119 -> 0x4828a8 (its OWN copy; stamps rewritten in-region, 14z-82)
code   0x4be820 +0x24c  obj_walker: 0x5e52a relocated verbatim + its extended type table at +0x2c (114 vanilla + 10 ported, 7 placed, 12 renumbered); dispatch site 0x5e542 left VANILLA
code   21 caller operand(s) of jsr 0x5e52a -> 0x4be820 (0x0053f6, 0x005410, 0x00577c, 0x0057a8, 0x00590a, 0x005ebc, 0x00943c, 0x009caa, 0x009f36, 0x00a188, 0x00a804, 0x00abcc, 0x010dfa, 0x012a3e, 0x012d16, 0x012e4c, 0x012e66, 0x020316, 0x021638, 0x021ada, 0x021dea)
poke32 0x0bd13e <- 0x004718c4  dispatch_00[0x11] donovan handler
poke32 0x0bd1be <- 0x0046f96e  dispatch_01[0x11] donovan handler
poke32 0x0bd23e <- 0x00470190  dispatch_02[0x11] donovan handler
poke32 0x0bd2be <- 0x00470190  dispatch_03[0x11] donovan handler
poke32 0x0bd33e <- 0x00470190  dispatch_04[0x11] donovan handler
poke32 0x0bd3be <- 0x00471272  dispatch_05[0x11] donovan handler
poke32 0x0bd43e <- 0x0046fcf2  dispatch_06[0x11] donovan handler
poke32 0x0bd53e <- 0x00470114  dispatch_08[0x11] donovan handler
poke32 0x0bd5be <- 0x0046fe62  dispatch_09[0x11] donovan handler
poke32 0x0bd63e <- 0x0046fc60  dispatch_10[0x11] donovan handler
poke32 0x0bd6be <- 0x004716bc  dispatch_11[0x11] donovan handler
poke32 0x0bd73e <- 0x004717da  dispatch_12[0x11] donovan handler
poke32 0x0bd7be <- 0x0047188e  dispatch_13[0x11] donovan handler
poke32 0x0bd83e <- 0x0047147c  dispatch_14[0x11] donovan handler
poke32 0x0bf25e <- 0x0046fde0  dispatch_15[0x11] donovan handler
poke32 0x0bf35e <- 0x004711c8  dispatch_16[0x11] donovan handler
poke32 0x0bf3de <- 0x00471230  dispatch_17[0x11] donovan handler
poke32 0x0bf4de <- 0x00471902  dispatch_18[0x11] donovan handler
poke32 0x0bf65e <- 0x00471266  dispatch_19[0x11] donovan handler
...
data   0x4bea70 +0xb8  sound_table pyr_sfx_records <- vsav2 0x0c8b18 (23 entries; kept ['0x110@1', '0x111@3', '0x112@4', '0x0a4@5', '0x0a5@6', '0x097@7', '0x0a0@8', '0x0a1@9', '0x0a2@10', '0x0a1@11', '0x0a3@12', '0x09e@13', '0x0a6@16', '0x09a@18', '0x202@21']; zeroed 6 unplayable ids; remapped [(5, '0x72d', '0xa4'), (6, '0x72e', '0xa5'), (7, '0x720', '0x97'), (8, '0x729', '0xa0'), (9, '0x72a', '0xa1'), (10, '0x72b', '0xa2'), (11, '0x72a', '0xa1'), (12, '0x72c', '0xa3'), (13, '0x727', '0x9e'), (16, '0x72f', '0xa6'), (18, '0x723', '0x9a')])
poke32 0x0bf45e <- 0x4bea70  sound_table pyr_sfx_records per-char ptr row 0x11 (was 0x95894)
data   0x4beb30 +0x20  select_records portrait/p1 coord list (8 pairs, vs2 0x3036b8)
data   0x4beb50 +0x2a  select_records portrait/p1 record (vs2 0x2a639c, 8 entries, budget 0x61 = vs2's own)
poke32 0x26746e <- 0x4beb50  select_records portrait/p1 array row 0x11 (was 0x27195e, the base-half alias)
data   0x4beb80 +0x20  select_records portrait/p2 coord list (8 pairs, vs2 0x3036d8)
data   0x4beba0 +0x2a  select_records portrait/p2 record (vs2 0x2a63c6, 8 entries, budget 0x61 = vs2's own)
poke32 0x2674ee <- 0x4beba0  select_records portrait/p2 array row 0x11 (was 0x271d70, the base-half alias)
data   0x4bebd0 +0x4  select_records name_banner/p1 coord list (1 pairs, vs2 0x2fd9b4)
data   0x4bebe0 +0xe  select_records name_banner/p1 record (vs2 0x2a6570, 1 entries, budget 0x6 = vs2's own)
poke32 0x2675ee <- 0x4bebe0  select_records name_banner/p1 array row 0x11 (was 0x272156, the base-half alias)
data   0x4bebf0 +0x8  select_records name_banner/p2 coord list (2 pairs, vs2 0x303d9c)
data   0x4bec00 +0x12  select_records name_banner/p2 record (vs2 0x2a7680, 2 entries, budget 0x3 = vs2's own)
poke32 0x26766e <- 0x4bec00  select_records name_banner/p2 array row 0x11 (was 0x273060, the base-half alias)
data   0x4bec20 +0x14  select_records splash_p1/p1 coord list (5 pairs, vs2 0x30437c)
data   0x4bec40 +0x1e  select_records splash_p1/p1 record (vs2 0x2a7f2c, 5 entries, budget 0x4f = vs2's own)
poke32 0x2672ee <- 0x4bec40  select_records splash_p1/p1 array row 0x11 (was 0x273494, the base-half alias)
data   0x4bec60 +0x14  select_records splash_p2/p1 coord list (5 pairs, vs2 0x304390)
data   0x4bec80 +0x1e  select_records splash_p2/p1 record (vs2 0x2a7f4a, 5 entries, budget 0x4f = vs2's own)
poke32 0x26736e <- 0x4bec80  select_records splash_p2/p1 array row 0x11 (was 0x2737da, the base-half alias)
data   0x4beca0 +0x38  select_records win_quote/p1 coord list (14 pairs, vs2 0x305034)
data   0x4bece0 +0x42  select_records win_quote/p1 record (vs2 0x2a8cb6, 14 entries, budget 0xb5 = vs2's own)
poke32 0x2673ee <- 0x4bece0  select_records win_quote/p1 array row 0x11 (was 0x273b68, the base-half alias)
...
data   0x4bed30 +0x6040  win_pal_variant don_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c365c stride 0xb40)
data   0x4c4d70 +0x6040  win_pal_variant hui_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c329c stride 0xb40)
data   0x4cadb0 +0x6040  win_pal_variant pyr_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c35bc stride 0xb40)
code   0x4d0df0 +0x32  win_pal_variant thunk, 3-way: don_win_pal d6==0x13 -> a0=0x4be150, hui_win_pal d6==0x10 -> a0=0x4c4370, pyr_win_pal d6==0x11 -> a0=0x4ca310; else vanilla pool 0x3ad700
code   0x05f1b6 +6     win_pal_variant: movea.l #pool -> jsr 0x4d0df0
# site_thunk name_bank_variant_id: body deferred to the 0x05fce0 chain (30 bytes)
# site_thunk splash_bank_variant_id: body deferred to the 0x06c0e0 chain (30 bytes)
# site_thunk winquote_bank_variant_id: body deferred to the 0x05f328 chain (22 bytes)
data   0x4d0e30 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c28fc
# site_thunk select_pal_variant_id: body deferred to the 0x05f146 chain (56 bytes)
code   0x4d0f70 +0x7c  site_thunk 3-way chain at 0x05f146: select_pal_variant_id, select_pal_variant_id, select_pal_variant_id (22 shared tail bytes)
code   0x4d0ff0 +0x32  site_thunk 3-way chain at 0x05f328: winquote_bank_variant_id, winquote_bank_variant_id, winquote_bank_variant_id (2 shared tail bytes)
code   0x4d1030 +0x3e  site_thunk 3-way chain at 0x05fce0: name_bank_variant_id, name_bank_variant_id, name_bank_variant_id (8 shared tail bytes)
code   0x4d1070 +0x3e  site_thunk 3-way chain at 0x06c0e0: splash_bank_variant_id, splash_bank_variant_id, splash_bank_variant_id (8 shared tail bytes)
code   0x4d10b0 ILLEGAL  TRIPWIRE for unresolved 0xf2f2f2
# init_shim chain fall-through (an id no declaring tenant claims): unresolved 0xf2f2f2 -> tripwire 0x4d10b0
code   0x4d10c0 MERGED init shim (pool latch A5+0x7966, seeder 0x16c64, phase-gated; flavor (A6+0x3c2) donovan<-0x01/held 0x00->handler 0xc1030, huitzil<-0x00/held 0x01->handler 0x415810 [Start bitmask 0xff8060]; unmatched id -> tripwire 0x4d10b0) planted on 2 dispatch rows (F2 fix)
poke32 0x0bd146 <- 0x004d10c0  dispatch_00[0x13] donovan handler via MERGED seed shim (F2)
poke32 0x0bd13a <- 0x004d10c0  dispatch_00[0x10] huitzil handler via MERGED seed shim (F2)
