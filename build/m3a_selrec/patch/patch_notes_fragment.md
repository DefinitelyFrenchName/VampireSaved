...
code   0x02a7c8 ENGINE HOOK: +0x14e state dispatch -> thunk 0x0cbfb0 (vanilla ids ghost-clean via jmp-back; ids 0xb2-0xc8 -> 12 synthesized stubs at 0x3ffb30, ext table 0x0cbf80)
...
data   0x400010 +0xe50  data_port throw_victim_keyframes PLACED (tenant at 0x13; host block 0xb19f8 untouched) <- vsav2 0x0ca1ca (0 fixes)
...
data   0x401310 +0x4  select_records highlight/p1 coord list (1 pairs, vs2 0x303734)
data   0x401320 +0xe  select_records highlight/p1 record (vs2 0x2a6750, 1 entries, budget 0x5 = vs2's own, PLACEHOLDER tile code(s) 0xB000 — unplaced until the gfx half)
poke32 0x268a4e <- 0x401320  select_records highlight/p1 array row 0x13 (was 0x272594, the base-half alias)
data   0x401330 +0x4  select_records highlight/p2 coord list (1 pairs, vs2 0x2fc354)
data   0x401340 +0xe  select_records highlight/p2 record (vs2 0x2a6f00, 1 entries, budget 0x2 = vs2's own, PLACEHOLDER tile code(s) 0xB129 — unplaced until the gfx half)
poke32 0x268ace <- 0x401340  select_records highlight/p2 array row 0x13 (was 0x2727c0, the base-half alias)
...
code   0x0fff60 +0x18  site_thunk select_companion_tbl_b; site 0x0845f8 jsr-routed
code   0x0fff80 +0x22  site_thunk select_companion_resolve_s1; site 0x084602 jsr-routed
code   0x0fffb0 +0x22  site_thunk select_companion_resolve_s2; site 0x084624 jsr-routed
code   0x3ffd90 +0x3c  site_thunk accent_color_aware_0; site 0x02ad82 jsr-routed
code   0x3ffdd0 +0x3c  site_thunk accent_color_aware_1; site 0x02ad94 jsr-routed
code   0x3ffe10 +0x3c  site_thunk accent_color_aware_2; site 0x02b342 jsr-routed
code   0x3ffe50 +0x3c  site_thunk accent_color_aware_3; site 0x02b7e8 jsr-routed
...
code   0x3ffef0 +0x1e  site_thunk name_bank_variant_id; site 0x05fce0 jsr-routed
code   0x3fff10 +0x1e  site_thunk splash_bank_variant_id; site 0x06c0e0 jsr-routed
code   0x3fff30 +0x16  site_thunk winquote_bank_variant_id; site 0x05f328 jsr-routed
code   0x3fff50 +0x7e  site_thunk select_sword_pal_variant_id; site 0x05f9d0 jsr-routed
data   0x401350 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c2a3c
code   0x401490 +0x38  site_thunk select_pal_variant_id; site 0x05f146 jsr-routed
