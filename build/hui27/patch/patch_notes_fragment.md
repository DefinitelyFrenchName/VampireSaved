...
code   0x0fcb90 init shim (pool latch A5+0x7966, seeder 0x16c64; flavor (A6+0x3c2)<-0x00, Start-held [0xff8060 bit=player] -> 0x01) -> handler 0x0c1e60
...
code   0x0fcc40 +0x16  win_pal_variant hui_win_pal thunk (d6==TT -> a0 = 0x40c8f0; else vanilla pool 0x3ad700)
code   0x05f1b6 +6     win_pal_variant hui_win_pal: movea.l #pool -> jsr 0xfcc40
...
code   0x0fcda0 +0x102  site_thunk beam_list_type6; site 0x01b6aa jmp-routed
