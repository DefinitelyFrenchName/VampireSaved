...
#   obj_hook authored type 124 -> 0x0d3ef0 (from src 0x6cac0; vs2 row-8 companion machine (the beam/effect family) as a tenant-only type)
data   0x0fc350 +0x1f4  proj_hook extended type table (114 vanilla + 10 ported, 7 placed)
code   0x0fc550 obj_hook thunk (ghost-clean: returns to vanilla jsr)
code   0x05e542 ENGINE HOOK: dispatch -> jmp thunk; vanilla jsr (A0) at 0x5e548 untouched (vanilla types identical via table copy)
code   0x0fc570 init shim (pool latch A5+0x7966, seeder 0x16c64; flavor (A6+0x3c2)<-0x00, Start-held [0xff8060 bit=player] -> 0x01) -> handler 0x0c1e60
poke32 0x0bd13a <- 0x000fc570  dispatch_00[0x10] donovan handler via seed shim
...
code   0x0fc5c0 +0x28  select_wheel roster21: march mid-row retarget 0x16/0x19 -> 0x02 (dest computation 0x2b598 jsr-routed)
code   0x0fc5f0 +0x28  select_wheel roster21: march mid-row retarget 0x16/0x19 -> 0x02 (dest computation 0x2b7d8 jsr-routed)
...
code   0x0fc620 +0x16  win_pal_variant hui_win_pal thunk (d6==TT -> a0 = 0x40ab70; else vanilla pool 0x3ad700)
code   0x05f1b6 +6     win_pal_variant hui_win_pal: movea.l #pool -> jsr 0xfc620
code   0x0fc640 +0x1a  site_thunk tenant_jump_seq; site 0x022a0e jmp-routed
code   0x0fc660 +0xe  site_thunk shadow_seq_guard; site 0x08245c jmp-routed
code   0x0fc670 +0x1e  site_thunk name_bank_variant_id; site 0x05fce0 jsr-routed
code   0x0fc690 +0x1e  site_thunk splash_bank_variant_id; site 0x06c0e0 jsr-routed
code   0x0fc6b0 +0x16  site_thunk winquote_bank_variant_id; site 0x05f328 jsr-routed
data   0x410070 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c12dc
code   0x0fc6d0 +0x38  site_thunk select_pal_variant_id; site 0x05f146 jsr-routed
...
code   0x0fc710 +0x42  site_thunk throw_arc_tables; site 0x028386 jmp-routed
code   0x0fc760 +0x20  site_thunk tenant_type_stamp; site 0x060ee0 jmp-routed
code   0x0fc780 +0xe  site_thunk idmask_victim_spawn; site 0x060ef0 jmp-routed
code   0x0fc790 +0x10  site_thunk idmask_piece_subtype; site 0x05e7d6 jmp-routed
