...
data   0x0fca80 +0x130  proj_hook extended type table (59 vanilla + 17 ported, 12 placed)
code   0x0fcbb0 obj_hook thunk (ghost-clean: returns to vanilla jsr)
...
data   0x0fcbe0 +0x1f0  proj_hook extended type table (114 vanilla + 10 ported, 7 placed)
code   0x0fcdd0 obj_hook thunk (ghost-clean: returns to vanilla jsr)
code   0x05e542 ENGINE HOOK: dispatch -> jmp thunk; vanilla jsr (A0) at 0x5e548 untouched (vanilla types identical via table copy)
code   0x0fcdf0 init shim (pool latch A5+0x7966, seeder 0x16c64; flavor (A6+0x3c2) huitzil<-0x00/held 0x01 [Start bitmask 0xff8060, bit=player]) -> handler 0x0c1e60
poke32 0x0bd13a <- 0x000fcdf0  dispatch_00[0x10] donovan handler via seed shim
...
code   0x0fce40 +0x28  select_wheel roster21: march mid-row retarget 0x16/0x19 -> 0x02 (dest computation 0x2b598 jsr-routed)
code   0x0fce70 +0x28  select_wheel roster21: march mid-row retarget 0x16/0x19 -> 0x02 (dest computation 0x2b7d8 jsr-routed)
...
code   0x0fcea0 +0x16  win_pal_variant thunk, 1-way: hui_win_pal d6==0x10 -> a0=0x40c9b0; else vanilla pool 0x3ad700
code   0x05f1b6 +6     win_pal_variant: movea.l #pool -> jsr 0xfcea0
code   0x0fcec0 +0x1a  site_thunk tenant_jump_seq; site 0x022a0e jmp-routed
code   0x0fcee0 +0xe  site_thunk shadow_seq_guard; site 0x08245c jmp-routed
code   0x0fcef0 +0x1e  site_thunk name_bank_variant_id; site 0x05fce0 jsr-routed
code   0x0fcf10 +0x1e  site_thunk splash_bank_variant_id; site 0x06c0e0 jsr-routed
code   0x0fcf30 +0x16  site_thunk winquote_bank_variant_id; site 0x05f328 jsr-routed
data   0x411eb0 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c12dc
code   0x0fcf50 +0x38  site_thunk select_pal_variant_id; site 0x05f146 jsr-routed
...
code   0x0fcf90 +0x42  site_thunk throw_arc_tables; site 0x028386 jmp-routed
code   0x0fcfe0 +0xe  site_thunk idmask_victim_spawn; site 0x060ef0 jmp-routed
code   0x0fcff0 +0x10  site_thunk idmask_piece_subtype; site 0x05e7d6 jmp-routed
data   0x4123c0 +0x100  site_thunk df_gold_variant_id data block <- vsav2 0x3abedc
code   0x0fd000 +0x54  site_thunk df_gold_variant_id; site 0x02a8d6 jmp-routed
code   0x0fd060 +0x102  site_thunk beam_list_type6; site 0x01b6aa jmp-routed
