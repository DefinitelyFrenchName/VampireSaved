...
# code+0x898: port_patch 6600fd4c -> 6000fd4c (EX route disabled: bne.w -> bra.w past the EX check (vs2's no-stock path at every stock level), ruled 2026-09-18)
...
# x028122+0x8a4: port_patch 3b4eb48c -> 3b4eb43a (grab ptr store a6: vs2 -0x4B74 -> vsavj -0x4BC6)
# x028122+0x8a8: port_patch 3b49b48e -> 3b49b43c (grab ptr store a1: vs2 -0x4B72 -> vsavj -0x4BC4)
# x028122+0x972: port_patch 3b4eb48c -> 3b4eb43a (grab ptr store a6 (site 2))
# x028122+0x976: port_patch 3b49b48e -> 3b49b43c (grab ptr store a1 (site 2))
# x028122+0xa38: port_patch 3b4eb48c -> 3b4eb43a (grab ptr store a6 (site 3))
# x028122+0xa3c: port_patch 3b49b48e -> 3b49b43c (grab ptr store a1 (site 3))
# x028122+0xc4a: port_patch 4a2e01c3 -> 4a2e0111 (meter adder: Dark Force test +0x1C3 (vs2 Power) -> +0x111 (vsavj Change), #157 DF tail)
...
data   0x4010e0 +0xe50  data_port throw_victim_keyframes PLACED (tenant at 0x13; host block 0xb19f8 untouched) <- vsav2 0x0ca1ca (0 fixes)
...
data   0x0b8ba0 +0x20  data_port defense_curve_row <- vsav2 0x0d2d1e (0 fixes)
data   0x0bcc92 +0x2  data_port defense_rally_threshold <- vsav2 0x0d6e30 (1 fixes)
...
# select_wheel roster21: version_text 'M20' -> 3 glyph entries at screen (324,202), pal row 0x19, codes 0x1fe40+ (authored tiles via wheel_bank5.json)
...
code   0x3ffbb0 +0x32  site_thunk ls_freeze_vs2_victim; site 0x023ad8 jsr-routed
code   0x3ffbf0 +0x34  site_thunk ls_freeze_vs2_attacker; site 0x023ade jsr-routed
code   0x3ffc30 +0x24  site_thunk es_type51_dispatch; site 0x0185ca jsr-routed
...
code   0x3ffc60 +0x7e  site_thunk select_sword_pal_variant_id; site 0x05f9d0 jsr-routed
...
code   0x3ffce0 +0x22  site_thunk voice_borrow_keep_tenant; site 0x00aef2 jsr-routed
code   0x3ffd10 +0x1e  site_thunk oboro_select_hook; site 0x020b9c jsr-routed
# site_thunk random_select_bound: roster_subst -> ['0x10', '0x11', '0x13'] (bound 15+3)
code   0x3ffd30 +0xe  site_thunk random_select_bound; site 0x020c74 jmp-routed
...
code   0x3ffd60 +0x5e  site_thunk hitclass_map_extend; site 0x01a888 jmp-routed
...
code   0x3fffa0 farm-port stub for 0x2916c (param at 0x3fff80, common 0x29f4a)
code   0x3fffc0 farm-port stub for 0x29184 (param at 0x3fffb0, common 0x29f4a)
code   0x3fffe0 farm-port stub for 0x2918c (param at 0x3fffd0, common 0x29f4a)
code   0x46a630 slot-clearing alloc wrapper for 0x15702 -> 0x16fba (0x80 cleared, +8 preserved)
...
code   0x46a660 sound stub for 0x4ddc (vsavj sfx id 0x84)
code   0x46a680 sound stub for 0x4f48 (vsavj sfx id 0x8b)
...
code   0x46a6a0 sound stub for 0x4e92 (vsavj sfx id 0x93)
...
code   0x46a6c0 sound stub for 0x4ec6 (vsavj sfx id 0x95)
code   0x46a6e0 sound stub for 0x4e10 (vsavj sfx id 0x85)
...
code   0x46a700 sound stub for 0x4e5e (vsavj sfx id 0x91)
code   0x46a720 sound stub for 0x4e78 (vsavj sfx id 0x92)
...
code   0x46a740 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00450002, rts)
# code+0xdf0: owner_tag stamp_b_d16 type 69 -> jsr 0x46a740 (huitzil id 0x10)
# code+0xe20: owner_tag stamp_b_d16 type 69 -> jsr 0x46a740 (huitzil id 0x10)
code   0x46a750 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00460002, rts)
# code+0x1070: owner_tag stamp_b_d16 type 70 -> jsr 0x46a750 (huitzil id 0x10)
# code+0x14b0: owner_tag stamp_b_d16 type 70 -> jsr 0x46a750 (huitzil id 0x10)
code   0x46a760 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00470002, rts)
# code+0x1950: owner_tag stamp_b_d16 type 71 -> jsr 0x46a760 (huitzil id 0x10)
code   0x46a770 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00480002, rts)
# code+0x2026: owner_tag stamp_b_d16 type 72 -> jsr 0x46a770 (huitzil id 0x10)
# code+0x2048: owner_tag stamp_b_d16 type 72 -> jsr 0x46a770 (huitzil id 0x10)
# code+0x13bc: data_in_code reroute -> helper 0x46a790, table 0x46a780 (DATA view of vsav2 0x056074; FG capture-pose random table (native draws seqs 1/3/5))
# code+0x1390: data_in_code reroute -> helper 0x46a7b0, table 0x46a7a0 (DATA view of vsav2 0x056064; FG capture-pose table 2 (seqs 0x56-0x59))
# code+0x17c8: data_in_code reroute -> helper 0x46a7d0, table 0x46a7c0 (DATA view of vsav2 0x05649c; capture-pose table 3 (seqs 0x56-0x59 twin))
# code+0x17f4: data_in_code reroute -> helper 0x46a7f0, table 0x46a7e0 (DATA view of vsav2 0x0564ac; capture-pose table 4 (01/03/05 twin))
...
code   0x46a800 ILLEGAL  TRIPWIRE for unresolved 0x2cd38
# x022400+0x112: unresolved 0x2cd38 -> tripwire 0x46a800
# bank_ref 0xd8998 -> 0xbe7fa (delta rule, 16B byte-identical)
code   0x46a810 ILLEGAL  TRIPWIRE for unresolved 0x7f5f4
# x022400+0xa82: unresolved 0x7f5f4 -> tripwire 0x46a810
code   0x46a820 ILLEGAL  TRIPWIRE for unresolved 0x82480
# x022400+0xada: unresolved 0x82480 -> tripwire 0x46a820
# bank_ref 0xd9638 -> 0xbf49a (delta rule, known table base)
code   0x46a830 ILLEGAL  TRIPWIRE for unresolved 0x828fe
# x022400+0xb66: unresolved 0x828fe -> tripwire 0x46a830
# bank_ref 0xd8998 -> 0xbe7fa (delta rule, 16B byte-identical)
code   0x46a840 ILLEGAL  TRIPWIRE for unresolved 0xbdb0
# x022400+0x12ac: unresolved 0xbdb0 -> tripwire 0x46a840
# x022400+0x12fa: unresolved 0x2cd38 -> tripwire 0x46a800
code   0x46a850 ILLEGAL  TRIPWIRE for unresolved 0x8278c
# x022400+0x14c0: unresolved 0x8278c -> tripwire 0x46a850
code   0x46a860 ILLEGAL  TRIPWIRE for unresolved 0x7b368
# x022400+0x15c8: unresolved 0x7b368 -> tripwire 0x46a860
code   0x46a870 ILLEGAL  TRIPWIRE for unresolved 0x3d1c
# x022400+0x662: unresolved 0x3d1c -> tripwire 0x46a870
code   0x46a880 ILLEGAL  TRIPWIRE for unresolved 0x3dc6
# x022400+0x696: unresolved 0x3dc6 -> tripwire 0x46a880
code   0x46a890 ILLEGAL  TRIPWIRE for unresolved 0x3e70
# x022400+0x80c: unresolved 0x3e70 -> tripwire 0x46a890
# x022400+0x86c: unresolved 0x3d1c -> tripwire 0x46a870
code   0x46a8a0 ILLEGAL  TRIPWIRE for unresolved 0x3c44
# x022400+0x1078: unresolved 0x3c44 -> tripwire 0x46a8a0
code   0x46a8b0 ILLEGAL  TRIPWIRE for unresolved 0x3cb0
# x022400+0x13a0: unresolved 0x3cb0 -> tripwire 0x46a8b0
code   0x46a8c0 ILLEGAL  TRIPWIRE for unresolved 0x3a28
# x022400+0x13e0: unresolved 0x3a28 -> tripwire 0x46a8c0
# x022400+0x13ee: unresolved 0x3a28 -> tripwire 0x46a8c0
code   0x46a8d0 ILLEGAL  TRIPWIRE for unresolved 0x3980
# x022400+0x1404: unresolved 0x3980 -> tripwire 0x46a8d0
code   0x46a8e0 ILLEGAL  TRIPWIRE for unresolved 0x41be
# x022400+0x14ce: unresolved 0x41be -> tripwire 0x46a8e0
...
# x028122+0x8a4: port_patch 3b4eb48c -> 3b4eb43a (#157: grab ptr store a6: vs2 -0x4B74 -> vsavj -0x4BC6)
# x028122+0x8a8: port_patch 3b49b48e -> 3b49b43c (#157: grab ptr store a1: vs2 -0x4B72 -> vsavj -0x4BC4)
# x028122+0x972: port_patch 3b4eb48c -> 3b4eb43a (#157: grab ptr store a6 (site 2))
...
code   0x46a8f0 slot-clearing alloc wrapper for 0x1572e -> 0x16fe6 (0x80 cleared, +8 preserved)
code   0x46a930 farm-port stub for 0x2915c (param at 0x46a920, common 0x29f4a)
code   0x46a950 farm-port stub for 0x29164 (param at 0x46a940, common 0x29f4a)
code   0x46a960 sound stub for 0x4f96 (vsavj sfx id 0xa1)
code   0x46a980 ILLEGAL  TRIPWIRE for unresolved 0x4223c
# x057456+0x3b42: unresolved 0x4223c -> tripwire 0x46a980
code   0x46a990 ILLEGAL  TRIPWIRE for unresolved 0x42cee
# x057456+0x421a: unresolved 0x42cee -> tripwire 0x46a990
code   0x46a9a0 ILLEGAL  TRIPWIRE for unresolved 0x448d4
# x057456+0x50cc: unresolved 0x448d4 -> tripwire 0x46a9a0
...
code   0x46a9b0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00400002, rts)
# x057456+0x8fc: owner_tag stamp_b_d16 type 64 -> jsr 0x46a9b0 (huitzil id 0x10)
code   0x46a9c0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00410002, rts)
# x057456+0xa24: owner_tag stamp_b_d16 type 65 -> jsr 0x46a9c0 (huitzil id 0x10)
code   0x46a9d0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00420002, rts)
# x057456+0x14ce: owner_tag stamp_b_d16 type 66 -> jsr 0x46a9d0 (huitzil id 0x10)
code   0x46a9e0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00430002, rts)
# x057456+0x18f6: owner_tag stamp_b_d16 type 67 -> jsr 0x46a9e0 (huitzil id 0x10)
code   0x46a9f0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c003e0002, rts)
# x057456+0x29c4: owner_tag stamp_b_d16 type 62 -> jsr 0x46a9f0 (huitzil id 0x10)
code   0x46aa00 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c003f0002, rts)
# x057456+0x2b4a: owner_tag stamp_b_d16 type 63 -> jsr 0x46aa00 (huitzil id 0x10)
code   0x46aa10 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c004b0002, rts)
# x057456+0x2b56: owner_tag stamp_b_d16 type 75 -> jsr 0x46aa10 (huitzil id 0x10)
code   0x46aa20 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c003d0002, rts)
# x057456+0x39fe: owner_tag stamp_b_d16 type 61 -> jsr 0x46aa20 (huitzil id 0x10)
code   0x46aa30 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_b_d16 197c00490002, rts)
# x057456+0x4624: owner_tag stamp_b_d16 type 73 -> jsr 0x46aa30 (huitzil id 0x10)
code   0x46aa40 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01014200, rts)
# x057456+0x4d12: owner_tag stamp_l_ind type 66 -> jsr 0x46aa40 (huitzil id 0x10)
code   0x46aa50 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01004202, rts)
# x057456+0x4ddc: owner_tag stamp_l_ind type 66 -> jsr 0x46aa50 (huitzil id 0x10)
code_file 0x416906 +0x5200  donovan x057456 (from vsav2 0x057456)
code   0x46aa60 ILLEGAL  TRIPWIRE for unresolved 0x12f484
# x05c800+0x152a: unresolved 0x12f484 -> tripwire 0x46aa60
# x05c800+0x16a4: unresolved 0x12f484 -> tripwire 0x46aa60
code   0x46aa70 ILLEGAL  TRIPWIRE for unresolved 0x167bf4
# x05c800+0x2622: unresolved 0x167bf4 -> tripwire 0x46aa70
# x05c800+0x2a20: unresolved 0x167bf4 -> tripwire 0x46aa70
code   0x46aa80 ILLEGAL  TRIPWIRE for unresolved 0x17f176
# x05c800+0x2ae4: unresolved 0x17f176 -> tripwire 0x46aa80
# x05c800+0x3034: unresolved 0x17f176 -> tripwire 0x46aa80
code   0x46aa90 ILLEGAL  TRIPWIRE for unresolved 0x181592
# x05c800+0x3072: unresolved 0x181592 -> tripwire 0x46aa90
# x05c800+0x1456: char-id imm 0x10 -> 0x10
# x05c800+0x738: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 (Jedah band) / WIDE bank 4)
# x05c800+0x58d4: port_patch 397c60000018 -> 397c10000018 (OBJ bank setter (a4 form): vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
# x05c800+0x5994: port_patch 397c60000018 -> 397c10000018 (OBJ bank setter (a4 form): vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
code   0x46aaa0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01003b22, rts)
# x05c800+0x83a: owner_tag stamp_l_ind type 59 -> jsr 0x46aaa0 (huitzil id 0x10)
# pcrel_escape_fix x05c800: 2 escapes -> 1 trampolines (0 tripwired), pad 0x6a00..0x6a20
...
code   0x46aab0 sound stub for 0x4fb0 (vsavj sfx id 0xa0)
code   0x46aad0 sound stub for 0x4fca (vsavj sfx id 0xa5)
code_file 0x3ffdc0 +0x1ba  donovan x067846 (from vsav2 0x067846)
...
code   0x46aaf0 sound stub for 0x4f2e (vsavj sfx id 0x199)
code_file 0x4274b0 +0x310  donovan x068458 (from vsav2 0x068458)
code_file 0x4277c0 +0x264  donovan x068768 (from vsav2 0x068768)
code   0x46ab10 sound stub for 0x4efa (vsavj sfx id 0x90)
code_file 0x427a30 +0x2ac  donovan x0689cc (from vsav2 0x0689CC)
code   0x46ab30 +0x40  patched clone of 0x5459a for vs2 0x5c77e (unmasked set-anim entry; false byte-matc)
code   0x46ab70 sound stub for 0x4f62 (vsavj sfx id 0x7f)
...
code   0x46ab90 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01004206, rts)
# x069046+0x4a: owner_tag stamp_l_ind type 66 -> jsr 0x46ab90 (huitzil id 0x10)
code   0x46aba0 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01004204, rts)
# x069046+0x130: owner_tag stamp_l_ind type 66 -> jsr 0x46aba0 (huitzil id 0x10)
...
code   0x46abb0 ILLEGAL  TRIPWIRE for unresolved 0x22f2d2
# x06cac0+0x546: unresolved 0x22f2d2 -> tripwire 0x46abb0
code   0x46abc0 ILLEGAL  TRIPWIRE for unresolved 0x4cb0
# x06cac0+0x552: unresolved 0x4cb0 -> tripwire 0x46abc0
code   0x46abd0 ILLEGAL  TRIPWIRE for unresolved 0x4c96
# x06cac0+0x586: unresolved 0x4c96 -> tripwire 0x46abd0
# x06cac0+0x58e: unresolved 0x22f2d2 -> tripwire 0x46abb0
# bank_ref 0xd7118 -> 0xbcf7a (delta rule, known table base)
# bank_ref 0xd7118 -> 0xbcf7a (delta rule, known table base)
code   0x46abe0 ILLEGAL  TRIPWIRE for unresolved 0x3a90
# x06cac0+0xacc: unresolved 0x3a90 -> tripwire 0x46abe0
code   0x46abf0 ILLEGAL  TRIPWIRE for unresolved 0x3a76
# x06cac0+0xb18: unresolved 0x3a76 -> tripwire 0x46abf0
# x06cac0+0xb60: unresolved 0x3a76 -> tripwire 0x46abf0
# x06cac0+0xbac: unresolved 0x3a76 -> tripwire 0x46abf0
...
code   0x46ac00 ILLEGAL  TRIPWIRE for unresolved 0x281696
# x088512+0x348: unresolved 0x281696 -> tripwire 0x46ac00
code   0x46ac10 ILLEGAL  TRIPWIRE for unresolved 0x289b14
# x088512+0x126a: unresolved 0x289b14 -> tripwire 0x46ac10
# x088512+0x127c: unresolved 0x289b14 -> tripwire 0x46ac10
code   0x46ac20 ILLEGAL  TRIPWIRE for unresolved 0x28ed08
# x088512+0x1de2: unresolved 0x28ed08 -> tripwire 0x46ac20
code   0x46ac30 ILLEGAL  TRIPWIRE for unresolved 0x36784a
# x088512+0x1dee: unresolved 0x36784a -> tripwire 0x46ac30
code   0x46ac40 sound stub for 0x50ee (vsavj sfx id 0x7e)
code   0x46ac60 sound stub for 0x50a0 (vsavj sfx id 0x7b)
code   0x46ac80 sound stub for 0x50d4 (vsavj sfx id 0x7d)
code   0x46aca0 sound stub for 0x50ba (vsavj sfx id 0x7c)
code   0x46acc0 sound stub for 0x4e2a (vsavj sfx id 0x8f)
code   0x46ace0 sound stub for 0x4df6 (vsavj sfx id 0x86)
code   0x46ad00 ILLEGAL  TRIPWIRE for unresolved 0x2695d0
# x088512+0x2894: unresolved 0x2695d0 -> tripwire 0x46ad00
code   0x46ad10 ILLEGAL  TRIPWIRE for unresolved 0x2abd58
# x088512+0x359c: unresolved 0x2abd58 -> tripwire 0x46ad10
# x088512+0x22c: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
# x088512+0x1814: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
# x088512+0x2bee: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
...
code   0x46ad20 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01014102, rts)
# x088512+0x2ebc: owner_tag stamp_l_ind type 65 -> jsr 0x46ad20 (huitzil id 0x10)
code   0x46ad30 owner-tag thunk (huitzil id 0x10 -> (+0x7f,A4), then stamp_l_ind 28bc01014100, rts)
# x088512+0x2f54: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x3034: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x305e: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x3088: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x30b2: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x30dc: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x3106: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x3130: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x329a: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x32c4: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x32ee: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x3318: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x3342: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x336c: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x3396: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x33c0: owner_tag stamp_l_ind type 65 -> jsr 0x46ad30 (huitzil id 0x10)
# x088512+0x3ae4: data_in_code reroute -> helper 0x46ae40, table 0x46ad40 (DATA view of vsav2 0x08c042; pod-zone word offset/record table (a3 re-derived from it; self-relative))
...
code   0x46ae50 ILLEGAL  TRIPWIRE for unresolved 0x2c31aa
# x2b7ef4+0xb0d9: unresolved 0x2c31aa -> tripwire 0x46ae50
code   0x46ae60 ILLEGAL  TRIPWIRE for unresolved 0x2c31e4
# x2b7ef4+0xb0fd: unresolved 0x2c31e4 -> tripwire 0x46ae60
code   0x46ae70 ILLEGAL  TRIPWIRE for unresolved 0x2c3236
# x2b7ef4+0xb105: unresolved 0x2c3236 -> tripwire 0x46ae70
code   0x46ae80 ILLEGAL  TRIPWIRE for unresolved 0x2c325c
# x2b7ef4+0xb10d: unresolved 0x2c325c -> tripwire 0x46ae80
code   0x46ae90 ILLEGAL  TRIPWIRE for unresolved 0x2c3272
# x2b7ef4+0xb115: unresolved 0x2c3272 -> tripwire 0x46ae90
code   0x46aea0 ILLEGAL  TRIPWIRE for unresolved 0x2c3280
# x2b7ef4+0xb11d: unresolved 0x2c3280 -> tripwire 0x46aea0
code   0x46aeb0 ILLEGAL  TRIPWIRE for unresolved 0x2c3296
# x2b7ef4+0xb125: unresolved 0x2c3296 -> tripwire 0x46aeb0
code   0x46aec0 ILLEGAL  TRIPWIRE for unresolved 0x2c32a4
# x2b7ef4+0xb12d: unresolved 0x2c32a4 -> tripwire 0x46aec0
code   0x46aed0 ILLEGAL  TRIPWIRE for unresolved 0x2c32b2
# x2b7ef4+0xb135: unresolved 0x2c32b2 -> tripwire 0x46aed0
...
data     0x46db30 +0x500  sprite palette block (vsav2 0x39BC9C); poke32 0x38c1d8 (table 0x38c198 row 0x10)
data     0x46e030 +0xdc0  effect palette block (vsav2 0x3AB69C); poke32 0x38c258 (table 0x38c218 row 0x10)
...
data   0x46edf0 +0x1d80  data_port grab_hold_keyframes PLACED (tenant at 0x10; host block 0x92c4a untouched) <- vsav2 0x0c56aa (0 fixes)
poke32 0x0be2ba <- 0x46edf0  data_port grab_hold_keyframes ptr-table 0xbe27a row 0x10
...
poke32 0x0bf45a <- 0x470b70  sound_table hui_sfx_records per-char ptr row 0x10 (was 0x938ba)
data   0x470c30 +0x1c  select_records portrait/p1 coord list (7 pairs, vs2 0x303238)
data   0x470c50 +0x26  select_records portrait/p1 record (vs2 0x2a5e4a, 7 entries, budget 0x5b = vs2's own)
poke32 0x26746a <- 0x470c50  select_records portrait/p1 array row 0x10 (was 0x271924, the base-half alias)
data   0x470c80 +0x1c  select_records portrait/p2 coord list (7 pairs, vs2 0x3035a8)
data   0x470ca0 +0x26  select_records portrait/p2 record (vs2 0x2a625a, 7 entries, budget 0x5b = vs2's own)
poke32 0x2674ea <- 0x470ca0  select_records portrait/p2 array row 0x10 (was 0x271d36, the base-half alias)
data   0x470cd0 +0x4  select_records name_banner/p1 coord list (1 pairs, vs2 0x303730)
data   0x470ce0 +0xe  select_records name_banner/p1 record (vs2 0x2a64d6, 1 entries, budget 0x8 = vs2's own)
poke32 0x2675ea <- 0x470ce0  select_records name_banner/p1 array row 0x10 (was 0x272148, the base-half alias)
data   0x470cf0 +0x8  select_records name_banner/p2 coord list (2 pairs, vs2 0x303d9c)
data   0x470d00 +0x12  select_records name_banner/p2 record (vs2 0x2a7506, 2 entries, budget 0x3 = vs2's own)
poke32 0x26766a <- 0x470d00  select_records name_banner/p2 array row 0x10 (was 0x273052, the base-half alias)
data   0x470d20 +0x14  select_records splash_p1/p1 coord list (5 pairs, vs2 0x304028)
data   0x470d40 +0x1e  select_records splash_p1/p1 record (vs2 0x2a7b06, 5 entries, budget 0x4c = vs2's own)
poke32 0x2672ea <- 0x470d40  select_records splash_p1/p1 array row 0x10 (was 0x273462, the base-half alias)
data   0x470d60 +0x14  select_records splash_p2/p1 coord list (5 pairs, vs2 0x3042b8)
data   0x470d80 +0x1e  select_records splash_p2/p1 record (vs2 0x2a7e36, 5 entries, budget 0x4c = vs2's own)
poke32 0x26736a <- 0x470d80  select_records splash_p2/p1 array row 0x10 (was 0x2737a8, the base-half alias)
data   0x470da0 +0x84  select_records win_quote/p1 coord list (33 pairs, vs2 0x304bd8)
data   0x470e30 +0x8e  select_records win_quote/p1 record (vs2 0x2a881e, 33 entries, budget 0x8a = vs2's own)
poke32 0x2673ea <- 0x470e30  select_records win_quote/p1 array row 0x10 (was 0x273aee, the base-half alias)
...
# site_thunk splash_bank_variant_id: body deferred to the 0x06c0e0 chain (30 bytes)
# site_thunk winquote_bank_variant_id: body deferred to the 0x05f328 chain (22 bytes)
code   0x470ec0 +0x1a  site_thunk tenant_jump_seq; site 0x022a0e jmp-routed
code   0x470ee0 +0xe  site_thunk shadow_seq_guard; site 0x08245c jmp-routed
data   0x470ef0 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c12dc
# site_thunk select_pal_variant_id: body deferred to the 0x05f146 chain (56 bytes)
data   0x471030 +0x54  site_thunk throw_arc_tables data block <- vsav2 0x0279b4
data   0x471090 +0x370  site_thunk throw_arc_tables data block <- vsav2 0x027a08
code   0x471400 +0x42  site_thunk throw_arc_tables; site 0x028386 jmp-routed
code   0x471450 +0xe  site_thunk idmask_victim_spawn; site 0x060ef0 jmp-routed
code   0x471460 +0x10  site_thunk idmask_piece_subtype; site 0x05e7d6 jmp-routed
data   0x471470 +0x100  site_thunk df_gold_variant_id data block <- vsav2 0x3abedc
code   0x471570 +0x54  site_thunk df_gold_variant_id; site 0x02a8d6 jmp-routed
code   0x4715d0 +0xfe  site_thunk beam_list_type6; site 0x01b6aa jmp-routed
code   0x4716d0 +0x1d6  site_thunk index_window_018468; site 0x018460 jmp-routed
...
# table_fix: region x026142 len 0x1400 -> 0x1440 (merged vanilla bank table; tenant rows written per tenant)
data_file 0x485770 +0x1b500  donovan anim (from vsav2 0x264086)
data_file 0x4a0c70 +0x190  donovan aux0_0 (from vsav2 0x334170)
data_file 0x4a0e00 +0x190  donovan aux0_1 (from vsav2 0x33CD00)
data_file 0x4a0f90 +0xd830  donovan aux0_2 (from vsav2 0x344A60)
code   0x4bc970 farm-port stub for 0x2916c (param at 0x4bc950, common 0x29f4a)
code   0x4bc990 farm-port stub for 0x2915c (param at 0x4bc980, common 0x29f4a)
code   0x4bc9b0 farm-port stub for 0x29164 (param at 0x4bc9a0, common 0x29f4a)
code   0x4bc9d0 farm-port stub for 0x29184 (param at 0x4bc9c0, common 0x29f4a)
code   0x4bc9f0 farm-port stub for 0x2918c (param at 0x4bc9e0, common 0x29f4a)
code   0x4bca00 sound stub for 0x4f96 (vsavj sfx id 0xa1)
code   0x4bca20 slot-clearing alloc wrapper for 0x15702 -> 0x16fba (0x80 cleared, +8 preserved)
code   0x4bca50 slot-clearing alloc wrapper for 0x1572e -> 0x16fe6 (0x80 cleared, +8 preserved)
code   0x4bca80 ILLEGAL  TRIPWIRE for unresolved 0x4223c
# code+0x3ad8: unresolved 0x4223c -> tripwire 0x4bca80
code   0x4bca90 ILLEGAL  TRIPWIRE for unresolved 0x42cee
# code+0x41b0: unresolved 0x42cee -> tripwire 0x4bca90
code   0x4bcaa0 ILLEGAL  TRIPWIRE for unresolved 0x448d4
# code+0x5062: unresolved 0x448d4 -> tripwire 0x4bcaa0
...
code   0x4bcab0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c00400002, rts)
# code+0x892: owner_tag stamp_b_d16 type 64 -> jsr 0x4bcab0 (pyron id 0x11)
code   0x4bcac0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c00410002, rts)
# code+0x9ba: owner_tag stamp_b_d16 type 65 -> jsr 0x4bcac0 (pyron id 0x11)
code   0x4bcad0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c00420002, rts)
# code+0x1464: owner_tag stamp_b_d16 type 66 -> jsr 0x4bcad0 (pyron id 0x11)
code   0x4bcae0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c00430002, rts)
# code+0x188c: owner_tag stamp_b_d16 type 67 -> jsr 0x4bcae0 (pyron id 0x11)
code   0x4bcaf0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c003e0002, rts)
# code+0x295a: owner_tag stamp_b_d16 type 62 -> jsr 0x4bcaf0 (pyron id 0x11)
code   0x4bcb00 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c003f0002, rts)
# code+0x2ae0: owner_tag stamp_b_d16 type 63 -> jsr 0x4bcb00 (pyron id 0x11)
code   0x4bcb10 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c004b0002, rts)
# code+0x2aec: owner_tag stamp_b_d16 type 75 -> jsr 0x4bcb10 (pyron id 0x11)
code   0x4bcb20 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c003d0002, rts)
# code+0x3994: owner_tag stamp_b_d16 type 61 -> jsr 0x4bcb20 (pyron id 0x11)
code   0x4bcb30 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_b_d16 197c00490002, rts)
# code+0x45ba: owner_tag stamp_b_d16 type 73 -> jsr 0x4bcb30 (pyron id 0x11)
code   0x4bcb40 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01014200, rts)
# code+0x4ca8: owner_tag stamp_l_ind type 66 -> jsr 0x4bcb40 (pyron id 0x11)
code   0x4bcb50 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01004202, rts)
# code+0x4d72: owner_tag stamp_l_ind type 66 -> jsr 0x4bcb50 (pyron id 0x11)
# code+0x1ee: data_in_code [pointer-inline] lea.l #0x4bcb60,a2 in place (DATA view of vsav2 0x0576f4; air-dive per-strength (xv,yv) rows; a2 re-derived by `lea (a2,d2.w),a2`)
code_file 0x4718b0 +0x5200  donovan code (from vsav2 0x0574C0)
data_file 0x4ae7c0 +0x16b6  donovan hitbox (from vsav2 0x0C7502)
...
data_file 0x4afe80 +0x322  donovan hitbox_proj (from vsav2 0x0D0986)
# x026142+0x1414: bank table row 0x13 <- 0x1000 (bank 4, WIDE encoding; vanilla row was 0x2000) — tenant-driven
# x026142+0x140e: bank table row 0x10 <- 0x1000 (bank 4, WIDE encoding; vanilla row was 0x6000) — tenant-driven
# x026142+0x1410: bank table row 0x11 <- 0x1000 (bank 4, WIDE encoding; vanilla row was 0x6000) — tenant-driven
# x026142+0x13ee: table_fix 48 bytes (merged vanilla bank table; tenant rows written per tenant)
...
# bank_ref 0xd7198 -> 0xbcffa (delta rule, known table base)
# pcrel_escape_fix x026142: 9 escapes -> 6 trampolines (0 tripwired), pad 0x1440..0x14a0
code_file 0x476ab0 +0x14a0  donovan x026142 (from vsav2 0x026142)
# bank_ref 0xd6ebe -> 0xbcd20 (delta rule, 16B byte-identical)
# bank_ref 0xd699e -> 0xbc800 (delta rule, 16B byte-identical)
# bank_ref 0xd671e -> 0xbc580 (delta rule, 16B byte-identical)
# bank_ref 0xd671e -> 0xbc580 (delta rule, 16B byte-identical)
...
# x028122+0xa38: port_patch 3b4eb48c -> 3b4eb43a (#157: grab ptr store a6 (site 3))
# x028122+0xa3c: port_patch 3b49b48e -> 3b49b43c (#157: grab ptr store a1 (site 3))
code_file 0x477f50 +0xe00  donovan x028122 (from vsav2 0x028122)
code   0x4bcb70 ILLEGAL  TRIPWIRE for unresolved 0x12f484
# x05c800+0x152a: unresolved 0x12f484 -> tripwire 0x4bcb70
# x05c800+0x16a4: unresolved 0x12f484 -> tripwire 0x4bcb70
code   0x4bcb80 ILLEGAL  TRIPWIRE for unresolved 0x167bf4
# x05c800+0x2622: unresolved 0x167bf4 -> tripwire 0x4bcb80
# x05c800+0x2a20: unresolved 0x167bf4 -> tripwire 0x4bcb80
code   0x4bcb90 ILLEGAL  TRIPWIRE for unresolved 0x17f176
# x05c800+0x2ae4: unresolved 0x17f176 -> tripwire 0x4bcb90
# x05c800+0x3034: unresolved 0x17f176 -> tripwire 0x4bcb90
code   0x4bcba0 ILLEGAL  TRIPWIRE for unresolved 0x181592
# x05c800+0x3072: unresolved 0x181592 -> tripwire 0x4bcba0
# x05c800+0x738: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 (Jedah band) / WIDE bank 4)
# x05c800+0x58d4: port_patch 397c60000018 -> 397c10000018 (OBJ bank setter (a4 form): vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
# x05c800+0x5994: port_patch 397c60000018 -> 397c10000018 (OBJ bank setter (a4 form): vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
code   0x4bcbb0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01003b22, rts)
# x05c800+0x83a: owner_tag stamp_l_ind type 59 -> jsr 0x4bcbb0 (pyron id 0x11)
# pcrel_escape_fix x05c800: 2 escapes -> 1 trampolines (0 tripwired), pad 0x6a00..0x6a20
code_file 0x478d50 +0x6a20  donovan x05c800 (from vsav2 0x05C800)
code_file 0x47f770 +0x280  donovan x0672d0 (from vsav2 0x0672D0)
code_file 0x47f9f0 +0x2f6  donovan x067550 (from vsav2 0x067550)
code   0x4bcbc0 sound stub for 0x4fb0 (vsavj sfx id 0xa0)
code   0x4bcbe0 sound stub for 0x4fca (vsavj sfx id 0xa5)
code_file 0x47fcf0 +0x1ba  donovan x067846 (from vsav2 0x067846)
code_file 0x47feb0 +0x60c  donovan x067a00 (from vsav2 0x067A00)
...
code_file 0x4804c0 +0x44c  donovan x06800c (from vsav2 0x06800C)
code_file 0x480910 +0x310  donovan x068458 (from vsav2 0x068458)
code_file 0x480c20 +0x264  donovan x068768 (from vsav2 0x068768)
code   0x4bcc00 sound stub for 0x4efa (vsavj sfx id 0x90)
code_file 0x480e90 +0x2ac  donovan x0689cc (from vsav2 0x0689CC)
code   0x4bcc20 +0x40  patched clone of 0x5459a for vs2 0x5c77e (unmasked set-anim entry; false byte-matc)
code   0x4bcc60 sound stub for 0x4f62 (vsavj sfx id 0x7f)
code_file 0x481140 +0x3ce  donovan x068c78 (from vsav2 0x068C78)
# x069046+0x260: type_renumber stamp_l_ind type 114 -> 125 (pyron's own number; site 0x5e542)
code   0x4bcc80 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01004206, rts)
# x069046+0x4a: owner_tag stamp_l_ind type 66 -> jsr 0x4bcc80 (pyron id 0x11)
code   0x4bcc90 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01004204, rts)
# x069046+0x130: owner_tag stamp_l_ind type 66 -> jsr 0x4bcc90 (pyron id 0x11)
code_file 0x481510 +0x2b0  donovan x069046 (from vsav2 0x069046)
...
code_file 0x4817c0 +0x368  donovan x0692f6 (from vsav2 0x0692F6)
# x06965e+0xac: type_renumber stamp_l_ind type 114 -> 125 (pyron's own number; site 0x5e542)
code_file 0x481b30 +0x100  donovan x06965e (from vsav2 0x06965E)
code   0x4bcca0 ILLEGAL  TRIPWIRE for unresolved 0x281696
# x088512+0x348: unresolved 0x281696 -> tripwire 0x4bcca0
code   0x4bccb0 ILLEGAL  TRIPWIRE for unresolved 0x289b14
# x088512+0x126a: unresolved 0x289b14 -> tripwire 0x4bccb0
# x088512+0x127c: unresolved 0x289b14 -> tripwire 0x4bccb0
code   0x4bccc0 ILLEGAL  TRIPWIRE for unresolved 0x24edd4
# x088512+0x1362: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x13a0: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x13e4: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x1428: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x1464: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x14a2: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x150a: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x154e: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x1590: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x15f0: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x1670: unresolved 0x24edd4 -> tripwire 0x4bccc0
code   0x4bccd0 ILLEGAL  TRIPWIRE for unresolved 0x24a3ce
# x088512+0x16d8: unresolved 0x24a3ce -> tripwire 0x4bccd0
# x088512+0x1732: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x1796: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x17fa: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x18ee: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x191c: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x194a: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x1994: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x1cd2: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x1d1a: unresolved 0x24edd4 -> tripwire 0x4bccc0
code   0x4bcce0 ILLEGAL  TRIPWIRE for unresolved 0x28ed08
# x088512+0x1de2: unresolved 0x28ed08 -> tripwire 0x4bcce0
code   0x4bccf0 ILLEGAL  TRIPWIRE for unresolved 0x36784a
# x088512+0x1dee: unresolved 0x36784a -> tripwire 0x4bccf0
code   0x4bcd00 sound stub for 0x50ee (vsavj sfx id 0x7e)
code   0x4bcd20 sound stub for 0x50a0 (vsavj sfx id 0x7b)
code   0x4bcd40 sound stub for 0x50d4 (vsavj sfx id 0x7d)
code   0x4bcd60 sound stub for 0x50ba (vsavj sfx id 0x7c)
code   0x4bcd80 ILLEGAL  TRIPWIRE for unresolved 0x25111e
# x088512+0x2156: unresolved 0x25111e -> tripwire 0x4bcd80
# x088512+0x21d2: unresolved 0x25111e -> tripwire 0x4bcd80
# x088512+0x26e2: unresolved 0x25111e -> tripwire 0x4bcd80
code   0x4bcd90 sound stub for 0x4e2a (vsavj sfx id 0x8f)
code   0x4bcdb0 sound stub for 0x4df6 (vsavj sfx id 0x86)
# x088512+0x28ce: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x290c: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x294a: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x2986: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x29c4: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x2a2c: unresolved 0x24edd4 -> tripwire 0x4bccc0
# x088512+0x2a6a: unresolved 0x24edd4 -> tripwire 0x4bccc0
code   0x4bcdd0 ILLEGAL  TRIPWIRE for unresolved 0x2abd58
# x088512+0x359c: unresolved 0x2abd58 -> tripwire 0x4bcdd0
# x088512+0x22c: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
# x088512+0x1814: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
# x088512+0x2bee: port_patch 3d7c60000018 -> 3d7c10000018 (OBJ bank setter: vs2 bank 3 -> vsav bank 2 / WIDE bank 4)
...
code   0x4bcde0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01014102, rts)
# x088512+0x2ebc: owner_tag stamp_l_ind type 65 -> jsr 0x4bcde0 (pyron id 0x11)
code   0x4bcdf0 owner-tag thunk (pyron id 0x11 -> (+0x7f,A4), then stamp_l_ind 28bc01014100, rts)
# x088512+0x2f54: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x3034: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x305e: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x3088: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x30b2: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x30dc: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x3106: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x3130: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x329a: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x32c4: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x32ee: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x3318: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x3342: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x336c: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x3396: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x33c0: owner_tag stamp_l_ind type 65 -> jsr 0x4bcdf0 (pyron id 0x11)
# x088512+0x3ae4: data_in_code reroute -> helper 0x4bcf00, table 0x4bce00 (DATA view of vsav2 0x08c042; pod-zone word offset/record table (a3 re-derived from it; self-relative; shared-zone copy))
code_file 0x481c30 +0x3b40  donovan x088512 (from vsav2 0x088512)
data_file 0x4b01b0 +0x900  donovan x0d143e (from vsav2 0x0D143E)
data_file 0x4b0ab0 +0xc8e  donovan x100e3c (from vsav2 0x100E3C)
code   0x4bcf10 ILLEGAL  TRIPWIRE for unresolved 0x2c3136
# x2b7ef4+0xb0c9: unresolved 0x2c3136 -> tripwire 0x4bcf10
code   0x4bcf20 ILLEGAL  TRIPWIRE for unresolved 0x2c3170
# x2b7ef4+0xb0d1: unresolved 0x2c3170 -> tripwire 0x4bcf20
code   0x4bcf30 ILLEGAL  TRIPWIRE for unresolved 0x2c31aa
# x2b7ef4+0xb0d9: unresolved 0x2c31aa -> tripwire 0x4bcf30
code   0x4bcf40 ILLEGAL  TRIPWIRE for unresolved 0x2c31e4
# x2b7ef4+0xb0fd: unresolved 0x2c31e4 -> tripwire 0x4bcf40
code   0x4bcf50 ILLEGAL  TRIPWIRE for unresolved 0x2c3236
# x2b7ef4+0xb105: unresolved 0x2c3236 -> tripwire 0x4bcf50
code   0x4bcf60 ILLEGAL  TRIPWIRE for unresolved 0x2c325c
# x2b7ef4+0xb10d: unresolved 0x2c325c -> tripwire 0x4bcf60
code   0x4bcf70 ILLEGAL  TRIPWIRE for unresolved 0x2c3272
# x2b7ef4+0xb115: unresolved 0x2c3272 -> tripwire 0x4bcf70
code   0x4bcf80 ILLEGAL  TRIPWIRE for unresolved 0x2c3280
# x2b7ef4+0xb11d: unresolved 0x2c3280 -> tripwire 0x4bcf80
code   0x4bcf90 ILLEGAL  TRIPWIRE for unresolved 0x2c3296
# x2b7ef4+0xb125: unresolved 0x2c3296 -> tripwire 0x4bcf90
code   0x4bcfa0 ILLEGAL  TRIPWIRE for unresolved 0x2c32a4
# x2b7ef4+0xb12d: unresolved 0x2c32a4 -> tripwire 0x4bcfa0
code   0x4bcfb0 ILLEGAL  TRIPWIRE for unresolved 0x2c32b2
# x2b7ef4+0xb135: unresolved 0x2c32b2 -> tripwire 0x4bcfb0
# x2b7ef4: effect-c5 — 5714 bank-1 codes kept NATIVE (art -> group C bank 5); 114 coord lists matched, 617 ported (11336B fragment)
data_file 0x4b1740 +0xb20c  donovan x2b7ef4 (from vsav2 0x2B7EF4)
data     0x4bfc10 +0x500  sprite palette block (vsav2 0x39C19C); poke32 0x38c1dc (table 0x38c198 row 0x11)
data     0x4c0110 +0xdc0  effect palette block (vsav2 0x3AC45C); poke32 0x38c25c (table 0x38c218 row 0x11)
poke32 0x0bcebe <- 0x00485770  anim_index_a[0x11] donovan anim
poke32 0x0bcf3e <- 0x0048acba  anim_index_a2[0x11] donovan anim
poke32 0x0bcfbe <- 0x00487c3e  anim_index_b[0x11] donovan anim
poke32 0x0bd03e <- 0x004876ba  anim_index_c[0x11] donovan anim
poke32 0x0bd0be <- 0x0048ec9e  anim_index_proj[0x11] donovan anim
data   0x0bd902 +0x8  param32_a[0x11] value
data   0x0bdeaa +0x30  jump_params[0x11] value
poke32 0x0bd9be <- 0x004ae8bc  hitbox_base[0x11] donovan hitbox
poke32 0x0bda3e <- 0x004ae7c0  hitbox_comp[0x11] donovan hitbox
poke32 0x0bdabe <- 0x004afe88  proj_hitbox_base[0x11] donovan hitbox_proj
poke32 0x0bdb3e <- 0x004afe80  proj_hitbox_comp[0x11] donovan hitbox_proj
...
poke32 0x0bf2de <- 0x00471ea2  tail_code_ptr[0x11] donovan code
...
poke32 0x0bf05e <- 0x004b0ab0  ai_script_0[0x11] donovan x100e3c
poke32 0x0bf0de <- 0x004b0b9c  ai_script_1[0x11] donovan x100e3c
poke32 0x0bf15e <- 0x004b1488  ai_script_2[0x11] donovan x100e3c
poke32 0x0bf1de <- 0x004b1728  ai_script_3[0x11] donovan x100e3c
poke32 0x0bd4be <- 0x00024ea4  dispatch_07[0x11] engine twin of 0x23afe (alias char row 0x30b9a differs)
code   0x4c0ed0 ILLEGAL  TRIPWIRE for unresolved 0x65c22
# obj_hook@0x54470 type 59 owner-dispatch fallback: unresolved 0x65c22 -> tripwire 0x4c0ed0
code   0x4c0ee0 obj_hook type 59 OWNER-DISPATCH (tag; donovan 0xcbe32; unknown owner -> tripwire 0x4c0ed0)
...
code   0x4c0f00 ILLEGAL  TRIPWIRE for unresolved 0x65e5a
# obj_hook@0x54470 type 61 owner-dispatch fallback: unresolved 0x65e5a -> tripwire 0x4c0f00
code   0x4c0f10 obj_hook type 61 OWNER-DISPATCH (tag; donovan 0xcc06a; unknown owner -> tripwire 0x4c0f00)
...
code   0x4c0f30 ILLEGAL  TRIPWIRE for unresolved 0x66ec4
# obj_hook@0x54470 type 62 owner-dispatch fallback: unresolved 0x66ec4 -> tripwire 0x4c0f30
code   0x4c0f40 obj_hook type 62 OWNER-DISPATCH (tag; donovan 0xcd0d4; unknown owner -> tripwire 0x4c0f30)
...
code   0x4c0f60 ILLEGAL  TRIPWIRE for unresolved 0x6717c
# obj_hook@0x54470 type 63 owner-dispatch fallback: unresolved 0x6717c -> tripwire 0x4c0f60
code   0x4c0f70 obj_hook type 63 OWNER-DISPATCH (tag; donovan 0xc28a0; unknown owner -> tripwire 0x4c0f60)
...
code   0x4c0f90 ILLEGAL  TRIPWIRE for unresolved 0x672d0
# obj_hook@0x54470 type 64 owner-dispatch fallback: unresolved 0x672d0 -> tripwire 0x4c0f90
code   0x4c0fa0 obj_hook type 64 OWNER-DISPATCH (tag; huitzil 0x4264d0, pyron 0x47f770; unknown owner -> tripwire 0x4c0f90)
code   0x4c0fd0 ILLEGAL  TRIPWIRE for unresolved 0x67550
# obj_hook@0x54470 type 65 owner-dispatch fallback: unresolved 0x67550 -> tripwire 0x4c0fd0
code   0x4c0fe0 obj_hook type 65 OWNER-DISPATCH (tag; huitzil 0x426750, pyron 0x47f9f0; unknown owner -> tripwire 0x4c0fd0)
...
code   0x4c1010 ILLEGAL  TRIPWIRE for unresolved 0x67846
# obj_hook@0x54470 type 66 owner-dispatch fallback: unresolved 0x67846 -> tripwire 0x4c1010
code   0x4c1020 obj_hook type 66 OWNER-DISPATCH (tag; huitzil 0x3ffdc0, pyron 0x47fcf0; unknown owner -> tripwire 0x4c1010)
...
code   0x4c1050 ILLEGAL  TRIPWIRE for unresolved 0x67a00
# obj_hook@0x54470 type 67 owner-dispatch fallback: unresolved 0x67a00 -> tripwire 0x4c1050
code   0x4c1060 obj_hook type 67 OWNER-DISPATCH (tag; huitzil 0x426a50, pyron 0x47feb0; unknown owner -> tripwire 0x4c1050)
code   0x4c1090 ILLEGAL  TRIPWIRE for unresolved 0x6800c
# obj_hook@0x54470 type 68 owner-dispatch fallback: unresolved 0x6800c -> tripwire 0x4c1090
code   0x4c10a0 obj_hook type 68 OWNER-DISPATCH (tag; huitzil 0x427060, pyron 0x4804c0; unknown owner -> tripwire 0x4c1090)
code   0x4c10d0 ILLEGAL  TRIPWIRE for unresolved 0x68458
# obj_hook@0x54470 type 69 owner-dispatch fallback: unresolved 0x68458 -> tripwire 0x4c10d0
code   0x4c10e0 obj_hook type 69 OWNER-DISPATCH (tag; huitzil 0x4274b0, pyron 0x480910; unknown owner -> tripwire 0x4c10d0)
code   0x4c1110 ILLEGAL  TRIPWIRE for unresolved 0x68768
# obj_hook@0x54470 type 70 owner-dispatch fallback: unresolved 0x68768 -> tripwire 0x4c1110
code   0x4c1120 obj_hook type 70 OWNER-DISPATCH (tag; huitzil 0x4277c0, pyron 0x480c20; unknown owner -> tripwire 0x4c1110)
code   0x4c1150 ILLEGAL  TRIPWIRE for unresolved 0x689cc
# obj_hook@0x54470 type 71 owner-dispatch fallback: unresolved 0x689cc -> tripwire 0x4c1150
code   0x4c1160 obj_hook type 71 OWNER-DISPATCH (tag; huitzil 0x427a30, pyron 0x480e90; unknown owner -> tripwire 0x4c1150)
code   0x4c1190 ILLEGAL  TRIPWIRE for unresolved 0x68c78
# obj_hook@0x54470 type 72 owner-dispatch fallback: unresolved 0x68c78 -> tripwire 0x4c1190
code   0x4c11a0 obj_hook type 72 OWNER-DISPATCH (tag; huitzil 0x427ce0, pyron 0x481140; unknown owner -> tripwire 0x4c1190)
code   0x4c11d0 ILLEGAL  TRIPWIRE for unresolved 0x69046
# obj_hook@0x54470 type 73 owner-dispatch fallback: unresolved 0x69046 -> tripwire 0x4c11d0
code   0x4c11e0 obj_hook type 73 OWNER-DISPATCH (tag; huitzil 0x4280b0, pyron 0x481510; unknown owner -> tripwire 0x4c11d0)
...
code   0x4c1210 ILLEGAL  TRIPWIRE for unresolved 0x692f6
# obj_hook@0x54470 type 74 owner-dispatch fallback: unresolved 0x692f6 -> tripwire 0x4c1210
code   0x4c1220 obj_hook type 74 OWNER-DISPATCH (tag; huitzil 0x428360, pyron 0x4817c0; unknown owner -> tripwire 0x4c1210)
code   0x4c1250 ILLEGAL  TRIPWIRE for unresolved 0x6965e
# obj_hook@0x54470 type 75 owner-dispatch fallback: unresolved 0x6965e -> tripwire 0x4c1250
code   0x4c1260 obj_hook type 75 OWNER-DISPATCH (tag; huitzil 0x4286d0, pyron 0x481b30; unknown owner -> tripwire 0x4c1250)
...
code   0x4c1290 +0x15c  obj_walker: 0x54458 relocated verbatim + its extended type table at +0x2c (59 vanilla + 17 ported, 17 placed); dispatch site 0x54470 left VANILLA
code   2 caller operand(s) of jsr 0x54458 -> 0x4c1290 (0x009436, 0x020310)
...
code   0x4c13f0 ILLEGAL  TRIPWIRE for unresolved 0x6a70c
# obj_hook@0x5e542 type 121: unresolved 0x6a70c -> tripwire 0x4c13f0
# obj_hook@0x5e542 type 122: unresolved 0x6a70c -> tripwire 0x4c13f0
# obj_hook@0x5e542 type 123: unresolved 0x6a70c -> tripwire 0x4c13f0
#   obj_hook renumbered type 124 = huitzil's 114 -> 0x4296f0 (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 125 = pyron's 114 -> 0x481c30 (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 126 = huitzil's 115 -> 0x42a9aa (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 127 = pyron's 115 -> 0x482eea (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 128 = huitzil's 116 -> 0x42b44c (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 129 = pyron's 116 -> 0x48398c (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 130 = huitzil's 117 -> 0x42b7ca (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 131 = pyron's 117 -> 0x483d0a (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 132 = huitzil's 118 -> 0x42bed6 (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 133 = pyron's 118 -> 0x484416 (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 134 = huitzil's 119 -> 0x42c2b8 (its OWN copy; stamps rewritten in-region, 14z-82)
#   obj_hook renumbered type 135 = pyron's 119 -> 0x4847f8 (its OWN copy; stamps rewritten in-region, 14z-82)
code   0x4c1400 +0x24c  obj_walker: 0x5e52a relocated verbatim + its extended type table at +0x2c (114 vanilla + 10 ported, 7 placed, 12 renumbered); dispatch site 0x5e542 left VANILLA
code   21 caller operand(s) of jsr 0x5e52a -> 0x4c1400 (0x0053f6, 0x005410, 0x00577c, 0x0057a8, 0x00590a, 0x005ebc, 0x00943c, 0x009caa, 0x009f36, 0x00a188, 0x00a804, 0x00abcc, 0x010dfa, 0x012a3e, 0x012d16, 0x012e4c, 0x012e66, 0x020316, 0x021638, 0x021ada, 0x021dea)
poke32 0x0bd13e <- 0x00473814  dispatch_00[0x11] donovan handler
poke32 0x0bd1be <- 0x004718be  dispatch_01[0x11] donovan handler
poke32 0x0bd23e <- 0x004720e0  dispatch_02[0x11] donovan handler
poke32 0x0bd2be <- 0x004720e0  dispatch_03[0x11] donovan handler
poke32 0x0bd33e <- 0x004720e0  dispatch_04[0x11] donovan handler
poke32 0x0bd3be <- 0x004731c2  dispatch_05[0x11] donovan handler
poke32 0x0bd43e <- 0x00471c42  dispatch_06[0x11] donovan handler
poke32 0x0bd53e <- 0x00472064  dispatch_08[0x11] donovan handler
poke32 0x0bd5be <- 0x00471db2  dispatch_09[0x11] donovan handler
poke32 0x0bd63e <- 0x00471bb0  dispatch_10[0x11] donovan handler
poke32 0x0bd6be <- 0x0047360c  dispatch_11[0x11] donovan handler
poke32 0x0bd73e <- 0x0047372a  dispatch_12[0x11] donovan handler
poke32 0x0bd7be <- 0x004737de  dispatch_13[0x11] donovan handler
poke32 0x0bd83e <- 0x004733cc  dispatch_14[0x11] donovan handler
poke32 0x0bf25e <- 0x00471d30  dispatch_15[0x11] donovan handler
poke32 0x0bf35e <- 0x00473118  dispatch_16[0x11] donovan handler
poke32 0x0bf3de <- 0x00473180  dispatch_17[0x11] donovan handler
poke32 0x0bf4de <- 0x00473852  dispatch_18[0x11] donovan handler
poke32 0x0bf65e <- 0x004731b6  dispatch_19[0x11] donovan handler
...
data   0x4c1650 +0xb80  data_port pyron_capture_keyframes PLACED (tenant at 0x11; host block 0x94954 untouched) <- vsav2 0x0c7f98 (0 fixes)
poke32 0x0be2be <- 0x4c1650  data_port pyron_capture_keyframes ptr-table 0xbe27a row 0x11
data   0x4c21d0 +0xb8  sound_table pyr_sfx_records <- vsav2 0x0c8b18 (23 entries; kept ['0x110@1', '0x111@3', '0x112@4', '0x0a4@5', '0x0a5@6', '0x097@7', '0x0a0@8', '0x0a1@9', '0x0a2@10', '0x0a1@11', '0x0a3@12', '0x09e@13', '0x0a6@16', '0x09a@18', '0x202@21']; zeroed 6 unplayable ids; remapped [(5, '0x72d', '0xa4'), (6, '0x72e', '0xa5'), (7, '0x720', '0x97'), (8, '0x729', '0xa0'), (9, '0x72a', '0xa1'), (10, '0x72b', '0xa2'), (11, '0x72a', '0xa1'), (12, '0x72c', '0xa3'), (13, '0x727', '0x9e'), (16, '0x72f', '0xa6'), (18, '0x723', '0x9a')])
poke32 0x0bf45e <- 0x4c21d0  sound_table pyr_sfx_records per-char ptr row 0x11 (was 0x95894)
data   0x4c2290 +0x20  select_records portrait/p1 coord list (8 pairs, vs2 0x3036b8)
data   0x4c22b0 +0x2a  select_records portrait/p1 record (vs2 0x2a639c, 8 entries, budget 0x61 = vs2's own)
poke32 0x26746e <- 0x4c22b0  select_records portrait/p1 array row 0x11 (was 0x27195e, the base-half alias)
data   0x4c22e0 +0x20  select_records portrait/p2 coord list (8 pairs, vs2 0x3036d8)
data   0x4c2300 +0x2a  select_records portrait/p2 record (vs2 0x2a63c6, 8 entries, budget 0x61 = vs2's own)
poke32 0x2674ee <- 0x4c2300  select_records portrait/p2 array row 0x11 (was 0x271d70, the base-half alias)
data   0x4c2330 +0x4  select_records name_banner/p1 coord list (1 pairs, vs2 0x2fd9b4)
data   0x4c2340 +0xe  select_records name_banner/p1 record (vs2 0x2a6570, 1 entries, budget 0x6 = vs2's own)
poke32 0x2675ee <- 0x4c2340  select_records name_banner/p1 array row 0x11 (was 0x272156, the base-half alias)
data   0x4c2350 +0x8  select_records name_banner/p2 coord list (2 pairs, vs2 0x303d9c)
data   0x4c2360 +0x12  select_records name_banner/p2 record (vs2 0x2a7680, 2 entries, budget 0x3 = vs2's own)
poke32 0x26766e <- 0x4c2360  select_records name_banner/p2 array row 0x11 (was 0x273060, the base-half alias)
data   0x4c2380 +0x14  select_records splash_p1/p1 coord list (5 pairs, vs2 0x30437c)
data   0x4c23a0 +0x1e  select_records splash_p1/p1 record (vs2 0x2a7f2c, 5 entries, budget 0x4f = vs2's own)
poke32 0x2672ee <- 0x4c23a0  select_records splash_p1/p1 array row 0x11 (was 0x273494, the base-half alias)
data   0x4c23c0 +0x14  select_records splash_p2/p1 coord list (5 pairs, vs2 0x304390)
data   0x4c23e0 +0x1e  select_records splash_p2/p1 record (vs2 0x2a7f4a, 5 entries, budget 0x4f = vs2's own)
poke32 0x26736e <- 0x4c23e0  select_records splash_p2/p1 array row 0x11 (was 0x2737da, the base-half alias)
data   0x4c2400 +0x38  select_records win_quote/p1 coord list (14 pairs, vs2 0x305034)
data   0x4c2440 +0x42  select_records win_quote/p1 record (vs2 0x2a8cb6, 14 entries, budget 0xb5 = vs2's own)
poke32 0x2673ee <- 0x4c2440  select_records win_quote/p1 array row 0x11 (was 0x273b68, the base-half alias)
...
data   0x4c2490 +0x6040  win_pal_variant don_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c365c stride 0xb40)
data   0x4c84d0 +0x6040  win_pal_variant hui_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c329c stride 0xb40)
data   0x4ce510 +0x6040  win_pal_variant pyr_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c35bc stride 0xb40)
code   0x4d4550 +0x32  win_pal_variant thunk, 3-way: don_win_pal d6==0x13 -> a0=0x4c18b0, hui_win_pal d6==0x10 -> a0=0x4c7ad0, pyr_win_pal d6==0x11 -> a0=0x4cda70; else vanilla pool 0x3ad700
code   0x05f1b6 +6     win_pal_variant: movea.l #pool -> jsr 0x4d4550
# site_thunk name_bank_variant_id: body deferred to the 0x05fce0 chain (30 bytes)
# site_thunk splash_bank_variant_id: body deferred to the 0x06c0e0 chain (30 bytes)
# site_thunk winquote_bank_variant_id: body deferred to the 0x05f328 chain (22 bytes)
data   0x4d4590 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c28fc
# site_thunk select_pal_variant_id: body deferred to the 0x05f146 chain (56 bytes)
code   0x4d46d0 +0x7c  site_thunk 3-way chain at 0x05f146: select_pal_variant_id, select_pal_variant_id, select_pal_variant_id (22 shared tail bytes)
code   0x4d4750 +0x32  site_thunk 3-way chain at 0x05f328: winquote_bank_variant_id, winquote_bank_variant_id, winquote_bank_variant_id (2 shared tail bytes)
code   0x4d4790 +0x3e  site_thunk 3-way chain at 0x05fce0: name_bank_variant_id, name_bank_variant_id, name_bank_variant_id (8 shared tail bytes)
code   0x4d47d0 +0x3e  site_thunk 3-way chain at 0x06c0e0: splash_bank_variant_id, splash_bank_variant_id, splash_bank_variant_id (8 shared tail bytes)
code   0x4d4810 ILLEGAL  TRIPWIRE for unresolved 0xf2f2f2
# init_shim chain fall-through (an id no declaring tenant claims): unresolved 0xf2f2f2 -> tripwire 0x4d4810
code   0x4d4820 MERGED init shim (pool latch A5+0x7966, seeder 0x16c64, phase-gated; flavor (A6+0x3c2) donovan<-0x01/held 0x00->handler 0xc1030, huitzil<-0x00/held 0x01->handler 0x416900 [Start bitmask 0xff8060]; unmatched id -> tripwire 0x4d4810) planted on 2 dispatch rows (F2 fix)
poke32 0x0bd146 <- 0x004d4820  dispatch_00[0x13] donovan handler via MERGED seed shim (F2)
poke32 0x0bd13a <- 0x004d4820  dispatch_00[0x10] huitzil handler via MERGED seed shim (F2)
