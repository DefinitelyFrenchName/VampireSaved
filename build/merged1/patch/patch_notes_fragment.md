...
# select_wheel roster21: version_text 'M18' -> 3 glyph entries at screen (324,202), pal row 0x19, codes 0x1fe40+ (authored tiles via wheel_bank5.json)
...
data   0x4c1620 +0xb80  data_port pyron_capture_keyframes PLACED (tenant at 0x11; host block 0x94954 untouched) <- vsav2 0x0c7f98 (0 fixes)
poke32 0x0be2be <- 0x4c1620  data_port pyron_capture_keyframes ptr-table 0xbe27a row 0x11
data   0x4c21a0 +0xb8  sound_table pyr_sfx_records <- vsav2 0x0c8b18 (23 entries; kept ['0x110@1', '0x111@3', '0x112@4', '0x0a4@5', '0x0a5@6', '0x097@7', '0x0a0@8', '0x0a1@9', '0x0a2@10', '0x0a1@11', '0x0a3@12', '0x09e@13', '0x0a6@16', '0x09a@18', '0x202@21']; zeroed 6 unplayable ids; remapped [(5, '0x72d', '0xa4'), (6, '0x72e', '0xa5'), (7, '0x720', '0x97'), (8, '0x729', '0xa0'), (9, '0x72a', '0xa1'), (10, '0x72b', '0xa2'), (11, '0x72a', '0xa1'), (12, '0x72c', '0xa3'), (13, '0x727', '0x9e'), (16, '0x72f', '0xa6'), (18, '0x723', '0x9a')])
poke32 0x0bf45e <- 0x4c21a0  sound_table pyr_sfx_records per-char ptr row 0x11 (was 0x95894)
data   0x4c2260 +0x20  select_records portrait/p1 coord list (8 pairs, vs2 0x3036b8)
data   0x4c2280 +0x2a  select_records portrait/p1 record (vs2 0x2a639c, 8 entries, budget 0x61 = vs2's own)
poke32 0x26746e <- 0x4c2280  select_records portrait/p1 array row 0x11 (was 0x27195e, the base-half alias)
data   0x4c22b0 +0x20  select_records portrait/p2 coord list (8 pairs, vs2 0x3036d8)
data   0x4c22d0 +0x2a  select_records portrait/p2 record (vs2 0x2a63c6, 8 entries, budget 0x61 = vs2's own)
poke32 0x2674ee <- 0x4c22d0  select_records portrait/p2 array row 0x11 (was 0x271d70, the base-half alias)
data   0x4c2300 +0x4  select_records name_banner/p1 coord list (1 pairs, vs2 0x2fd9b4)
data   0x4c2310 +0xe  select_records name_banner/p1 record (vs2 0x2a6570, 1 entries, budget 0x6 = vs2's own)
poke32 0x2675ee <- 0x4c2310  select_records name_banner/p1 array row 0x11 (was 0x272156, the base-half alias)
data   0x4c2320 +0x8  select_records name_banner/p2 coord list (2 pairs, vs2 0x303d9c)
data   0x4c2330 +0x12  select_records name_banner/p2 record (vs2 0x2a7680, 2 entries, budget 0x3 = vs2's own)
poke32 0x26766e <- 0x4c2330  select_records name_banner/p2 array row 0x11 (was 0x273060, the base-half alias)
data   0x4c2350 +0x14  select_records splash_p1/p1 coord list (5 pairs, vs2 0x30437c)
data   0x4c2370 +0x1e  select_records splash_p1/p1 record (vs2 0x2a7f2c, 5 entries, budget 0x4f = vs2's own)
poke32 0x2672ee <- 0x4c2370  select_records splash_p1/p1 array row 0x11 (was 0x273494, the base-half alias)
data   0x4c2390 +0x14  select_records splash_p2/p1 coord list (5 pairs, vs2 0x304390)
data   0x4c23b0 +0x1e  select_records splash_p2/p1 record (vs2 0x2a7f4a, 5 entries, budget 0x4f = vs2's own)
poke32 0x26736e <- 0x4c23b0  select_records splash_p2/p1 array row 0x11 (was 0x2737da, the base-half alias)
data   0x4c23d0 +0x38  select_records win_quote/p1 coord list (14 pairs, vs2 0x305034)
data   0x4c2410 +0x42  select_records win_quote/p1 record (vs2 0x2a8cb6, 14 entries, budget 0xb5 = vs2's own)
poke32 0x2673ee <- 0x4c2410  select_records win_quote/p1 array row 0x11 (was 0x273b68, the base-half alias)
...
data   0x4c2460 +0x6040  win_pal_variant don_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c365c stride 0xb40)
data   0x4c84a0 +0x6040  win_pal_variant hui_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c329c stride 0xb40)
data   0x4ce4e0 +0x6040  win_pal_variant pyr_win_pal: sparse block, 10 sets of 0xa0 at stride 0xaa0 (vs2 0x3c35bc stride 0xb40)
code   0x4d4520 +0x32  win_pal_variant thunk, 3-way: don_win_pal d6==0x13 -> a0=0x4c1880, hui_win_pal d6==0x10 -> a0=0x4c7aa0, pyr_win_pal d6==0x11 -> a0=0x4cda40; else vanilla pool 0x3ad700
code   0x05f1b6 +6     win_pal_variant: movea.l #pool -> jsr 0x4d4520
# site_thunk name_bank_variant_id: body deferred to the 0x05fce0 chain (30 bytes)
# site_thunk splash_bank_variant_id: body deferred to the 0x06c0e0 chain (30 bytes)
# site_thunk winquote_bank_variant_id: body deferred to the 0x05f328 chain (22 bytes)
data   0x4d4560 +0x140  site_thunk select_pal_variant_id data block <- vsav2 0x3c28fc
# site_thunk select_pal_variant_id: body deferred to the 0x05f146 chain (56 bytes)
code   0x4d46a0 +0x7c  site_thunk 3-way chain at 0x05f146: select_pal_variant_id, select_pal_variant_id, select_pal_variant_id (22 shared tail bytes)
code   0x4d4720 +0x32  site_thunk 3-way chain at 0x05f328: winquote_bank_variant_id, winquote_bank_variant_id, winquote_bank_variant_id (2 shared tail bytes)
code   0x4d4760 +0x3e  site_thunk 3-way chain at 0x05fce0: name_bank_variant_id, name_bank_variant_id, name_bank_variant_id (8 shared tail bytes)
code   0x4d47a0 +0x3e  site_thunk 3-way chain at 0x06c0e0: splash_bank_variant_id, splash_bank_variant_id, splash_bank_variant_id (8 shared tail bytes)
code   0x4d47e0 ILLEGAL  TRIPWIRE for unresolved 0xf2f2f2
# init_shim chain fall-through (an id no declaring tenant claims): unresolved 0xf2f2f2 -> tripwire 0x4d47e0
code   0x4d47f0 MERGED init shim (pool latch A5+0x7966, seeder 0x16c64, phase-gated; flavor (A6+0x3c2) donovan<-0x01/held 0x00->handler 0xc1030, huitzil<-0x00/held 0x01->handler 0x416900 [Start bitmask 0xff8060]; unmatched id -> tripwire 0x4d47e0) planted on 2 dispatch rows (F2 fix)
poke32 0x0bd146 <- 0x004d47f0  dispatch_00[0x13] donovan handler via MERGED seed shim (F2)
poke32 0x0bd13a <- 0x004d47f0  dispatch_00[0x10] huitzil handler via MERGED seed shim (F2)
