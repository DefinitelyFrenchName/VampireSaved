...
tenant at a time with that tenant's own extract:
  ...
  verify_pcrel_data.py build/m3b_merged26 --src-data ... \
      --extract build/hui56/extract --placement-suffix @huitzil  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
