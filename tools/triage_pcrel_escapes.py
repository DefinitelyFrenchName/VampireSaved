...
SOLO = {"donovan": "don_m21", "huitzil": "hui55", "pyron": "pyron40"}  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b

mp = json.load(open("build/m3b_merged25/patch/placements.json"))["regions"]  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
