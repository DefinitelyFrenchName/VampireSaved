...
SOLO = {"donovan": "don_m23", "huitzil": "hui57", "pyron": "pyron42"}  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b

mp = json.load(open("build/m3b_merged27/patch/placements.json"))["regions"]  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
