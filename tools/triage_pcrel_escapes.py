...
SOLO = {"donovan": "don_m24", "huitzil": "hui58", "pyron": "pyron43"}  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b

mp = json.load(open("build/m3b_merged28/patch/placements.json"))["regions"]  # re-pointed 14z-117b (random-select freeze) <- 14z-117  # re-pointed 14z-119 (physics-port freeze) <- 14z-117b
