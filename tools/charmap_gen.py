...
UNDECODED = [
    ...
    {"structure": "anim", "what": "DONE 14z-120 (5): hbA != 0 marks an ATTACK node (hbA>>8 = the attack record); startup / active / recovery per chain are derived in the out-of-tree <tenant>_anim.md (tools/framedata_pages.sh)", "evidence": "tests/test_hitbox_encoding.sh"},
