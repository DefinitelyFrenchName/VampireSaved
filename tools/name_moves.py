...
TENANTS = {"donovan": {"id": None, "p2_id": "01", "p2_path": ("R",), "build": "build/don_m24"},
           # PHASE 3 (reactions): the tenant on the VICTIM side (P2) — P1 is Victor (0x03), both by the early-window pokes
           "donovan_victim": {"id": "03", "id_p2": "13", "build": "build/don_m24"},
           "huitzil_victim": {"id": "03", "id_p2": "10", "build": "build/hui58"},
           "pyron_victim":   {"id": "03", "id_p2": "11", "build": "build/pyron43"},
           "huitzil": {"id": "10", "path": ("L", "L", "L"), "p2_id": "01", "p2_path": ("R",), "build": "build/hui58"},
           "pyron":   {"id": "11", "path": ("R", "R", "R"), "p2_id": "01", "p2_path": ("R",), "build": "build/pyron43"}}
