...
TENANTS = {"donovan": {"id": None, "build": "build/don_m20"},
           # PHASE 3 (reactions): the tenant on the VICTIM side (P2) — P1 is Victor (0x03), both by the early-window pokes
           "donovan_victim": {"id": "03", "id_p2": "13", "build": "build/don_m20"},
           "huitzil_victim": {"id": "03", "id_p2": "10", "build": "build/hui54"},
           "pyron_victim":   {"id": "03", "id_p2": "11", "build": "build/pyron38"},
           "huitzil": {"id": "10", "build": "build/hui54"},
           "pyron":   {"id": "11", "build": "build/pyron38"}}
