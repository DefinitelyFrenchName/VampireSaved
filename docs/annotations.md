...
| named by a document or manifest only | 2103 |
| named by both a document/manifest and code | 553 |
| named by CODE ONLY (the gap list below) | 265 |
| carried by atlas | 438 |
| carried by engine_internals | 602 |
| carried by other docs | 940 |
...
| `PRG:0x003BEE` | build/manifest/huitzil.toml — hui_kernel_voice_e0 |
| `PRG:0x003BF0` | build/manifest/pyron.toml — pyr_kernel_voice_e0 |
| `PRG:0x003BF4` | build/manifest/donovan.toml — don_kernel_voice_e0 |
| `PRG:0x003C5A` | build/manifest/huitzil.toml — hui_kernel_voice_e1 |
| `PRG:0x003C5C` | build/manifest/pyron.toml — pyr_kernel_voice_e1 |
| `PRG:0x003C60` | build/manifest/donovan.toml — don_kernel_voice_e1 |
| `PRG:0x003CC6` | build/manifest/huitzil.toml — hui_kernel_voice_e2 |
| `PRG:0x003CC8` | build/manifest/pyron.toml — pyr_kernel_voice_e2 |
| `PRG:0x003CCC` | build/manifest/donovan.toml — don_kernel_voice_e2 |
| `PRG:0x003D30` | build/manifest/huitzil.toml — hui_kernel_voice_e3 |
| `PRG:0x003D32` | build/manifest/pyron.toml — pyr_kernel_voice_e3 |
| `PRG:0x003D36` | build/manifest/donovan.toml — don_kernel_voice_e3 |
...
| `PRG:0x005BEA` | docs/game/atlas/ram.md — Attract-mode demo roster (superset-invariant note); HANDOFF.md — MiSTer (14z-106/107) — the jtcps2w core + the simulation oracle; docs/project/doc_audit_14z118.md — 4. Log of the pass (one line per commit); tests/test_attract_roster.sh |
...
| `PRG:0x00AEDA` | docs/game/engine_internals.md — BORROW: (0x382,A6) is the fighter's voice-FLAVOR class |
| `PRG:0x00AEF2` | docs/game/engine_internals.md — BORROW: (0x382,A6) is the fighter's voice-FLAVOR class; HANDOFF.md — Build registry; build/manifest/donovan.toml — don_sfx_records; build/manifest/donovan.toml — voice_borrow_keep_tenant; build/manifest/huitzil.toml — voice_borrow_keep_tenant; build/manifest/pyron.toml — voice_borrow_keep_tenant; +3 more |
| `PRG:0x00AEF6` | docs/game/atlas/id_space.md — The arcade-opponent path (a fourth roster work item); docs/game/atlas/id_space.md — Which ids vanilla ever assigns (measured over the corpus); docs/game/atlas/ram.md — Player blocks — P1 '$FF8400', P2 '$FF8800' (0x400 apart) [D, corrected]; docs/game/engine_internals.md — BORROW: (0x382,A6) is the fighter's voice-FLAVOR class; docs/game/engine_internals.md — superseded by "third pass: the VOICE-CLASS BORROW" directly below; HANDOFF.md — Build registry [vs2]; +6 more |
| `PRG:0x00AEF8` | docs/game/engine_internals.md — BORROW: (0x382,A6) is the fighter's voice-FLAVOR class; HANDOFF.md — Build registry; build/manifest/donovan.toml — voice_borrow_site_pad; build/manifest/huitzil.toml — voice_borrow_site_pad; build/manifest/pyron.toml — voice_borrow_site_pad; build/manifest/shared_writes.toml — donovan; +2 more |
...
| `PRG:0x00AF16` | docs/game/atlas/ram.md — Player blocks — P1 '$FF8400', P2 '$FF8800' (0x400 apart) [D, corrected]; docs/game/engine_internals.md — BORROW: (0x382,A6) is the fighter's voice-FLAVOR class; docs/game/engine_internals.md — the #92 crash; decoded end to end and confirmed on screen); tests/test_voice_row_range.sh |
...
| `PRG:0x00B094` | docs/game/atlas/id_space.md — The arcade-opponent path (a fourth roster work item); docs/game/engine_internals.md — Sprite palette pipeline (session 14b, playtest-driven) |
| `PRG:0x00B268` | docs/game/atlas/ram.md — Player blocks — P1 '$FF8400', P2 '$FF8800' (0x400 apart) [D, corrected]; docs/game/atlas/select_screen.md — SHADOW vs A TENANT — the static pass (14z-116, the maintainer's question); docs/game/engine_internals.md — BORROW: (0x382,A6) is the fighter's voice-FLAVOR class; docs/game/engine_internals.md — the #92 crash; decoded end to end and confirmed on screen); HANDOFF.md — Build registry; HANDOFF.md — Individual gates; +8 more |
...
| `PRG:0x00EC0E` | docs/game/engine_internals.md — art" is RETRACTED — it was an index-join error and a phase offset |
| `PRG:0x00F8EE` | docs/game/engine_internals.md — The child companion's shadow — SOLVED (14z-69o) |
...
| `PRG:0x010000` | docs/game/atlas/select_screen.md — The wheel DRAWER — object, bank word, and the bank-5 move (14z-63); docs/game/engine_internals.md — GFX ROM (sprite/tile) subsystem; docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically; docs/game/engine_internals.md — The WIN-QUOTE TEXT SYSTEM — fully decoded (14z-76); docs/game/engine_internals.md — confirmed static; RETRACTS most of the 14z-85d filed detail); docs/game/engine_internals.md — note-table array semantics, the dead type-C song class, the alias bit; +42 more |
...
| `PRG:0x010EF6` | docs/game/engine_internals.md — Select-screen (portrait/name) pipeline — mapped (session 14c) |
| `PRG:0x011006` | docs/game/engine_internals.md — confirmed static; RETRACTS most of the 14z-85d filed detail); docs/platform/gotchas.md — A member's REGION layout is not its FILE layout — and the Z80 driver's own address space is a THIRD thing (14z-86) |
...
| `PRG:0x011BD0` | docs/game/engine_internals.md — THE CAPTURE-POSE INSTALLER (14z-99, measured on Victor's 6+HP grab); HANDOFF.md — Individual gates; tests/test_capture_pose_sources.sh |
| `PRG:0x012728` | docs/game/engine_internals.md — Select-screen (portrait/name) pipeline — mapped (session 14c) |
...
| `PRG:0x01378A` | docs/game/atlas/ram.md — Fighter + effect-pool fields (14z-67, measured on the H effect arc); docs/game/engine_internals.md — a vs2-only effect handler that was never ported; docs/game/engine_internals.md — selection mechanism is now named; docs/game/engine_internals.md — selection mechanism is now named [vs2] |
...
| `PRG:0x015084` | docs/game/engine_internals.md — Select-screen (portrait/name) pipeline — mapped (session 14c); HANDOFF.md — Individual gates; docs/project/patch_notes.md — Why it mattered; build/manifest/donovan.toml — select_companion_tbl_b; build/manifest/donovan.toml — weapon_accent_rowd_slot; build/manifest/reconciliation.toml — map; +1 more |
...
| `PRG:0x015668` | docs/game/engine_internals.md — selection mechanism is now named |
...
| `PRG:0x01613C` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33) |
...
| `PRG:0x016B70` | docs/game/engine_internals.md — Hitboxes and attack records (phase 2 of the character-data map, 14z-120 (5), MEASURED) [vs2]; docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) |
| `PRG:0x016B94` | docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) [vs2] |
| `PRG:0x016B9C` | docs/game/atlas/ram.md — Combat struct (player block +0x000) [C, verified D/T] |
...
| `PRG:0x016DDC` | docs/project/patch_notes.md — A. '[reaction_hook]' d2 extension (donovan.toml; singleton, merged inherits); tests/test_reaction_hook_d2.sh; tools/audit_fsm_census.py |
| `PRG:0x016DE4` | docs/game/engine_internals.md — The object-script state dispatcher at 'PRG:0x018508' (14z-109) [vs2]; HANDOFF.md — Build registry [vs2]; HANDOFF.md — Individual gates [vs2]; docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122) [vs2]; docs/project/patch_notes.md — A. '[reaction_hook]' d2 extension (donovan.toml; singleton, merged inherits); build/manifest/donovan.toml — reaction_hook; +2 more |
...
| `PRG:0x016F56` | docs/game/engine_internals.md — selection mechanism is now named |
...
| `PRG:0x016F8E` | docs/game/engine_internals.md — measured 14z-68d on the Huitzil effect arc); HANDOFF.md — Individual gates; docs/project/tables/reconciliation.md — Structural findings the map rests on; build/manifest/dispatch_census.toml — (top); build/manifest/reconciliation.toml — map; tests/audit_dispatch_census.sh |
...
| `PRG:0x017D5C` | docs/game/engine_internals.md — Reactions as the victim — the per-character reaction SETS (phase 3, 14z-120 (7), MEASURED); docs/project/gotchas.md — "THE ONLY WRITER" IS A CLAIM ABOUT THE TAP'S WINDOW — a light hit's overlap frames named the wrong mechanism for the pushback (14z-120 (12), corrected 14z-121 (3)) |
...
| `PRG:0x018460` | docs/game/engine_internals.md — The SUB-STATE DISPATCHER FAMILY at 0x018460 (14z-79); docs/game/engine_internals.md — The object-script state dispatcher at 'PRG:0x018508' (14z-109); docs/game/engine_internals.md — The projectile-pool HIT-CLASS map — a second type consumer, bounded at 64 (14z-82b); HANDOFF.md — Build registry; HANDOFF.md — Individual gates; docs/game/gotchas.md — downstream of the handler's rts (14z-79, cost a build); +17 more |
...
| `PRG:0x018468` | docs/game/engine_internals.md — The SUB-STATE DISPATCHER FAMILY at 0x018460 (14z-79); docs/game/engine_internals.md — vs2/vh2 fill them (named 14z-74; SIX instances and counting); HANDOFF.md — Build registry; HANDOFF.md — Build registry [vs2]; HANDOFF.md — THE OUT-OF-RANGE INDEX TOOLKIT (14z-78) — three instruments, one class; docs/platform/gotchas.md — PC-relative reads are DECRYPTED reads on CPS-2 (paid: 2026-07-25, ~45min); +16 more |
...
| `PRG:0x018508` | docs/game/engine_internals.md — The SUB-STATE DISPATCHER FAMILY at 0x018460 (14z-79); docs/game/engine_internals.md — The object-script state dispatcher at 'PRG:0x018508' (14z-109); HANDOFF.md — Build registry; docs/project/gotchas.md — (14z-75, cost a shipped legacy regression and a blocked freeze); docs/project/gotchas.md — and the engines RENUMBERED families between games (14z-109, the #99 crash); docs/project/patch_index.md — Mechanism inventory (generator vocabulary); +12 more |
| `PRG:0x01850A` | HANDOFF.md — Individual gates; docs/project/gotchas.md — (14z-75, cost a shipped legacy regression and a blocked freeze); build/manifest/pyron.toml — palette_routine_row_11_c; build/manifest/pyron.toml — roster21; tests/test_index_window_thunk.sh; tests/test_pyron_cosmo.sh |
...
| `PRG:0x018511` | docs/project/gotchas.md — first, then interrogate the corpse (14z-109 method note); tests/test_reaction_hook_d2.sh |
...
| `PRG:0x0185DA` | docs/game/engine_internals.md — The SUB-STATE DISPATCHER FAMILY at 0x018460 (14z-79); HANDOFF.md — THE OUT-OF-RANGE INDEX TOOLKIT (14z-78) — three instruments, one class; docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122) [vs2]; docs/project/patch_notes.md — C. Why the bytes and not a data remap; build/manifest/donovan.toml — ls_freeze_vs2_attacker; tests/lua/index_watch.lua; +2 more |
...
| `PRG:0x0199D8` | docs/game/engine_internals.md — selection mechanism is now named |
| `PRG:0x0199DA` | docs/game/atlas/sprite_lists.md — 1. The drawer [vh2] |
| `PRG:0x0199DC` | docs/game/atlas/sprite_lists.md — 1. The drawer [vs2]; docs/game/engine_internals.md — selection mechanism is now named; build/manifest/huitzil.toml — beam_effect_class31 |
...
| `PRG:0x019E0E` | docs/game/engine_internals.md — (14z-70, maintainer-endorsed; use this FIRST); docs/game/engine_internals.md — a vs2-only effect handler that was never ported |
...
| `PRG:0x01A1FC` | docs/game/atlas/sprite_lists.md — Handler targets; HANDOFF.md — Individual gates [vs2]; docs/project/patch_notes.md — 14z-71 — the beam: byte detail; build/manifest/huitzil.toml — beam_effect_class31 [vs2]; tests/test_beam_list_type6.sh |
...
| `PRG:0x01A886` | docs/game/engine_internals.md — The projectile-pool HIT-CLASS map — a second type consumer, bounded at 64 (14z-82b); docs/project/patch_notes.md — below is the record of the probe session and is NOT rewritten.); build/manifest/huitzil.toml — index_window_018468; build/manifest/pyron.toml — port_patch; tools/gen_hitclass_map_thunk.py |
| `PRG:0x01A888` | docs/game/engine_internals.md — The projectile-pool HIT-CLASS map — a second type consumer, bounded at 64 (14z-82b); HANDOFF.md — Build registry; docs/project/patch_index.md — Mechanism inventory (generator vocabulary); docs/project/patch_notes.md — 14z-82 — per-tenant TYPE NUMBERS (the merged obj_hook vec3 fix) + the F2 merged shim; docs/project/patch_notes.md — below is the record of the probe session and is NOT rewritten.); build/manifest/huitzil.toml — hitclass_map_extend; +8 more |
| `PRG:0x01A88E` | docs/game/engine_internals.md — The projectile-pool HIT-CLASS map — a second type consumer, bounded at 64 (14z-82b); docs/project/patch_notes.md — below is the record of the probe session and is NOT rewritten.); tools/gen_hitclass_map_thunk.py |
...
| `PRG:0x01AFAE` | docs/game/atlas/sprite_lists.md — 1. The drawer; docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below.; HANDOFF.md — Individual gates; build/manifest/huitzil.toml — beam_effect_class31; tests/test_beam_list_type6.sh |
...
| `PRG:0x01B6B2` | HANDOFF.md — Individual gates; docs/project/patch_notes.md — 14z-71 — the beam: byte detail; build/manifest/huitzil.toml — beam_effect_class31; tests/test_beam_list_type6.sh |
...
| `PRG:0x01FE40` | docs/game/engine_internals.md — 14z-105: two more things the select screen carries (atlas: select_screen.md); HANDOFF.md — Build registry; HANDOFF.md — Running a CPS-2 WIDE build (playtest); docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-115 — THE SELECT-WHEEL SEPARATION (maintainer-directed "E2", approved 2026-08-28): byte detail; docs/project/patch_notes.md — W2 — the select-screen version string ('version_*' knobs on '[[select_wheel]] roster21'); +3 more |
...
| `PRG:0x01FFFF` | docs/game/engine_internals.md — GFX ROM (sprite/tile) subsystem; docs/game/engine_internals.md — confirmed static; RETRACTS most of the 14z-85d filed detail); tests/audit_mister_map_fit.sh; tools/gfx_tiles.py |
...
| `PRG:0x0206DA` | docs/game/engine_internals.md — BORROW: (0x382,A6) is the fighter's voice-FLAVOR class |
...
| `PRG:0x020CB0` | docs/game/atlas/select_screen.md — The confirm-path id override ($43 / $45) — decoded, and NOT the Oboro path; HANDOFF.md — Individual gates; tests/test_shadow_tenant.sh |
...
| `PRG:0x020E6A` | docs/game/atlas/ram.md — Combat struct (player block +0x000) [C, verified D/T]; docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) |
...
| `PRG:0x0216A8` | docs/game/engine_internals.md — The child companion's shadow — SOLVED (14z-69o) |
...
| `PRG:0x022008` | docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) [vs2]; docs/game/engine_internals.md — The per-char effect system (14z-67, decoded on the H ping rounds) [vs2]; docs/project/gotchas.md — (14z-68, refutes half of the 14z-67 entry theory) [vs2]; docs/project/patch_notes.md — handler clone + the x026142 escape fix; build/manifest/huitzil.toml — pcrel_escape_fix [vs2]; build/manifest/reconciliation_donovan.toml — map [vs2]; +2 more |
| `PRG:0x02203A` | docs/game/atlas/ram.md — Combat struct (player block +0x000) [C, verified D/T] [vs2]; docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) [vs2] |
| `PRG:0x022078` | docs/game/atlas/ram.md — Combat struct (player block +0x000) [C, verified D/T] [vs2]; docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) [vs2] |
| `PRG:0x022174` | docs/game/atlas/ram.md — Combat struct (player block +0x000) [C, verified D/T] |
| `PRG:0x022282` | docs/game/atlas/ram.md — Combat struct (player block +0x000) [C, verified D/T] [vs2]; docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) [vs2] |
...
| `PRG:0x02245E` | build/manifest/pcrel_escapes.toml — hui52 |
...
| `PRG:0x022576` | build/manifest/pcrel_escapes.toml — hui52 |
...
| `PRG:0x02264A` | build/manifest/pcrel_escapes.toml — hui52 |
...
| `PRG:0x022694` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x0226D4` | build/manifest/pcrel_escapes.toml — hui52 |
...
| `PRG:0x02271C` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022750` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022780` | build/manifest/type_stamps.toml — compare |
| `PRG:0x022798` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x0227F0` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022830` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x02286E` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x02289A` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x0228C0` | build/manifest/pcrel_escapes.toml — hui52 |
...
| `PRG:0x0228EC` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x02290C` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022936` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022960` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022994` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x0229CE` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x0229F8` | build/manifest/pcrel_escapes.toml — hui52 |
...
| `PRG:0x022A42` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022AAA` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022AD2` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022AF4` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022B2A` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022B74` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022BA2` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022BEC` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022C14` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022C36` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022C52` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022C90` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022CC0` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022CFA` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022D26` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022D4E` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022D74` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022DB0` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022DD4` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022DEA` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022E00` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022E3C` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022E8C` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022EB2` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022EF8` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022F0E` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022F30` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022F58` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x022FBC` | build/manifest/pcrel_escapes.toml — hui52 |
...
| `PRG:0x022FFA` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x02300C` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x0230A4` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x0230EA` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x0231AE` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x02320A` | build/manifest/pcrel_escapes.toml — hui52 |
...
| `PRG:0x02328E` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x0232E6` | build/manifest/pcrel_escapes.toml — hui52 |
...
| `PRG:0x02356E` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x023624` | build/manifest/pcrel_escapes.toml — hui52 |
...
| `PRG:0x02380E` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x02384E` | docs/game/engine_internals.md — measured on Phobos' FINAL GUARDIAN; twins verified in both engines); HANDOFF.md — Build registry; docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-110b — the 0x51 -> 0x44 state remap: byte detail; docs/project/patch_notes.md — vs2-licensed class remaps; maintainer-ruled option (a)); build/manifest/donovan.toml — ls_freeze_vs2_attacker; +1 more |
...
| `PRG:0x0238A0` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x0238FC` | build/manifest/huitzil.toml — throw_arc_tables |
| `PRG:0x02395A` | build/manifest/pcrel_escapes.toml — hui52 |
...
| `PRG:0x025EE0` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end; docs/game/engine_internals.md — enters Dark Force, the symptom reproduces and is measured |
...
| `PRG:0x026166` | docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) [vs2] |
| `PRG:0x02619E` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end |
| `PRG:0x0261A6` | docs/game/engine_internals.md — enters Dark Force, the symptom reproduces and is measured [vs2] |
| `PRG:0x0261C2` | docs/game/engine_internals.md — enters Dark Force, the symptom reproduces and is measured [vs2] |
| `PRG:0x0261E2` | docs/game/atlas/select_screen.md — SHADOW vs A TENANT — the static pass (14z-116, the maintainer's question) |
| `PRG:0x02620A` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end |
...
| `PRG:0x0262A4` | HANDOFF.md — Individual gates [vs2]; build/manifest/donovan.toml — voice_alias_thunk_w14 [vs2]; tests/audit_don_ko_writer.sh |
...
| `PRG:0x02681E` | docs/game/engine_internals.md — Reactions as the victim — the per-character reaction SETS (phase 3, 14z-120 (7), MEASURED) |
...
| `PRG:0x026F80` | build/manifest/pcrel_escapes.toml — don_m18; build/manifest/pcrel_escapes.toml — hui52; build/manifest/pcrel_escapes.toml — pyron36 |
| `PRG:0x026F8A` | build/manifest/pcrel_escapes.toml — don_m18; build/manifest/pcrel_escapes.toml — hui52; build/manifest/pcrel_escapes.toml — pyron36 |
| `PRG:0x026F94` | build/manifest/pcrel_escapes.toml — don_m18; build/manifest/pcrel_escapes.toml — hui52; build/manifest/pcrel_escapes.toml — pyron36 |
...
| `PRG:0x027000` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end; build/manifest/huitzil.toml — pcrel_escape_fix |
| `PRG:0x027008` | docs/game/engine_internals.md — enters Dark Force, the symptom reproduces and is measured [vs2]; build/manifest/reconciliation.toml — map |
| `PRG:0x027024` | docs/game/engine_internals.md — enters Dark Force, the symptom reproduces and is measured [vs2] |
...
| `PRG:0x027044` | build/manifest/pcrel_escapes.toml — don_m18; build/manifest/pcrel_escapes.toml — hui52; build/manifest/pcrel_escapes.toml — pyron36 |
| `PRG:0x02704E` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end |
...
| `PRG:0x027082` | docs/game/atlas/ram.md — Combat struct (player block +0x000) [C, verified D/T]; docs/game/engine_internals.md — Reactions as the victim — the per-character reaction SETS (phase 3, 14z-120 (7), MEASURED); docs/project/inferred_claims.md — G2/G3 — measurements feeding engine_internals |
| `PRG:0x02708E` | build/manifest/pcrel_escapes.toml — don_m18; build/manifest/pcrel_escapes.toml — hui52; build/manifest/pcrel_escapes.toml — pyron36 |
...
| `PRG:0x02716A` | docs/game/engine_internals.md — superseded by "third pass: the VOICE-CLASS BORROW" directly below |
...
| `PRG:0x027282` | docs/game/engine_internals.md — system (session 14z-66, measured on the Huitzil port); HANDOFF.md — Build registry; build/manifest/huitzil.toml — df_seq_entry_10; build/manifest/reconciliation.toml — map [vs2] |
...
| `PRG:0x027D78` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x027DF8` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x027E18` | build/manifest/pcrel_escapes.toml — hui52 |
| `PRG:0x027E38` | build/manifest/pcrel_escapes.toml — hui52 |
...
| `PRG:0x027F70` | docs/game/engine_internals.md — THE CAPTURE-POSE INSTALLER (14z-99, measured on Victor's 6+HP grab); build/manifest/reconciliation.toml — map |
...
| `PRG:0x028000` | docs/game/engine_internals.md — confirmed static; RETRACTS most of the 14z-85d filed detail); docs/platform/gotchas.md — A member's REGION layout is not its FILE layout — and the Z80 driver's own address space is a THIRD thing (14z-86) |
...
| `PRG:0x02802E` | docs/game/engine_internals.md — THE CAPTURE-POSE INSTALLER (14z-99, measured on Victor's 6+HP grab); docs/game/engine_internals.md — The physics bank's 'gap_*' rows (14z-121, a reference scan of vsavj's code); docs/game/engine_internals.md — system (session 14z-66, measured on the Huitzil port); HANDOFF.md — Build registry [vh2]; HANDOFF.md — Individual gates; build/manifest/bank_map.toml — gap_be27a; +6 more |
| `PRG:0x02804C` | docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; build/manifest/donovan.toml — port_patch |
| `PRG:0x028058` | docs/game/engine_internals.md — system (session 14z-66, measured on the Huitzil port); HANDOFF.md — Individual gates; build/manifest/huitzil.toml — df_seq_entry_10; tests/test_capture_pose_sources.sh |
...
| `PRG:0x028C76` | build/manifest/pcrel_escapes.toml — don_m18; build/manifest/pcrel_escapes.toml — hui52; build/manifest/pcrel_escapes.toml — pyron36 |
| `PRG:0x028C98` | build/manifest/pcrel_escapes.toml — don_m18; build/manifest/pcrel_escapes.toml — hui52; build/manifest/pcrel_escapes.toml — pyron36 |
...
| `PRG:0x028D50` | build/manifest/donovan.toml — hit_class_props_ext_hi; build/manifest/donovan.toml — hit_class_props_ext_lo; build/manifest/huitzil.toml — effect_map_5051; build/manifest/shared_writes.toml — donovan; build/manifest/shared_writes.toml — huitzil |
...
| `PRG:0x028D54` | build/manifest/donovan.toml — hit_class_props_ext_hi |
...
| `PRG:0x028E42` | HANDOFF.md — Build registry [vs2]; docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-99 — the window (#43(b) + #103 + #104 + #105): byte detail; build/manifest/reconciliation.toml — map |
...
| `PRG:0x028FF4` | build/manifest/pcrel_escapes.toml — don_m18; build/manifest/pcrel_escapes.toml — hui52; build/manifest/pcrel_escapes.toml — pyron36 |
| `PRG:0x029034` | build/manifest/pcrel_escapes.toml — don_m18; build/manifest/pcrel_escapes.toml — hui52; build/manifest/pcrel_escapes.toml — pyron36 |
...
| `PRG:0x029F4A` | docs/game/engine_internals.md — Command-input / motion-tracker subsystem (session 14z-48, measured both engines); docs/game/engine_internals.md — The mechanism, as far as it is decoded (14z-68v); docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33); build/manifest/huitzil.toml — pcrel_escape_fix; build/manifest/reconciliation.toml — map |
| `PRG:0x029F60` | docs/game/engine_internals.md — The mechanism, as far as it is decoded (14z-68v) |
| `PRG:0x029F86` | docs/game/engine_internals.md — The mechanism, as far as it is decoded (14z-68v) |
| `PRG:0x029F9A` | docs/game/engine_internals.md — The mechanism, as far as it is decoded (14z-68v) |
| `PRG:0x029FD2` | docs/game/engine_internals.md — The mechanism, as far as it is decoded (14z-68v) |
| `PRG:0x029FDA` | docs/game/engine_internals.md — The mechanism, as far as it is decoded (14z-68v) |
...
| `PRG:0x02A528` | docs/game/engine_internals.md — The mechanism, as far as it is decoded (14z-68v) |
| `PRG:0x02A538` | docs/game/engine_internals.md — The mechanism, as far as it is decoded (14z-68v) |
| `PRG:0x02A57C` | docs/game/engine_internals.md — The mechanism, as far as it is decoded (14z-68v) |
| `PRG:0x02A582` | docs/game/engine_internals.md — The mechanism, as far as it is decoded (14z-68v) |
...
| `PRG:0x02A8A4` | docs/game/engine_internals.md — THE DARK FORCE PALETTE-SEQUENCE BLOCKS — measured census (14z-79b); docs/game/engine_internals.md — The palette-SEQUENCE uploader (14z-75, measured on the Pyron blink); docs/game/engine_internals.md — 'tests/test_hui_df_style.sh' — header brought current 14z-114); docs/game/engine_internals.md — vs2/vh2 fill them (named 14z-74; SIX instances and counting); HANDOFF.md — Build registry [vs2]; HANDOFF.md — Individual gates; +10 more |
...
| `PRG:0x02A8C6` | docs/game/engine_internals.md — The palette-SEQUENCE uploader (14z-75, measured on the Pyron blink); docs/game/engine_internals.md — vs2/vh2 fill them (named 14z-74; SIX instances and counting); HANDOFF.md — Individual gates; build/manifest/pyron.toml — palette_routine_row_11; build/manifest/shared_writes.toml — pyron; tests/test_pyron_blink.sh; +1 more |
...
| `PRG:0x02A8E4` | docs/game/engine_internals.md — THE DARK FORCE PALETTE-SEQUENCE BLOCKS — measured census (14z-79b); docs/game/engine_internals.md — 'tests/test_hui_df_style.sh' — header brought current 14z-114); build/manifest/huitzil.toml — pcrel_escape_fix; build/manifest/pyron.toml — roster21 |
...
| `PRG:0x02A92C` | docs/game/engine_internals.md — THE DARK FORCE PALETTE-SEQUENCE BLOCKS — measured census (14z-79b); docs/game/engine_internals.md — 'tests/test_hui_df_style.sh' — header brought current 14z-114); build/manifest/huitzil.toml — pcrel_escape_fix |
...
| `PRG:0x02AD64` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33); build/manifest/huitzil.toml — pcrel_escape_fix |
| `PRG:0x02AD68` | docs/game/engine_internals.md — The palette-SEQUENCE uploader (14z-75, measured on the Pyron blink); docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33); build/manifest/huitzil.toml — pcrel_escape_fix |
| `PRG:0x02AD7C` | docs/game/engine_internals.md — The palette-SEQUENCE uploader (14z-75, measured on the Pyron blink) |
| `PRG:0x02AD80` | docs/game/engine_internals.md — OBJ (sprite) pipeline — the R2 answer (session 14, static decode); tests/lua/scroll3_watch.lua |
| `PRG:0x02AD82` | docs/game/engine_internals.md — THE DARK FORCE PALETTE-SEQUENCE BLOCKS — measured census (14z-79b); docs/game/engine_internals.md — The palette-SEQUENCE uploader (14z-75, measured on the Pyron blink); docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33); HANDOFF.md — Individual gates; docs/project/patch_notes.md — 14z-84 — Phobos' own Dark Force palette block (huitzil-m5 -> m6): byte detail; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; +8 more |
| `PRG:0x02AD8F` | HANDOFF.md — Individual gates; docs/platform/gotchas.md — Dump a tile band WITH its bank bits, or you will exonerate the guilty; docs/platform/gotchas.md — emulators resolve a ROM entry by HASH before NAME; tests/test_m2b_scroll3.sh; tests/test_merged_render_content.sh; tests/test_wide_render_content.sh |
...
| `PRG:0x02ADA6` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33) |
| `PRG:0x02ADAC` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33); docs/project/patch_notes.md — 14z-84 — Phobos' own Dark Force palette block (huitzil-m5 -> m6): byte detail; build/manifest/huitzil.toml — pcrel_escape_fix |
...
| `PRG:0x02CBDE` | HANDOFF.md — Build registry [vh2]; docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-111 — #99 ROOT CAUSE FIX (option A): the CPU AI action-script tables unparked, byte detail; build/manifest/reconciliation_huitzil.toml — map [vs2]; tests/test_tenant_loop.sh |
...
| `PRG:0x02CD40` | docs/game/atlas/character_tables.md — The CPU AI action-script tables 'PRG:0xBF01A / 0xBF09A / 0xBF11A / 0xBF19A' (14z-111, #99); docs/game/atlas/ram.md — Player blocks — P1 '$FF8400', P2 '$FF8800' (0x400 apart) [D, corrected]; docs/game/engine_internals.md — The CPU AI action-script system (14z-111, measured on the #99 capture); docs/project/patch_notes.md — 14z-111 — #99 ROOT CAUSE FIX (option A): the CPU AI action-script tables unparked, byte detail; build/manifest/bank_map.toml — dispatch_19 |
| `PRG:0x02CD9C` | docs/game/atlas/character_tables.md — The CPU AI action-script tables 'PRG:0xBF01A / 0xBF09A / 0xBF11A / 0xBF19A' (14z-111, #99); docs/game/atlas/ram.md — Player blocks — P1 '$FF8400', P2 '$FF8800' (0x400 apart) [D, corrected]; docs/game/engine_internals.md — The CPU AI action-script system (14z-111, measured on the #99 capture); docs/project/patch_notes.md — 14z-111 — #99 ROOT CAUSE FIX (option A): the CPU AI action-script tables unparked, byte detail; build/manifest/bank_map.toml — dispatch_19 |
| `PRG:0x02CE0A` | HANDOFF.md — Build registry [vh2]; docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-111 — #99 ROOT CAUSE FIX (option A): the CPU AI action-script tables unparked, byte detail; build/manifest/reconciliation_huitzil.toml — map [vs2]; tests/test_tenant_loop.sh |
| `PRG:0x02CE3E` | HANDOFF.md — Build registry [vh2]; docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-111 — #99 ROOT CAUSE FIX (option A): the CPU AI action-script tables unparked, byte detail; build/manifest/reconciliation_huitzil.toml — map [vs2]; tests/test_tenant_loop.sh |
...
| `PRG:0x02D3F2` | HANDOFF.md — Build registry [vh2]; docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-111 — #99 ROOT CAUSE FIX (option A): the CPU AI action-script tables unparked, byte detail; build/manifest/reconciliation_huitzil.toml — map |
...
| `PRG:0x02D5B2` | HANDOFF.md — Build registry [vh2]; docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-111 — #99 ROOT CAUSE FIX (option A): the CPU AI action-script tables unparked, byte detail; build/manifest/reconciliation_huitzil.toml — map |
| `PRG:0x02D5E6` | HANDOFF.md — Build registry [vh2]; docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-111 — #99 ROOT CAUSE FIX (option A): the CPU AI action-script tables unparked, byte detail; build/manifest/reconciliation_huitzil.toml — map |
...
| `PRG:0x02EEBB` | docs/game/engine_internals.md — OBJ (sprite) pipeline — the R2 answer (session 14, static decode); tests/lua/scroll3_watch.lua; tests/test_m2b_scroll3.sh |
...
| `PRG:0x030EE8` | docs/game/engine_internals.md — THE DARK FORCE PALETTE-SEQUENCE BLOCKS — measured census (14z-79b); docs/game/engine_internals.md — 'tests/test_hui_df_style.sh' — header brought current 14z-114); build/manifest/huitzil.toml — pcrel_escape_fix |
| `PRG:0x030F8B` | docs/game/engine_internals.md — The child companion's shadow — SOLVED (14z-69o) |
| `PRG:0x030F96` | docs/game/engine_internals.md — The child companion's shadow — SOLVED (14z-69o) |
...
| `PRG:0x034332` | docs/game/engine_internals.md — confirmed static; RETRACTS most of the 14z-85d filed detail); build/manifest/qs_songs.toml — hui_trap_eject; tests/test_qs_id_table.sh; tests/test_qs_songs.sh |
| `PRG:0x034365` | docs/game/engine_internals.md — confirmed static; RETRACTS most of the 14z-85d filed detail); tests/test_qs_id_table.sh |
...
| `PRG:0x03975E` | HANDOFF.md — THE OUT-OF-RANGE INDEX TOOLKIT (14z-78) — three instruments, one class; tests/lua/index_watch.lua; tools/gen_index_window_thunk.py |
| `PRG:0x03C6CE` | docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically |
| `PRG:0x03C977` | docs/game/engine_internals.md — confirmed static; RETRACTS most of the 14z-85d filed detail); build/manifest/qs_songs.toml — hui_trap_eject; build/manifest/qs_songs.toml — hui_trap_eject_alt |
| `PRG:0x03C980` | HANDOFF.md — Build registry [vs2]; build/manifest/qs_songs.toml — hui_trap_eject |
| `PRG:0x03C9C0` | HANDOFF.md — Build registry [vs2]; build/manifest/qs_songs.toml — hui_trap_eject_alt |
...
| `PRG:0x03DE84` | docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically |
...
| `PRG:0x03E928` | docs/game/atlas/ram.md — Combat struct (player block +0x000) [C, verified D/T] [vs2]; docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) [vs2] |
...
| `PRG:0x040F8B` | docs/game/engine_internals.md — The child companion's shadow — SOLVED (14z-69o) |
...
| `PRG:0x04367A` | HANDOFF.md — Build registry; HANDOFF.md — Running a CPS-2 WIDE build (playtest); docs/project/hardening_register.md — 2. The 13 plausible reconciliation rows (triaged 14z-100, H3.2); docs/project/inferred_claims.md — Small fixes elsewhere; docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-102 — the #107 row flip — FROZEN in donovan-m10 + every tenant + stock (the shared map), #107 CLOSED; +1 more |
...
| `PRG:0x0448A6` | HANDOFF.md — Build registry; HANDOFF.md — Running a CPS-2 WIDE build (playtest); docs/project/hardening_register.md — 2. The 13 plausible reconciliation rows (triaged 14z-100, H3.2); docs/project/inferred_claims.md — Small fixes elsewhere; docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-102 — the #107 row flip — FROZEN in donovan-m10 + every tenant + stock (the shared map), #107 CLOSED [vs2]; +4 more |
...
| `PRG:0x045000` | HANDOFF.md — Individual gates; tests/test_merged_render_content.sh |
...
| `PRG:0x0471E8` | docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) [vs2]; docs/project/hardening_register.md — 2. The 13 plausible reconciliation rows (triaged 14z-100, H3.2) [vs2] |
| `PRG:0x047FB6` | HANDOFF.md — Build registry; HANDOFF.md — Individual gates; docs/project/tables/reconciliation.md — Twin-choice case law; build/manifest/reconciliation.toml — map; tests/audit_tripwire_reach.sh; tests/test_tenant_loop.sh |
| `PRG:0x0486A0` | HANDOFF.md — Individual gates; tests/test_merged_render_content.sh |
...
| `PRG:0x04900A` | docs/game/atlas/ram.md — Combat struct (player block +0x000) [C, verified D/T]; docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) [vs2] |
| `PRG:0x049486` | docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) [vs2] |
| `PRG:0x0494DE` | HANDOFF.md — Build registry [vs2]; HANDOFF.md — Individual gates; HANDOFF.md — Running a CPS-2 WIDE build (playtest); HANDOFF.md — Running a CPS-2 WIDE build (playtest) [vs2]; docs/project/hardening_register.md — 5. Known-uncovered DYNAMIC surfaces (H4); docs/project/tables/reconciliation.md — Twin-choice case law [vs2]; +5 more |
...
| `PRG:0x056D68` | docs/game/engine_internals.md — The per-char effect system (14z-67, decoded on the H ping rounds); HANDOFF.md — Individual gates; build/manifest/huitzil.toml — pcrel_escape_fix; tests/test_hui_fx_flow.sh |
| `PRG:0x056D70` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end; docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end [vs2] |
...
| `PRG:0x05C620` | docs/game/engine_internals.md — Every '$FF9400' type's parameters, decoded and measured (14z-121) [vs2]; docs/game/engine_internals.md — Per-tenant TYPE NUMBERS on multi-tenant builds (14z-82); docs/game/engine_internals.md — measured 14z-68d on the Huitzil effect arc) [vs2]; HANDOFF.md — MiSTer (14z-106/107) — the jtcps2w core + the simulation oracle; build/manifest/donovan.toml — obj_hook; build/manifest/huitzil.toml — obj_hook; +6 more |
...
| `PRG:0x05E542` | docs/game/engine_internals.md — Per-tenant TYPE NUMBERS on multi-tenant builds (14z-82); docs/game/engine_internals.md — measured 14z-68d on the Huitzil effect arc); HANDOFF.md — Individual gates; docs/project/patch_index.md — Mechanism inventory (generator vocabulary); docs/project/patch_notes.md — 14z-82 — per-tenant TYPE NUMBERS (the merged obj_hook vec3 fix) + the F2 merged shim; docs/project/patch_notes.md — 14z-85 — the spawn-time OWNER TAG (site 0x54470's 59-75 family; maintainer option (a)); +21 more |
...
| `PRG:0x05F136` | docs/game/engine_internals.md — Select palettes + the splash/win map (session 14f); build/manifest/donovan.toml — select_sword_pal_variant_id; tools/select_port.py |
...
| `PRG:0x05F1B6` | docs/game/engine_internals.md — 2. PALETTE — pool + a per-char REMAP TABLE; HANDOFF.md — Individual gates; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; build/manifest/donovan.toml — don_win_pal; build/manifest/donovan.toml — hud_name_entry_13_lo; build/manifest/donovan.toml — region_fix; +9 more |
| `PRG:0x05F1F6` | docs/project/patch_notes.md — Stage 4 progress — sessions 5-6 |
| `PRG:0x05F200` | docs/game/engine_internals.md — 1. Portrait POSITION — table '0x5F200', 4 bytes/char (x at +0, y at +2); HANDOFF.md — Build registry [vs2]; docs/project/patch_index.md — Mechanism inventory (generator vocabulary); build/manifest/donovan.toml — region_fix; build/manifest/donovan.toml — win_pos_x_slot; build/manifest/donovan.toml — win_pos_y_slot; +7 more |
...
| `PRG:0x061588` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end; build/manifest/reconciliation.toml — map |
...
| `PRG:0x065C98` | build/manifest/pcrel_escapes.toml — don_m18 |
| `PRG:0x065DFA` | build/manifest/pcrel_escapes.toml — don_m18 |
...
| `PRG:0x06B1A0` | docs/game/engine_internals.md — Select palettes + the splash/win map (session 14f); docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; build/manifest/donovan.toml — select_sword_pal_variant_id; tools/select_port.py |
...
| `PRG:0x06B29C` | docs/game/engine_internals.md — 2. PALETTE — pool + a per-char REMAP TABLE [vs2]; HANDOFF.md — Build registry [vs2]; build/manifest/huitzil.toml — hud_name_entry_10_lo [vs2] |
| `PRG:0x06B2F2` | docs/game/engine_internals.md — 2. PALETTE — pool + a per-char REMAP TABLE; docs/game/engine_internals.md — Per-tenant win-screen checklist; HANDOFF.md — Build registry [vs2]; docs/project/patch_index.md — Mechanism inventory (generator vocabulary); build/manifest/huitzil.toml — hud_name_entry_10_lo [vs2]; build/manifest/pyron.toml — win_pos_y_slot [vs2]; +1 more |
...
| `PRG:0x06C0E0` | docs/game/atlas/select_screen.md — The RECORD-POINTER array — what the hovered cell displays (14z-61); docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically; docs/project/doc_audit_14z118.md — 2. Cross-document numbers to lock (candidates for the script); docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; build/manifest/donovan.toml — name_bank_variant_id; build/manifest/donovan.toml — splash_bank_variant_id; +6 more |
...
| `PRG:0x06D218` | docs/game/engine_internals.md — The 14z-69j state, superseded |
...
| `PRG:0x06D9D4` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end; build/manifest/reconciliation.toml — map [vs2] |
...
| `PRG:0x077376` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end; docs/project/gotchas.md — against the manifest/built image before planning on it; build/manifest/donovan.toml — accent_color_aware_3; build/manifest/reconciliation.toml — map |
...
| `PRG:0x080000` | docs/platform/gotchas.md — CPS-2 gfx simms are not tile-contiguous — naive slicing silently "works" on siblings only; tests/audit_mister_map_fit.sh; tests/test_phasec_image.sh; tests/test_wheel_bank5.sh; tools/audit_pointer_flow.py; tools/build_wide_romset.py; +3 more |
...
| `PRG:0x080AAC` | docs/game/engine_internals.md — The chain, end to end; HANDOFF.md — Build registry; docs/project/porting_sprite_lists.md — 1. Does the host have the CLASS row?; build/manifest/huitzil.toml — grab_hold_keyframes; tests/audit_effect_class_rows.sh |
...
| `PRG:0x080B28` | HANDOFF.md — Build registry [vh2]; HANDOFF.md — Running a CPS-2 WIDE build (playtest); docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-102 — #109 THE CLONE-BEAM FIX (row 31) — FROZEN as huitzil-m19/merged-m5 (bit-for-bit the probes), field-confirmed, #109 CLOSED; build/manifest/huitzil.toml — beam_effect_class16; build/manifest/huitzil.toml — beam_effect_class31; +1 more |
| `PRG:0x080B44` | HANDOFF.md — Build registry [vh2]; build/manifest/huitzil.toml — grab_hold_keyframes; tests/audit_clone_beam_lines.sh; tools/build_donovan.sh |
| `PRG:0x080B46` | build/manifest/reconciliation.toml — map [vs2] |
| `PRG:0x0813A8` | docs/game/engine_internals.md — a vs2-only effect handler that was never ported |
...
| `PRG:0x082AE2` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end; build/manifest/donovan.toml — accent_color_aware_3; build/manifest/reconciliation.toml — map [vs2] |
| `PRG:0x082CD0` | docs/game/engine_internals.md — a vs2-only effect handler that was never ported |
...
| `PRG:0x08A6CA` | docs/game/engine_internals.md — The 14z-69j state, superseded |
| `PRG:0x08A6DE` | docs/game/engine_internals.md — The 14z-69j state, superseded |
...
| `PRG:0x08ACE6` | docs/game/engine_internals.md — The 14z-69j state, superseded |
...
| `PRG:0x08B170` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below. |
...
| `PRG:0x08B61E` | build/manifest/pcrel_escapes.toml — don_m18 |
...
| `PRG:0x08C014` | docs/game/engine_internals.md — causal claim above is RETRACTED; docs/project/patch_notes.md — 14z-70 — the ground explosion, and one inert repair; build/manifest/pcrel_escapes.toml — pyron36; tools/extract_char.py |
| `PRG:0x08C026` | build/manifest/pcrel_escapes.toml — pyron36 |
| `PRG:0x08C038` | build/manifest/pcrel_escapes.toml — pyron36; tests/test_census_regions.sh |
...
| `PRG:0x08C08A` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below.; docs/project/patch_index.md — Mechanism inventory (generator vocabulary); docs/project/patch_notes.md — 14z-70 — the ground explosion, and one inert repair; build/manifest/pcrel_escapes.toml — pyron36; tools/extract_char.py |
| `PRG:0x08C09A` | build/manifest/pcrel_escapes.toml — pyron36 |
| `PRG:0x08C0A2` | build/manifest/pcrel_escapes.toml — pyron36; tests/test_census_regions.sh |
...
| `PRG:0x08FAD2` | docs/game/engine_internals.md — a vs2-only effect handler that was never ported [vs2] |
| `PRG:0x0905AE` | docs/game/engine_internals.md — a vs2-only effect handler that was never ported; tools/build_donovan.sh |
| `PRG:0x0907F6` | build/manifest/pcrel_escapes.toml — don_m18 |
| `PRG:0x0908A0` | build/manifest/pcrel_escapes.toml — don_m18 |
| `PRG:0x0908AE` | docs/game/engine_internals.md — a vs2-only effect handler that was never ported |
| `PRG:0x09098A` | build/manifest/pcrel_escapes.toml — don_m18 |
...
| `PRG:0x091562` | docs/game/engine_internals.md — a vs2-only effect handler that was never ported [vs2] |
...
| `PRG:0x0926E4` | HANDOFF.md — Build registry; HANDOFF.md — Running a CPS-2 WIDE build (playtest); docs/project/patch_index.md — Named patches and windows — the per-session sections, folded (14z-122); docs/project/patch_notes.md — 14z-102 — #109 THE CLONE-BEAM FIX (row 31) — FROZEN as huitzil-m19/merged-m5 (bit-for-bit the probes), field-confirmed, #109 CLOSED; build/manifest/huitzil.toml — beam_effect_class16 [vs2]; tests/audit_clone_beam_lines.sh; +1 more |
...
| `PRG:0x092C4A` | HANDOFF.md — Build registry; HANDOFF.md — Build registry [vh2]; docs/project/patch_index.md — Mechanism inventory (generator vocabulary); build/manifest/donovan.toml — capture_kf_bulleta; build/manifest/huitzil.toml — capture_kf_bulleta; build/manifest/huitzil.toml — df_seq_entry_10; +3 more |
| `PRG:0x093460` | HANDOFF.md — Build registry [vh2]; docs/project/patch_notes.md — 14z-71 — the beam: byte detail; docs/project/porting_code_regions.md — 1. Bound the region by the SIBLING ORACLE, then check what it cut; build/manifest/huitzil.toml — grab_hold_keyframes [vs2]; tools/build_donovan.sh |
| `PRG:0x0934B4` | docs/game/engine_internals.md — a vs2-only effect handler that was never ported; docs/game/engine_internals.md — a vs2-only effect handler that was never ported [vs2] |
...
| `PRG:0x0B1A16` | HANDOFF.md — Build registry; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; tests/test_don_throw_mirror.sh; tests/test_phasec_spaces.sh |
...
| `PRG:0x0B3450` | docs/game/atlas/character_tables.md — Variant-slot semantics (structural finding); docs/game/atlas/select_screen.md — The Oboro select hook (14z-105, the port's own path to '0x18'); HANDOFF.md — Build registry; HANDOFF.md — Individual gates; docs/project/patch_notes.md — W1 — 'oboro_select_hook' ('[[site_thunk]]', every tenant manifest, deduped); build/manifest/donovan.toml — capture_kf_jedah; +4 more |
| `PRG:0x0B61C0` | docs/game/engine_internals.md — The 14z-69j state, superseded |
...
| `PRG:0x0B76C0` | docs/game/engine_internals.md — Select phase 2 SHIPPED (session 14e, fingerprint e98a357a); docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically |
...
| `PRG:0x0BD97A` | docs/game/atlas/character_tables.md — Slot→character map, vsavj (COMPLETE; select-name/HUD verified picks); docs/game/atlas/character_tables.md — Table addresses (32 entries each: slots 0x00-0x0F, variants 0x10-0x1F); docs/game/atlas/character_tables.md — The full per-character table BANK — layout identical in all three sets; HANDOFF.md — Individual gates; build/manifest/bank_map.toml — hitbox_base; tests/audit_continue_switch.sh; +7 more |
...
| `PRG:0x0BF31A` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end; build/manifest/bank_map.toml — dispatch_16 |
...
| `PRG:0x0BF41A` | docs/game/atlas/ram.md — Player blocks — P1 '$FF8400', P2 '$FF8800' (0x400 apart) [D, corrected]; docs/game/engine_internals.md — BORROW: (0x382,A6) is the fighter's voice-FLAVOR class; docs/game/engine_internals.md — The per-node sfx dispatcher and per-char record arrays (14z-52); docs/game/engine_internals.md — in the sound kernel itself, NOT the 0x0BF41A record path; docs/project/cps2_wide.md — B4 prg: PASSED, with the control that made it meaningful; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; +10 more |
| `PRG:0x0BF466` | docs/project/gotchas.md — decided the shipped bytes (14z-65); docs/project/patch_notes.md — 14z-65 — M3b Phase 0: op-overlap assertion + tail_data_ptr ownership (2026-08-07); docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; tools/gen_donovan_patch.py; tools/patch_prg.py |
...
| `PRG:0x0BF61A` | docs/game/atlas/ram.md — Combat struct (player block +0x000) [C, verified D/T]; docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end; docs/game/engine_internals.md — machine that consumes it (14z-98, measured end to end on #103); build/manifest/bank_map.toml — dispatch_19 |
...
| `PRG:0x0C1780` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end |
...
| `PRG:0x0C4F3C` | HANDOFF.md — Build registry [vh2]; docs/project/patch_index.md — Mechanism inventory (generator vocabulary) [vh2]; build/manifest/huitzil.toml — grab_hold_keyframes |
...
| `PRG:0x0D0C7F` | HANDOFF.md — Build registry [vs2]; build/manifest/pyron.toml — palette_routine_row_11_c [vs2]; build/manifest/pyron.toml — roster21 [vs2]; tests/test_pyron_cosmo.sh |
...
| `PRG:0x0D3070` | docs/project/patch_notes.md — The two rows; build/manifest/donovan.toml — obj_bank_word_slot; tests/test_don_sword.sh |
...
| `PRG:0x0D4648` | docs/game/engine_internals.md — The 14z-69j state, superseded |
...
| `PRG:0x0D4E10` | docs/game/engine_internals.md — causal claim above is RETRACTED; docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below. |
...
| `PRG:0x0D6FC8` | docs/game/engine_internals.md — The 14z-69j state, superseded |
| `PRG:0x0D6FDC` | docs/game/engine_internals.md — The 14z-69j state, superseded |
...
| `PRG:0x0D8912` | docs/game/engine_internals.md — causal claim above is RETRACTED; docs/project/patch_notes.md — 14z-70 — the ground explosion, and one inert repair |
| `PRG:0x0D8950` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below.; docs/game/engine_internals.md — selection mechanism is now named [vs2]; docs/project/patch_notes.md — 14z-70 — the ground explosion, and one inert repair; tools/build_donovan.sh |
| `PRG:0x0D8988` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below.; docs/project/patch_notes.md — 14z-70 — byte detail; docs/project/porting_code_regions.md — Why a bound is dangerous; tools/build_donovan.sh |
| `PRG:0x0D8998` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below. |
| `PRG:0x0D89A0` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below. |
...
| `PRG:0x0D9538` | docs/game/engine_internals.md — The attack record's fields, by their READERS (14z-121, static on vs2 '0x16930-0x175F6', the hit-apply code that holds the record in A3) [vs2]; docs/game/engine_internals.md — The per-char effect system (14z-67, decoded on the H ping rounds) |
...
| `PRG:0x0D97B8` | docs/game/engine_internals.md — 14z-69c: THE MECHANISM, traced end to end [vs2] |
...
| `PRG:0x0E2D00` | docs/game/engine_internals.md — selection mechanism is now named |
| `PRG:0x0E2DC0` | docs/game/engine_internals.md — selection mechanism is now named |
| `PRG:0x0E2DD8` | docs/game/engine_internals.md — selection mechanism is now named; docs/game/engine_internals.md — selection mechanism is now named [vs2]; HANDOFF.md — Individual gates |
...
| `PRG:0x0E4DB8` | docs/game/engine_internals.md — selection mechanism is now named [vs2] |
...
| `PRG:0x0F52B4` | docs/game/engine_internals.md — The 14z-69j state, superseded; docs/game/engine_internals.md — selection mechanism is now named [vs2] |
| `PRG:0x0F5418` | docs/game/engine_internals.md — The 14z-69j state, superseded; docs/game/engine_internals.md — selection mechanism is now named [vs2] |
| `PRG:0x0F619C` | docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; tools/gen_anita_bank2.py |
| `PRG:0x0F72E4` | docs/game/engine_internals.md — selection mechanism is now named |
...
| `PRG:0x0FB2E0` | docs/game/engine_internals.md — The 14z-69j state, superseded |
| `PRG:0x0FB2F8` | docs/game/engine_internals.md — The 14z-69j state, superseded |
...
| `PRG:0x0FFFFF` | docs/game/atlas/README.md — The three sets (measured M0; every figure still current); HANDOFF.md — CPS-2 WIDE — the extended hardware profile (2026-08-03, B0-B4 all green); docs/project/cps2_wide.md — B4 prg: PASSED, with the control that made it meaningful; docs/project/mister_map.md — The minimal, profile-gated proposal — **IMPLEMENTED, slice D4**; tests/test_index_window_thunk.sh; tests/test_region_overlap.sh; +1 more |
| `PRG:0x100000` | docs/game/atlas/character_tables.md — The CPU AI action-script tables 'PRG:0xBF01A / 0xBF09A / 0xBF11A / 0xBF19A' (14z-111, #99); docs/game/atlas/character_tables.md — The CPU AI action-script tables 'PRG:0xBF01A / 0xBF09A / 0xBF11A / 0xBF19A' (14z-111, #99) [vh2]; docs/game/atlas/character_tables.md — The CPU AI action-script tables 'PRG:0xBF01A / 0xBF09A / 0xBF11A / 0xBF19A' (14z-111, #99) [vs2]; docs/game/atlas/ram.md — Player blocks — P1 '$FF8400', P2 '$FF8800' (0x400 apart) [D, corrected]; HANDOFF.md — Build registry [vs2]; HANDOFF.md — Key findings so far; +34 more |
...
| `PRG:0x16CF22` | docs/game/engine_internals.md — The 14z-69j state, superseded; docs/game/engine_internals.md — selection mechanism is now named [vs2] |
...
| `PRG:0x18D800` | docs/game/engine_internals.md — confirmed static; RETRACTS most of the 14z-85d filed detail); docs/game/engine_internals.md — replay 87 ours-vs-native, FULL ring tap); HANDOFF.md — Build registry; HANDOFF.md — Individual gates; build/manifest/huitzil.toml — region_fix; build/manifest/qs_songs.toml — (top); +2 more |
| `PRG:0x19D832` | docs/game/engine_internals.md — superseded by "third pass: the VOICE-CLASS BORROW" directly below |
...
| `PRG:0x1FDF20` | docs/game/engine_internals.md — superseded by "third pass: the VOICE-CLASS BORROW" directly below |
...
| `PRG:0x245872` | docs/game/atlas/character_tables.md — Animation index tables (bank extends below bank[0]); docs/game/engine_internals.md — The 14z-69j state, superseded; docs/game/engine_internals.md — selection mechanism is now named [vs2]; docs/project/gotchas.md — A pointer-shaped heuristic is placement-dependent — merged5 passed by luck (14z-92); build/manifest/gfx_layout3.toml — huitzil; tests/test_beam_anim_walk.sh; +4 more |
| `PRG:0x248B88` | docs/game/engine_internals.md — Select-screen (portrait/name) pipeline — mapped (session 14c); build/manifest/donovan.toml — select_pal_variant_id; tests/test_gfx_tiles.sh |
...
| `PRG:0x24EDD4` | docs/game/engine_internals.md — selection mechanism is now named |
| `PRG:0x24FC22` | docs/game/engine_internals.md — selection mechanism is now named |
| `PRG:0x24FCE2` | docs/game/engine_internals.md — selection mechanism is now named |
| `PRG:0x24FCF6` | docs/game/engine_internals.md — selection mechanism is now named |
| `PRG:0x24FCFA` | docs/game/engine_internals.md — The 14z-69j state, superseded; docs/game/engine_internals.md — selection mechanism is now named; docs/game/engine_internals.md — selection mechanism is now named [vs2]; HANDOFF.md — Individual gates; tests/test_beam_anim_walk.sh |
...
| `PRG:0x251CDA` | docs/game/engine_internals.md — The 14z-69j state, superseded; docs/game/engine_internals.md — selection mechanism is now named [vs2]; tests/test_beam_anim_walk.sh |
...
| `PRG:0x255800` | docs/game/engine_internals.md — confirmed static; RETRACTS most of the 14z-85d filed detail) [vs2]; HANDOFF.md — Individual gates [vs2]; build/manifest/qs_songs.toml — (top) [vs2]; tests/test_qs_id_table.sh |
| `PRG:0x257FFF` | docs/game/engine_internals.md — confirmed static; RETRACTS most of the 14z-85d filed detail) [vs2]; build/manifest/qs_songs.toml — (top) [vs2]; tests/test_qs_id_table.sh |
| `PRG:0x2601EC` | docs/game/gotchas.md — The per-char strip zone interleaves the SHARED MUSIC POOL; tools/overlay_port.py |
| `PRG:0x2621C8` | docs/game/engine_internals.md — selection mechanism is now named |
| `PRG:0x2621D6` | docs/game/engine_internals.md — The 14z-69j state, superseded; docs/game/engine_internals.md — selection mechanism is now named [vs2] |
| `PRG:0x26233A` | docs/game/engine_internals.md — The 14z-69j state, superseded; docs/game/engine_internals.md — selection mechanism is now named [vs2] |
...
| `PRG:0x267596` | docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically |
| `PRG:0x2675AA` | docs/game/atlas/select_screen.md — The RECORD-POINTER array — what the hovered cell displays (14z-61); HANDOFF.md — Individual gates; build/manifest/donovan.toml — name_banner; build/manifest/huitzil.toml — name_banner; build/manifest/pyron.toml — name_banner; tools/check_tenant_select.py; +2 more |
| `PRG:0x2675E2` | docs/game/engine_internals.md — Select-screen (portrait/name) pipeline — mapped (session 14c) |
| `PRG:0x2675E6` | docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically |
...
| `PRG:0x26768A` | docs/game/engine_internals.md — Select-screen (portrait/name) pipeline — mapped (session 14c) |
...
| `PRG:0x267F32` | docs/game/engine_internals.md — Select-screen (portrait/name) pipeline — mapped (session 14c); tools/overlay_port.py |
| `PRG:0x267F72` | docs/game/engine_internals.md — Select-screen (portrait/name) pipeline — mapped (session 14c) |
...
| `PRG:0x2689F6` | docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically |
| `PRG:0x2689FA` | docs/game/atlas/select_screen.md — The wheel DRAWER — object, bank word, and the bank-5 move (14z-63); docs/game/engine_internals.md — Select-screen (portrait/name) pipeline — mapped (session 14c); docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; tests/test_wheel_bank5.sh; tools/gen_donovan_patch.py |
...
| `PRG:0x268A02` | docs/game/atlas/select_screen.md — Ring reuse IMPLEMENTED (14z-63, maintainer-ratified round 7); docs/game/atlas/select_screen.md — The RECORD-POINTER array — what the hovered cell displays (14z-61); docs/game/atlas/select_screen.md — The ring/highlight POSITION source — the 32-row base table (14z-63); HANDOFF.md — Individual gates; docs/project/doc_audit_14z118.md — 2. Cross-document numbers to lock (candidates for the script); build/manifest/donovan.toml — highlight; +7 more |
| `PRG:0x268A3A` | docs/game/engine_internals.md — Select-screen (portrait/name) pipeline — mapped (session 14c) |
| `PRG:0x268A3E` | docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically |
...
| `PRG:0x268B8A` | docs/game/engine_internals.md — Select-screen (portrait/name) pipeline — mapped (session 14c) |
...
| `PRG:0x271CE8` | docs/game/atlas/select_screen.md — The RECORD-POINTER array — what the hovered cell displays (14z-61); docs/game/engine_internals.md — Select phase 2 SHIPPED (session 14e, fingerprint e98a357a); docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically; docs/game/gotchas.md — The per-char strip zone interleaves the SHARED MUSIC POOL; tests/test_tenant_select_records.sh; tools/overlay_port.py; +2 more |
...
| `PRG:0x27221A` | docs/game/engine_internals.md — Select phase 2 SHIPPED (session 14e, fingerprint e98a357a); docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically; tools/overlay_port.py; tools/select_arrays.py; tools/select_port.py |
| `PRG:0x2724A2` | docs/game/atlas/select_screen.md — Ring reuse IMPLEMENTED (14z-63, maintainer-ratified round 7); docs/game/engine_internals.md — Select phase 2 SHIPPED (session 14e, fingerprint e98a357a); docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; build/manifest/donovan.toml — highlight; tools/select_arrays.py; +1 more |
...
| `PRG:0x272A68` | docs/game/atlas/select_screen.md — Drawing the new medallions — the record, and why it cannot grow in place; docs/game/atlas/select_screen.md — The RECORD-POINTER array — what the hovered cell displays (14z-61); docs/game/engine_internals.md — Select-screen (portrait/name) pipeline — mapped (session 14c); docs/project/patch_notes.md — 14z-115 — THE SELECT-WHEEL SEPARATION (maintainer-directed "E2", approved 2026-08-28): byte detail; build/manifest/donovan.toml — roster21; build/manifest/donovan.toml — voice_borrow_voicenums_b; +6 more |
| `PRG:0x272A72` | docs/game/atlas/select_screen.md — Drawing the new medallions — the record, and why it cannot grow in place; docs/game/engine_internals.md — Select wheel (the medallion ring); build/manifest/donovan.toml — win_pal_slot0f_c7 |
| `PRG:0x272A7A` | build/manifest/donovan.toml — win_pal_slot0f_c7 |
| `PRG:0x272A92` | docs/game/engine_internals.md — Select wheel (the medallion ring) |
...
| `PRG:0x283C10` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below. |
| `PRG:0x283CBC` | build/manifest/huitzil.toml — obj_hook |
| `PRG:0x283E58` | HANDOFF.md — MiSTer (14z-106/107) — the jtcps2w core + the simulation oracle [vs2]; build/manifest/moves_donovan.toml — (top) [vs2]; build/manifest/moves_donovan.toml — Blizzard Sword [vs2]; tests/test_move_naming.sh |
...
| `PRG:0x284A64` | HANDOFF.md — MiSTer (14z-106/107) — the jtcps2w core + the simulation oracle [vs2]; build/manifest/moves_donovan.toml — (top) [vs2]; build/manifest/moves_donovan.toml — Lightning Sword (ES) [vs2]; tests/test_move_naming.sh |
...
| `PRG:0x288C6E` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below. |
| `PRG:0x288C78` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below. |
...
| `PRG:0x2A657E` | docs/game/atlas/select_screen.md — The tenant move IMPLEMENTED, and vs2's own arrays (14z-62); docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; build/manifest/donovan.toml — name_banner; tools/overlay_port.py; tools/select_port.py |
| `PRG:0x2A6742` | build/manifest/pyron.toml — highlight |
| `PRG:0x2A6750` | docs/game/atlas/select_screen.md — The tenant move IMPLEMENTED, and vs2's own arrays (14z-62); docs/game/engine_internals.md — Select-screen phase 2 (session 14e): the real handles, empirically; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; build/manifest/donovan.toml — highlight; tools/select_port.py |
| `PRG:0x2A6D8C` | docs/game/engine_internals.md — Select wheel (the medallion ring) [vs2] |
...
| `PRG:0x2B8530` | docs/game/engine_internals.md — The 14z-69j state, superseded; build/manifest/huitzil.toml — obj_hook |
| `PRG:0x2B8644` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below. |
| `PRG:0x2B872C` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below. |
| `PRG:0x2BA120` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below.; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; tools/gen_anita_bank2.py |
...
| `PRG:0x2BD45E` | docs/game/engine_internals.md — it is NOT the explosion's root. Claim RETRACTED, see 14z-70d below. |
...
| `PRG:0x303AAC` | docs/game/engine_internals.md — Select wheel (the medallion ring) |
...
| `PRG:0x32A50A` | docs/game/atlas/select_screen.md — Drawing the new medallions — the record, and why it cannot grow in place; docs/game/engine_internals.md — Select wheel (the medallion ring); docs/project/patch_notes.md — 14z-115 — THE SELECT-WHEEL SEPARATION (maintainer-directed "E2", approved 2026-08-28): byte detail; build/manifest/donovan.toml — roster21; build/manifest/donovan.toml — voice_borrow_voicenums_b; build/manifest/donovan.toml — win_pal_slot0f_c7; +2 more |
...
| `PRG:0x38C1D8` | docs/game/atlas/character_tables.md — The per-character palette POINTER tables (measured 14z-76); HANDOFF.md — Individual gates; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; build/manifest/pyron.toml — sprite; build/manifest/shared_writes.toml — (top); build/manifest/shared_writes.toml — huitzil; +3 more |
...
| `PRG:0x38C218` | docs/game/atlas/character_tables.md — The per-character palette POINTER tables (measured 14z-76); docs/game/atlas/character_tables.md — Variant-slot semantics (structural finding); docs/game/atlas/id_space.md — RESERVED IDS — vanilla does use part of the variant half; HANDOFF.md — Build registry [vs2]; HANDOFF.md — Individual gates; docs/game/gotchas.md — SLOT used, and reading it that way deferred a fix for two sessions (14z-76); +11 more |
| `PRG:0x38C258` | docs/game/atlas/character_tables.md — The per-character palette POINTER tables (measured 14z-76); HANDOFF.md — Build registry [vs2]; HANDOFF.md — Individual gates; docs/game/gotchas.md — SLOT used, and reading it that way deferred a fix for two sessions (14z-76); docs/project/patch_notes.md — Session 14z-76 (Pyron's effect palette; build/pyron20 69e8c6f0); docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; +9 more |
| `PRG:0x38C25C` | HANDOFF.md — Build registry [vs2]; docs/project/patch_notes.md — Session 14z-76 (Pyron's effect palette; build/pyron20 69e8c6f0); build/manifest/shared_writes.toml — pyron |
...
| `PRG:0x39A900` | docs/game/engine_internals.md — THE DARK FORCE PALETTE-SEQUENCE BLOCKS — measured census (14z-79b); docs/game/engine_internals.md — The palette-SEQUENCE uploader (14z-75, measured on the Pyron blink); docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33); HANDOFF.md — THE DF PALETTE-SEQ BLOCK CENSUS (14z-79b) — measured, and it had to be; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; docs/project/patch_notes.md — donovan-m2 stage 4 — +0x14E state hook, sound stubs, anim_index_a2 (2026-07-27, session 9); +7 more |
| `PRG:0x39ACC0` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33); HANDOFF.md — Build registry; HANDOFF.md — Individual gates; docs/project/patch_index.md — Mechanism inventory (generator vocabulary); docs/project/patch_notes.md — 14z-69 (session close) — byte detail; build/manifest/huitzil.toml — pcrel_escape_fix; +4 more |
| `PRG:0x39ACD0` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33) |
| `PRG:0x39ACE0` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33) |
| `PRG:0x39AD00` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33) |
| `PRG:0x39AD20` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33) |
| `PRG:0x39AD40` | build/manifest/huitzil.toml — pcrel_escape_fix |
| `PRG:0x39AD4F` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33) |
...
| `PRG:0x3A3800` | docs/game/engine_internals.md — Select wheel (the medallion ring); docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; build/manifest/donovan.toml — roster21; build/manifest/huitzil.toml — roster21; build/manifest/pyron.toml — roster21; tools/check_wheel_bank5.py |
...
| `PRG:0x3A3C00` | docs/game/engine_internals.md — Select wheel (the medallion ring) |
| `PRG:0x3A3CA0` | docs/game/atlas/id_space.md — The arcade-opponent path (a fourth roster work item); docs/game/atlas/id_space.md — What a per-tenant manifest must declare; docs/game/engine_internals.md — M2b in-emulator verification (session 14c, machine window); docs/game/engine_internals.md — Sprite palette pipeline (session 14b, playtest-driven); docs/project/inferred_claims.md — G2/G3 — measurements feeding engine_internals; docs/project/tenant_manifest.md — The schema |
...
| `PRG:0x3ABEDC` | docs/game/engine_internals.md — THE DARK FORCE PALETTE-SEQUENCE BLOCKS — measured census (14z-79b); docs/game/engine_internals.md — THE DARK FORCE PALETTE-SEQUENCE BLOCKS — measured census (14z-79b) [vs2]; HANDOFF.md — Build registry [vs2]; docs/project/patch_index.md — Mechanism inventory (generator vocabulary) [vs2]; docs/project/patch_notes.md — 14z-69 (session close) — byte detail [vs2]; docs/project/patch_notes.md — 14z-84 — Phobos' own Dark Force palette block (huitzil-m5 -> m6): byte detail; +6 more |
...
| `PRG:0x3AC000` | docs/game/engine_internals.md — Select palettes + the splash/win map (session 14f); docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; tools/check_tenant_select.py; tools/select_port.py |
...
| `PRG:0x3B0DFC` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33) [vs2]; build/manifest/huitzil.toml — pcrel_escape_fix [vs2] |
| `PRG:0x3B0E0C` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33) |
| `PRG:0x3B0E1C` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33) [vs2] |
| `PRG:0x3B0E3C` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33) |
| `PRG:0x3B0E5C` | docs/game/engine_internals.md — known class (the sword/statue blink, STATE 14z-33) |
...
| `PRG:0x3B5988` | docs/game/engine_internals.md — M2b in-emulator verification (session 14c, machine window); docs/game/engine_internals.md — Sprite palette pipeline (session 14b, playtest-driven); build/manifest/donovan.toml — gfx_remap |
...
| `PRG:0x3BA8E0` | docs/game/engine_internals.md — THE DARK FORCE PALETTE-SEQUENCE BLOCKS — measured census (14z-79b); HANDOFF.md — THE DF PALETTE-SEQ BLOCK CENSUS (14z-79b) — measured, and it had to be |
| `PRG:0x3BAEA8` | docs/game/engine_internals.md — M2b in-emulator verification (session 14c, machine window); docs/game/engine_internals.md — Sprite palette pipeline (session 14b, playtest-driven); build/manifest/donovan.toml — gfx_remap |
| `PRG:0x3BAF3C` | docs/project/patch_notes.md — Stage 4 progress — sessions 5-6 [vs2] |
| `PRG:0x3BAFDC` | docs/game/atlas/ram.md — Masked windows for hooked-build legacy comparison (CLAUDE.md §4 amendment, 2026-07-25) [vs2]; docs/game/engine_internals.md — Select wheel (the medallion ring) [vs2]; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6 [vs2]; build/manifest/donovan.toml — med_pal_row14_a; build/manifest/donovan.toml — win_pal_slot0f_c7 [vs2]; +2 more |
...
| `PRG:0x3C2BBC` | docs/game/engine_internals.md — 2. PALETTE — pool + a per-char REMAP TABLE [vs2]; HANDOFF.md — Build registry [vs2]; docs/project/patch_index.md — Mechanism inventory (generator vocabulary); build/manifest/huitzil.toml — hud_name_entry_10_lo; build/manifest/pyron.toml — win_pos_y_slot; tests/test_hui_winscreen.sh |
| `PRG:0x3C329C` | docs/game/engine_internals.md — 2. PALETTE — pool + a per-char REMAP TABLE; HANDOFF.md — Build registry [vs2]; build/manifest/huitzil.toml — hud_name_entry_10_lo; build/manifest/huitzil.toml — hui_win_pal; build/manifest/pyron.toml — win_pos_y_slot; tests/test_hui_winscreen.sh |
| `PRG:0x3C347C` | HANDOFF.md — Build registry [vs2]; docs/project/patch_notes.md — where the detail lives |
| `PRG:0x3C35BC` | build/manifest/pyron.toml — pyr_win_pal; build/manifest/pyron.toml — win_pos_y_slot |
| `PRG:0x3C365C` | docs/game/engine_internals.md — 2. PALETTE — pool + a per-char REMAP TABLE; HANDOFF.md — Build registry [vs2]; docs/project/patch_notes.md — Stage 4 progress — sessions 5-6 [vs2]; build/manifest/donovan.toml — don_win_pal; build/manifest/donovan.toml — hud_name_entry_13_lo [vs2]; build/manifest/donovan.toml — region_fix; +4 more |
...
| `PRG:0x3C635C` | HANDOFF.md — Build registry [vs2]; build/manifest/donovan.toml — win_pal_slot0f_c4; build/manifest/huitzil.toml — hud_name_entry_10_lo; tests/test_hui_winscreen.sh |
...
| `PRG:0x3FABA0` | HANDOFF.md — Build registry; HANDOFF.md — Build registry [vs2]; docs/project/patch_notes.md — Session 14z-76 (Pyron's effect palette; build/pyron20 69e8c6f0); tests/test_effect_palette_table.sh |
...
| `PRG:0x3FFD50` | HANDOFF.md — Build registry [vs2] |
...
| `PRG:0x3FFFFF` | docs/project/mister_map.md — 4. Why vanilla's 32 MB stays put, verified against the placement code; tools/diff_sets.py; tools/scan_code_refs.py |
...
| `PRG:0x0187BC` | tests/test_index_window_thunk.sh |
...
| `PRG:0x03D97A` | tests/audit_continue_switch.sh; tests/audit_don_vs_cpu.sh; tests/test_random_select_tenants.sh |
