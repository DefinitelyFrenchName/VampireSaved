...
| donovan-m2 | in progress (stage 1/5 PASS) | patch_prg tooling, extract_char oracle | replaces Jedah slot 0x0F | M2 proof-of-life: Donovan into vsavj. Generated by `tools/gen_donovan_patch.py --stage N` from the oracle-validated extraction (`tools/build_donovan.sh N`). Stage 1 (null relocation) proven: `tests/test_m2a_stage1_nullreloc.sh`. Per-stage details: docs/patch_notes.md. |
