...
|---|---|
| `patches/vsavjw/d_<member>.xdelta` (20 at M18) | VCDIFF deltas against a blob of the four reference dumps; measured at M18: **282 KB literal** generated bytes, 17.5 MB copy instructions, 9 MB fill — no reference run survives the rule-7 scan |
...
the four dumps; the applier refuses a wrong one by name.
