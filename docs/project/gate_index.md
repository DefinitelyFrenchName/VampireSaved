...
**334 scripts** — 79 ci_portable, 75 ci_static, 180 emulator-tier (run by name).
...
| [character-data](#character-data) | 26 | the character-data map — move naming, hitboxes, reactions, projectiles, measured mechanics |
