...
| `tests/test_don_immortal_native.sh` | test | emulator | MAME, ~9 min | 421+P (Lightning Sword) AGAINST NATIVE vsav2, in the units the comparison is allowed to use (14z-127, GitHub #114). | 14z-127 |
