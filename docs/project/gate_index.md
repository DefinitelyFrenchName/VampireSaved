...
| `tests/audit_tick_cadence.sh` | audit | emulator | MAME, ~7 min | on VANILLA content the two engines double their logic pass at different cadences: vsav2 every third frame, vsavj every fourth or fifth, both fighters on the same frames, both passes inside ONE activation of the game task; | 14z-156 |
