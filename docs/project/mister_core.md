...
> **[MSC-7]** **A retraction worth carrying, because it is the ordinary lesson in a new
...
kind of decision that ruins frame timing. **[MSC-24]** **It was measured before it was
...
**[MSC-33]** **Nine sites are gated as of slice D5**, and `tests/test_mister_wide_gate.sh`
...
**[MSC-14]** **The obj promote is gated at BOTH ends and that is deliberate.** `gfxc_sel`
...
**[MSC-15]** **The one ungated change is declared rather than hidden: the bank-0
...
**[MSC-13]** **A second profile gate operates one layer up, in the mapping tool.**
...
* **[MSC-36]** **A fourth graphics group, or any growth of the declared group-C region.**
...
| **The 128 MB module's chip select** | **[MSC-72]** the XL fallback (§4) assumes the module inverts chip 1's `/CS`. That is INFERRED from jtframe's RTL, never seen on a schematic. If XL is ever taken, confirm which module is in hand first. |
