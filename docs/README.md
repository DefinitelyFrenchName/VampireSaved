...
- [`gate_header_contract.md`](project/gate_header_contract.md) — **REFERENCE** · THE GATE HEADER CONTRACT — what a gate declares about itself in its leading comment block and who reads it: the WHAT/HOW/EXPECTS description (live), FOLLOWS and MEASURES (ruled, not built)
