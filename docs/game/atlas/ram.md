...
- **V3** `043c-043d,4182-41a2,41c2-41e2,4222-4262,42a2-42c2,7f00-8000` —
  + row 0x1D's slot (14z-88; ratified 2026-08-15 after the 14z-87b
  medallion move 0x1A→0x1D); `tests/expected/vsavj/masked-v3/`. Current
  WIDE sets (donovan-m6 / huitzil-m14 / pyron-m8) via their
  `tests/expected/<set>/mask` file.
...
adds row 0x1D's slot after the 14z-87b medallion move — the reminder
that a palette-row move is ALSO a staging-slot move. Two measured
