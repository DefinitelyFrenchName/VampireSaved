...
| +0x205 (`$FF8605`/`$FF8A05`) | CPU AI script INDEX into the class's table-0 block (`0x2CCB6`: `move.b (0x205,a6)` -> word offset -> script start) | [D: 14z-111, trace + write tap on crash_m10] |
