...
| +0x1AB.b | the ADVANCING-GUARD window: 14 on a grounded block (handler `0x2246E`, class `0xFF`), counts down per engine tick; presses after it count for nothing. Never set by a throw (Victor's 6MP hold, Sharirum Luna: 0 throughout) | [M: 14z-123] |
