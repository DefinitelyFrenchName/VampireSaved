...
301 entries (40 game / 91 platform / 170 project), counted from the buckets at generation.
...
## Project — our pipeline and method ([`project/gotchas.md`](project/gotchas.md)) — 170 entries
