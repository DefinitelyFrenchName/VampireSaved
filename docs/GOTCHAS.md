...
- THE DEAD-ROW CLASS: vsav ships table rows as stubs/aliases where vs2 fills them — 5 instances (beam class row 16, drawer type 12, grab keyframe row, Cosmo sub-state 81, the HUD mug/name rows 0x10-0x1F) + the variant-half alias variant; recipe in docs/game/engine_internals.md (14z-74, 5th 14z-75)
