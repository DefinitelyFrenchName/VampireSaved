...
- **The sim harness's direction bits are transposed** — Left and Down swap; measured against the game's own `$FF8058` mirror. Cost a whole obj-bank-4 measurement. [platform](platform/gotchas.md)
