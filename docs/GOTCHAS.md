...
300 entries (40 game / 91 platform / 169 project), counted from the buckets at generation.
...
## Project — our pipeline and method ([`project/gotchas.md`](project/gotchas.md)) — 169 entries
