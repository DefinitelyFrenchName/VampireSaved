...
- THE DEAD-ROW CLASS: vsav ships table rows as stubs/aliases where vs2 fills them — 4 instances (beam class row 16, drawer type 12, grab keyframe row, Cosmo sub-state 81) + the variant-half alias variant; recipe in docs/game/engine_internals.md (14z-74)
