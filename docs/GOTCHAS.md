...
291 entries (40 game / 90 platform / 161 project), counted from the buckets at generation.
...
## Platform — CPS-2, MAME, FBNeo ([`platform/gotchas.md`](platform/gotchas.md)) — 90 entries
